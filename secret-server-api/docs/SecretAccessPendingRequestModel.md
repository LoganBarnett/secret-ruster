...
| **current_step_approvers**                 | Option<**Vec<String>**>                                                  | The List of approving reviewers for the current approval step.    | [optional] |
| **current_step_reviewers**                 | Option<[**Vec<models::SecretAccessReviewer>**](SecretAccessReviewer.md)> | The List of reviewers for the current approval step.              | [optional] |
