...
| **recurring_schedule_id**   | Option<**i32**>                                                                        | Unique ID for this schedule                                                                                                  | [optional] |
| **recurring_schedule_type** | Option<[**models::RecurringScheduleType**](RecurringScheduleType.md)>                  |                                                                                                                              | [optional] |
| **schedule_constraints**    | Option<[**Vec<models::RecurringScheduleValueModel>**](RecurringScheduleValueModel.md)> | These indicate the rules for when a schedule should recur. If all of the constraints are met then the schedule will trigger. | [optional] |
