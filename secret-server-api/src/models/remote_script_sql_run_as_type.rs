...
/// RemoteScriptSqlRunAsType : RunAs
/// RunAs
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum RemoteScriptSqlRunAsType {
...
impl std::fmt::Display for RemoteScriptSqlRunAsType {
...
impl Default for RemoteScriptSqlRunAsType {
    fn default() -> RemoteScriptSqlRunAsType {
        Self::Database
    }
}
