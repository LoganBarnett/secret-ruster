...
/// PagingOfBackupLogViewModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfBackupLogViewModel {
    ...
    pub records: Option<Vec<models::BackupLogViewModel>>,
