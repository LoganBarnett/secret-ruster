...
/// RemoveUsersFromTeamArgs : RemoveUsersFromTeamArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct RemoveUsersFromTeamArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::RemoveUsersFromTeamModel>>,
}

impl RemoveUsersFromTeamArgs {
    /// RemoveUsersFromTeamArgs
    pub fn new() -> RemoveUsersFromTeamArgs {
        RemoveUsersFromTeamArgs {
            data: None,
        }
    }
