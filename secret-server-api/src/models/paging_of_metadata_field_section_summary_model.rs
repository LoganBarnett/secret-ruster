...
/// PagingOfMetadataFieldSectionSummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfMetadataFieldSectionSummaryModel {
    ...
    pub records: Option<Vec<models::MetadataFieldSectionSummaryModel>>,
...
impl PagingOfMetadataFieldSectionSummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfMetadataFieldSectionSummaryModel {
