...
/// SlackConfigurationTestResultModel : SlackConfigurationTestResultModel
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SlackConfigurationTestResultModel {
    /// Success
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl SlackConfigurationTestResultModel {
    /// SlackConfigurationTestResultModel
    pub fn new() -> SlackConfigurationTestResultModel {
        SlackConfigurationTestResultModel {
            success: None,
        }
    }
