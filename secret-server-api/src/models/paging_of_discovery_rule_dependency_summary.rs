...
/// PagingOfDiscoveryRuleDependencySummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfDiscoveryRuleDependencySummary {
    ...
    pub records: Option<Vec<models::DiscoveryRuleDependencySummary>>,
...
impl PagingOfDiscoveryRuleDependencySummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfDiscoveryRuleDependencySummary {
