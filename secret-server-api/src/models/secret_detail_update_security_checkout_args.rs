...
/// SecretDetailUpdateSecurityCheckoutArgs : Secret Security Checkout Message
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretDetailUpdateSecurityCheckoutArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretDetailSecurityCheckoutUpdateModel>>,
}

impl SecretDetailUpdateSecurityCheckoutArgs {
    /// Secret Security Checkout Message
    pub fn new() -> SecretDetailUpdateSecurityCheckoutArgs {
