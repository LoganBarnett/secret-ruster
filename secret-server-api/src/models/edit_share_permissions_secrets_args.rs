...
/// EditSharePermissionsSecretsArgs : EditSharePermissionsSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EditSharePermissionsSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EditSharePermissionsSecretsModel>>,
}

impl EditSharePermissionsSecretsArgs {
    /// EditSharePermissionsSecretsArgs
    pub fn new() -> EditSharePermissionsSecretsArgs {
        EditSharePermissionsSecretsArgs {
            data: None,
        }
    }
