...
/// ResetTwoFactorResponseModel : The result of the 2FA reset
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ResetTwoFactorResponseModel {
    /// Did the 2FA reset succeed
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl ResetTwoFactorResponseModel {
    /// The result of the 2FA reset
    pub fn new() -> ResetTwoFactorResponseModel {
