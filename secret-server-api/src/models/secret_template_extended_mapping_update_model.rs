...
/// SecretTemplateExtendedMappingUpdateModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretTemplateExtendedMappingUpdateModel {
    #[serde(rename = "fields", skip_serializing_if = "Option::is_none")]
    pub fields: Option<Box<models::UpdateFieldValueOfSecretTemplateExtendedMappingUpdateFieldModelLeftSquareBracketRightSquareBracket>>,
}

impl SecretTemplateExtendedMappingUpdateModel {
    /// Data
    pub fn new() -> SecretTemplateExtendedMappingUpdateModel {
