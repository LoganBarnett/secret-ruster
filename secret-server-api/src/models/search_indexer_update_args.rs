...
/// SearchIndexerUpdateArgs : SearchIndexerUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SearchIndexerUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SearchIndexerUpdateModel>>,
}

impl SearchIndexerUpdateArgs {
    /// SearchIndexerUpdateArgs
    pub fn new() -> SearchIndexerUpdateArgs {
        SearchIndexerUpdateArgs {
            data: None,
        }
    }
