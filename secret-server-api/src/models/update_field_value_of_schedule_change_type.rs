...
/// UpdateFieldValueOfScheduleChangeType : ChangeType
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfScheduleChangeType {
    /// Dirty
...
impl UpdateFieldValueOfScheduleChangeType {
    /// ChangeType
    pub fn new() -> UpdateFieldValueOfScheduleChangeType {
