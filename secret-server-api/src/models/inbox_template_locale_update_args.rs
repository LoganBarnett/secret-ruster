...
/// InboxTemplateLocaleUpdateArgs : InboxTemplateLocaleUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InboxTemplateLocaleUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::InboxTemplateLocaleUpdateModel>>,
}

impl InboxTemplateLocaleUpdateArgs {
    /// InboxTemplateLocaleUpdateArgs
    pub fn new() -> InboxTemplateLocaleUpdateArgs {
        InboxTemplateLocaleUpdateArgs {
            data: None,
        }
    }
