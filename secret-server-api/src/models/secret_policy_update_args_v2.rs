...
/// SecretPolicyUpdateArgsV2 : SecretPolicyUpdateArgsV2
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretPolicyUpdateArgsV2 {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretPolicyUpdateModelV2>>,
}

impl SecretPolicyUpdateArgsV2 {
    /// SecretPolicyUpdateArgsV2
    pub fn new() -> SecretPolicyUpdateArgsV2 {
        SecretPolicyUpdateArgsV2 {
            data: None,
        }
    }
