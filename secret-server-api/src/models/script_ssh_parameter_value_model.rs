...
/// ScriptSshParameterValueModel : Parameters
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScriptSshParameterValueModel {
    /// ParameterName
...
impl ScriptSshParameterValueModel {
    /// Parameters
    pub fn new() -> ScriptSshParameterValueModel {
