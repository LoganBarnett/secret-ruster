...
/// UpdateFieldValueOfTakeOverAccountTypeEnum : Take Over Account Type
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfTakeOverAccountTypeEnum {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<models::TakeOverAccountTypeEnum>,
}

impl UpdateFieldValueOfTakeOverAccountTypeEnum {
    /// Take Over Account Type
    pub fn new() -> UpdateFieldValueOfTakeOverAccountTypeEnum {
