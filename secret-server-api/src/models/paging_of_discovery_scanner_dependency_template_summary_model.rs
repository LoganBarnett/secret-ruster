...
/// PagingOfDiscoveryScannerDependencyTemplateSummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfDiscoveryScannerDependencyTemplateSummaryModel {
    ...
    pub records: Option<Vec<models::DiscoveryScannerDependencyTemplateSummaryModel>>,
...
impl PagingOfDiscoveryScannerDependencyTemplateSummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfDiscoveryScannerDependencyTemplateSummaryModel {
