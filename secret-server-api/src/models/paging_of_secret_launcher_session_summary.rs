...
/// PagingOfSecretLauncherSessionSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSecretLauncherSessionSummary {
    ...
    pub records: Option<Vec<models::SecretLauncherSessionSummary>>,
...
impl PagingOfSecretLauncherSessionSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSecretLauncherSessionSummary {
