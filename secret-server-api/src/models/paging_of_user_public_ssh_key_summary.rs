...
/// PagingOfUserPublicSshKeySummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfUserPublicSshKeySummary {
    ...
    pub records: Option<Vec<models::UserPublicSshKeySummary>>,
...
impl PagingOfUserPublicSshKeySummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfUserPublicSshKeySummary {
