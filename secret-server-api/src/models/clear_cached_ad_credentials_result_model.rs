...
/// ClearCachedAdCredentialsResultModel : A result from clearing cached AD credentials
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ClearCachedAdCredentialsResultModel {
    /// True is the call succeeded
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl ClearCachedAdCredentialsResultModel {
    /// A result from clearing cached AD credentials
    pub fn new() -> ClearCachedAdCredentialsResultModel {
