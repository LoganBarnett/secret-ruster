...
/// PagingOfSshCipherSuiteSummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSshCipherSuiteSummaryModel {
    ...
    pub records: Option<Vec<models::SshCipherSuiteSummaryModel>>,
...
impl PagingOfSshCipherSuiteSummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSshCipherSuiteSummaryModel {
