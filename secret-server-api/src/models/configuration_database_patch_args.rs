...
/// ConfigurationDatabasePatchArgs : ConfigurationDatabasePatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationDatabasePatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConfigurationDatabasePatchModel>>,
}

impl ConfigurationDatabasePatchArgs {
    /// ConfigurationDatabasePatchArgs
    pub fn new() -> ConfigurationDatabasePatchArgs {
        ConfigurationDatabasePatchArgs {
            data: None,
        }
    }
