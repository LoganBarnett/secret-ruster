...
/// PagingOfDiscoveryRuleAccountSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfDiscoveryRuleAccountSummary {
    ...
    pub records: Option<Vec<models::DiscoveryRuleAccountSummary>>,
...
impl PagingOfDiscoveryRuleAccountSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfDiscoveryRuleAccountSummary {
