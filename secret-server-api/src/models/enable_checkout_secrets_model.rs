...
/// EnableCheckoutSecretsModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableCheckoutSecretsModel {
    /// Ids of Secrets to set Checkout to enabled.
    #[serde(rename = "secretIds", skip_serializing_if = "Option::is_none")]
    pub secret_ids: Option<Vec<i32>>,
}

impl EnableCheckoutSecretsModel {
    /// Data
    pub fn new() -> EnableCheckoutSecretsModel {
