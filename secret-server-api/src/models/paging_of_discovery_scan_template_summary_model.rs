...
/// PagingOfDiscoveryScanTemplateSummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfDiscoveryScanTemplateSummaryModel {
    ...
    pub records: Option<Vec<models::DiscoveryScanTemplateSummaryModel>>,
...
impl PagingOfDiscoveryScanTemplateSummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfDiscoveryScanTemplateSummaryModel {
