...
/// EventPipelinePolicyGroupMapUpdateArgs : EventPipelinePolicyGroupMapUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EventPipelinePolicyGroupMapUpdateArgs {
    /// Data
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<i32>>,
}

impl EventPipelinePolicyGroupMapUpdateArgs {
    /// EventPipelinePolicyGroupMapUpdateArgs
    pub fn new() -> EventPipelinePolicyGroupMapUpdateArgs {
        EventPipelinePolicyGroupMapUpdateArgs {
            data: None,
        }
    }
