...
/// JumpboxRouteLevelPatchArgs : JumpboxRouteLevelPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct JumpboxRouteLevelPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::JumpboxRouteLevelPatchModel>>,
}

impl JumpboxRouteLevelPatchArgs {
    /// JumpboxRouteLevelPatchArgs
    pub fn new() -> JumpboxRouteLevelPatchArgs {
        JumpboxRouteLevelPatchArgs {
            data: None,
        }
    }
