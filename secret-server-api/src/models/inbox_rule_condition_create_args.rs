...
/// InboxRuleConditionCreateArgs : InboxRuleConditionCreateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InboxRuleConditionCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::InboxRuleConditionCreateModel>>,
}

impl InboxRuleConditionCreateArgs {
    /// InboxRuleConditionCreateArgs
    pub fn new() -> InboxRuleConditionCreateArgs {
        InboxRuleConditionCreateArgs {
            data: None,
        }
    }
