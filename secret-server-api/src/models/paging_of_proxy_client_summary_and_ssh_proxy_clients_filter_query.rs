...
/// PagingOfProxyClientSummaryAndSshProxyClientsFilterQuery : Specify filtering, paging, sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfProxyClientSummaryAndSshProxyClientsFilterQuery {
    ...
    pub filter: Option<Box<models::SshProxyClientsFilterQuery>>,
    ...
    pub records: Option<Vec<models::ProxyClientSummary>>,
...
impl PagingOfProxyClientSummaryAndSshProxyClientsFilterQuery {
    /// Specify filtering, paging, sorting options for querying records and returning results
    pub fn new() -> PagingOfProxyClientSummaryAndSshProxyClientsFilterQuery {
