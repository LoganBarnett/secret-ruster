...
/// PagingOfDependencyChangerSettingSummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfDependencyChangerSettingSummaryModel {
    ...
    pub records: Option<Vec<models::DependencyChangerSettingSummaryModel>>,
...
impl PagingOfDependencyChangerSettingSummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfDependencyChangerSettingSummaryModel {
