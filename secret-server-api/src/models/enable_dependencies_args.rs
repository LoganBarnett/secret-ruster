...
/// EnableDependenciesArgs : EnableDependenciesArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableDependenciesArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EnableDependenciesModel>>,
}

impl EnableDependenciesArgs {
    /// EnableDependenciesArgs
    pub fn new() -> EnableDependenciesArgs {
        EnableDependenciesArgs {
            data: None,
        }
    }
