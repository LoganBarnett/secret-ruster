...
/// UpdateFieldValueOfDiscoverySourceSettingsUpdateModel : Additional discovery settings
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfDiscoverySourceSettingsUpdateModel {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<Box<models::DiscoverySourceSettingsUpdateModel>>,
}

impl UpdateFieldValueOfDiscoverySourceSettingsUpdateModel {
    /// Additional discovery settings
    pub fn new() -> UpdateFieldValueOfDiscoverySourceSettingsUpdateModel {
