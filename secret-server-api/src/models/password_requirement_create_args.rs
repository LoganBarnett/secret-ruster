...
/// PasswordRequirementCreateArgs : Password Requirement Create Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PasswordRequirementCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::PasswordRequirementCreateModel>>,
}

impl PasswordRequirementCreateArgs {
    /// Password Requirement Create Args
    pub fn new() -> PasswordRequirementCreateArgs {
