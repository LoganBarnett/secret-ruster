...
/// SecretDetailHookCreateArgs : Create Secret Hook Arguments
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretDetailHookCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretDetailHooksCreateModel>>,
}

impl SecretDetailHookCreateArgs {
    /// Create Secret Hook Arguments
    pub fn new() -> SecretDetailHookCreateArgs {
