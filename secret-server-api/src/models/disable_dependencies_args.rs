...
/// DisableDependenciesArgs : DisableDependenciesArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableDependenciesArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DisableDependenciesModel>>,
}

impl DisableDependenciesArgs {
    /// DisableDependenciesArgs
    pub fn new() -> DisableDependenciesArgs {
        DisableDependenciesArgs {
            data: None,
        }
    }
