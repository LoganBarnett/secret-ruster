...
/// PagingOfPasswordTypeSecretUsageModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfPasswordTypeSecretUsageModel {
    ...
    pub records: Option<Vec<models::PasswordTypeSecretUsageModel>>,
...
impl PagingOfPasswordTypeSecretUsageModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfPasswordTypeSecretUsageModel {
