...
/// DiscoveryScannerSettingCreateData : Create discovery scanner settings
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryScannerSettingCreateData {
    /// DiscoveryScanTypeId to create
    #[serde(rename = "discoveryScanTypeId", skip_serializing_if = "Option::is_none")]
    pub discovery_scan_type_id: Option<i32>,
}

impl DiscoveryScannerSettingCreateData {
    /// Create discovery scanner settings
    pub fn new() -> DiscoveryScannerSettingCreateData {
