...
/// LauncherTypePatchArgs : Patch a launcher type
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LauncherTypePatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::LauncherTypePatchData>>,
}

impl LauncherTypePatchArgs {
    /// Patch a launcher type
    pub fn new() -> LauncherTypePatchArgs {
