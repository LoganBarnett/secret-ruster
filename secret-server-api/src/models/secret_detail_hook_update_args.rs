...
/// SecretDetailHookUpdateArgs : SecretDetailHookUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretDetailHookUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretDetailHookUpdateModel>>,
}

impl SecretDetailHookUpdateArgs {
    /// SecretDetailHookUpdateArgs
    pub fn new() -> SecretDetailHookUpdateArgs {
        SecretDetailHookUpdateArgs {
            data: None,
        }
    }
