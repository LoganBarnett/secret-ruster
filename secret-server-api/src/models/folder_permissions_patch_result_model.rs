...
/// FolderPermissionsPatchResultModel : FolderPermissionsPatchResultModel
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct FolderPermissionsPatchResultModel {
    /// Success
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl FolderPermissionsPatchResultModel {
    /// FolderPermissionsPatchResultModel
    pub fn new() -> FolderPermissionsPatchResultModel {
        FolderPermissionsPatchResultModel {
            success: None,
        }
    }
