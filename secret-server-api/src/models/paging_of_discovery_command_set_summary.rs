...
/// PagingOfDiscoveryCommandSetSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfDiscoveryCommandSetSummary {
    ...
    pub records: Option<Vec<models::DiscoveryCommandSetSummary>>,
...
impl PagingOfDiscoveryCommandSetSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfDiscoveryCommandSetSummary {
