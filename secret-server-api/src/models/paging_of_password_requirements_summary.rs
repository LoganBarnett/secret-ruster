...
/// PagingOfPasswordRequirementsSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfPasswordRequirementsSummary {
    ...
    pub records: Option<Vec<models::PasswordRequirementsSummary>>,
...
impl PagingOfPasswordRequirementsSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfPasswordRequirementsSummary {
