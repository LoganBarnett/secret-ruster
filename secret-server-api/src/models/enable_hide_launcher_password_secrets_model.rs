...
/// EnableHideLauncherPasswordSecretsModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableHideLauncherPasswordSecretsModel {
    /// Ids of Secrets to set Hide Launcher Password to enabled.
    #[serde(rename = "secretIds", skip_serializing_if = "Option::is_none")]
    pub secret_ids: Option<Vec<i32>>,
}

impl EnableHideLauncherPasswordSecretsModel {
    /// Data
    pub fn new() -> EnableHideLauncherPasswordSecretsModel {
