...
/// ConfigurationRpcPatchArgs : ConfigurationRpcPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationRpcPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConfigurationRpcPatchModel>>,
}

impl ConfigurationRpcPatchArgs {
    /// ConfigurationRpcPatchArgs
    pub fn new() -> ConfigurationRpcPatchArgs {
        ConfigurationRpcPatchArgs {
            data: None,
        }
    }
