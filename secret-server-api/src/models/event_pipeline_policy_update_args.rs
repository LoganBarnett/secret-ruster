...
/// EventPipelinePolicyUpdateArgs : EventPipelinePolicyUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EventPipelinePolicyUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EventPipelinePolicyUpdateModel>>,
}

impl EventPipelinePolicyUpdateArgs {
    /// EventPipelinePolicyUpdateArgs
    pub fn new() -> EventPipelinePolicyUpdateArgs {
        EventPipelinePolicyUpdateArgs {
            data: None,
        }
    }
