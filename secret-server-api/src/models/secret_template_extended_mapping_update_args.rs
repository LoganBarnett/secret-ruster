...
/// SecretTemplateExtendedMappingUpdateArgs : SecretTemplateExtendedMappingUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretTemplateExtendedMappingUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretTemplateExtendedMappingUpdateModel>>,
}

impl SecretTemplateExtendedMappingUpdateArgs {
    /// SecretTemplateExtendedMappingUpdateArgs
    pub fn new() -> SecretTemplateExtendedMappingUpdateArgs {
        SecretTemplateExtendedMappingUpdateArgs {
            data: None,
        }
    }
