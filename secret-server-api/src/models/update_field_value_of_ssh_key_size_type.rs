...
/// UpdateFieldValueOfSshKeySizeType : Size of the SSH Key in bits, updated when the template contains a private SSH Key
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfSshKeySizeType {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<models::SshKeySizeType>,
}

impl UpdateFieldValueOfSshKeySizeType {
    /// Size of the SSH Key in bits, updated when the template contains a private SSH Key
    pub fn new() -> UpdateFieldValueOfSshKeySizeType {
