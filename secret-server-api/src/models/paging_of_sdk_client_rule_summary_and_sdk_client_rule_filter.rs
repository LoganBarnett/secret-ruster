...
/// PagingOfSdkClientRuleSummaryAndSdkClientRuleFilter : Specify filtering, paging, sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSdkClientRuleSummaryAndSdkClientRuleFilter {
    ...
    pub filter: Option<Box<models::SdkClientRuleFilter>>,
    ...
    pub records: Option<Vec<models::SdkClientRuleSummary>>,
...
impl PagingOfSdkClientRuleSummaryAndSdkClientRuleFilter {
    /// Specify filtering, paging, sorting options for querying records and returning results
    pub fn new() -> PagingOfSdkClientRuleSummaryAndSdkClientRuleFilter {
