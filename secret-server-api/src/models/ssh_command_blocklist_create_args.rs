...
/// SshCommandBlocklistCreateArgs : Options to create SSH Command Blocklist
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SshCommandBlocklistCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SshCommandBlocklistCreateModel>>,
}

impl SshCommandBlocklistCreateArgs {
    /// Options to create SSH Command Blocklist
    pub fn new() -> SshCommandBlocklistCreateArgs {
