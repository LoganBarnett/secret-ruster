...
/// LauncherTypeCreateArgs : Create a launcher type
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LauncherTypeCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::LauncherTypeCreateData>>,
}

impl LauncherTypeCreateArgs {
    /// Create a launcher type
    pub fn new() -> LauncherTypeCreateArgs {
