...
/// PagingOfPlatformDataIntegrationDomainSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfPlatformDataIntegrationDomainSummary {
    ...
    pub records: Option<Vec<models::PlatformDataIntegrationDomainSummary>>,
...
impl PagingOfPlatformDataIntegrationDomainSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfPlatformDataIntegrationDomainSummary {
