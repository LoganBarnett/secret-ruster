...
/// UpdateFieldValueOfOptionalForceSecretApprovalType : Force approval type on Secrets that have approval
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfOptionalForceSecretApprovalType {
    /// Dirty
...
impl UpdateFieldValueOfOptionalForceSecretApprovalType {
    /// Force approval type on Secrets that have approval
    pub fn new() -> UpdateFieldValueOfOptionalForceSecretApprovalType {
