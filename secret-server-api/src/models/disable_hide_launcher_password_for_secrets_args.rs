...
/// DisableHideLauncherPasswordForSecretsArgs : DisableHideLauncherPasswordForSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableHideLauncherPasswordForSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DisableHideLauncherPasswordForSecretsModel>>,
}

impl DisableHideLauncherPasswordForSecretsArgs {
    /// DisableHideLauncherPasswordForSecretsArgs
    pub fn new() -> DisableHideLauncherPasswordForSecretsArgs {
        DisableHideLauncherPasswordForSecretsArgs {
            data: None,
        }
    }
