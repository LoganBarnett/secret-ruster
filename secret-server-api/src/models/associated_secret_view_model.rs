...
/// AssociatedSecretViewModel : Associated Secrets
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AssociatedSecretViewModel {
    /// FolderId
...
impl AssociatedSecretViewModel {
    /// Associated Secrets
    pub fn new() -> AssociatedSecretViewModel {
        AssociatedSecretViewModel {
            folder_id: None,
            folder_name: None,
            order: None,
            secret_id: None,
