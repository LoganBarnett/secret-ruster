...
/// SecretLauncherSessionActionResult : Secret Launcher Session Action Result
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretLauncherSessionActionResult {
    /// Was the operation a Success?
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl SecretLauncherSessionActionResult {
    /// Secret Launcher Session Action Result
    pub fn new() -> SecretLauncherSessionActionResult {
