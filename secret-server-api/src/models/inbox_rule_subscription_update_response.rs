...
/// InboxRuleSubscriptionUpdateResponse : InboxRuleSubscriptionUpdateResponse
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InboxRuleSubscriptionUpdateResponse {
    /// Success
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl InboxRuleSubscriptionUpdateResponse {
    /// InboxRuleSubscriptionUpdateResponse
    pub fn new() -> InboxRuleSubscriptionUpdateResponse {
        InboxRuleSubscriptionUpdateResponse {
            success: None,
        }
    }
