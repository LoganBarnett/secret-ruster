...
/// JumpboxRouteCreateArgs : JumpboxRouteCreateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct JumpboxRouteCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::JumpboxRouteCreateModel>>,
}

impl JumpboxRouteCreateArgs {
    /// JumpboxRouteCreateArgs
    pub fn new() -> JumpboxRouteCreateArgs {
        JumpboxRouteCreateArgs {
            data: None,
        }
    }
