...
/// DisableUsersArgs : DisableUsersArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableUsersArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DisableUsersModel>>,
}

impl DisableUsersArgs {
    /// DisableUsersArgs
    pub fn new() -> DisableUsersArgs {
        DisableUsersArgs {
            data: None,
        }
    }
