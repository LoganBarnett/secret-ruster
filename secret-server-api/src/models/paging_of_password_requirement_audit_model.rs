...
/// PagingOfPasswordRequirementAuditModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfPasswordRequirementAuditModel {
    ...
    pub records: Option<Vec<models::PasswordRequirementAuditModel>>,
...
impl PagingOfPasswordRequirementAuditModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfPasswordRequirementAuditModel {
