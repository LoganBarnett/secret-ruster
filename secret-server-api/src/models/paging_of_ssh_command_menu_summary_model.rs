...
/// PagingOfSshCommandMenuSummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSshCommandMenuSummaryModel {
    ...
    pub records: Option<Vec<models::SshCommandMenuSummaryModel>>,
...
impl PagingOfSshCommandMenuSummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSshCommandMenuSummaryModel {
