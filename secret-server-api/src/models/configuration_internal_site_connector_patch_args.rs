...
/// ConfigurationInternalSiteConnectorPatchArgs : ConfigurationInternalSiteConnectorPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationInternalSiteConnectorPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConfigurationInternalSiteConnectorPatchModel>>,
}

impl ConfigurationInternalSiteConnectorPatchArgs {
    /// ConfigurationInternalSiteConnectorPatchArgs
    pub fn new() -> ConfigurationInternalSiteConnectorPatchArgs {
        ConfigurationInternalSiteConnectorPatchArgs {
            data: None,
        }
    }
