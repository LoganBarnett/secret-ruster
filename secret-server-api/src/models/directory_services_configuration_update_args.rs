...
/// DirectoryServicesConfigurationUpdateArgs : DirectoryServicesConfigurationUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DirectoryServicesConfigurationUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DirectoryServicesConfigurationUpdateModel>>,
}

impl DirectoryServicesConfigurationUpdateArgs {
    /// DirectoryServicesConfigurationUpdateArgs
    pub fn new() -> DirectoryServicesConfigurationUpdateArgs {
        DirectoryServicesConfigurationUpdateArgs {
            data: None,
        }
    }
