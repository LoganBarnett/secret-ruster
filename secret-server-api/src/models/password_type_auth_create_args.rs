...
/// PasswordTypeAuthCreateArgs : Password Type Auth Create Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PasswordTypeAuthCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::PasswordTypeAuthCreateModel>>,
}

impl PasswordTypeAuthCreateArgs {
    /// Password Type Auth Create Args
    pub fn new() -> PasswordTypeAuthCreateArgs {
