...
/// PagingOfReportScheduleSummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfReportScheduleSummaryModel {
    ...
    pub records: Option<Vec<models::ReportScheduleSummaryModel>>,
...
impl PagingOfReportScheduleSummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfReportScheduleSummaryModel {
