...
/// SlackConfigurationUpdateArgsV2 : SlackConfigurationUpdateArgsV2
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SlackConfigurationUpdateArgsV2 {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SlackConfigurationUpdateModelV2>>,
}

impl SlackConfigurationUpdateArgsV2 {
    /// SlackConfigurationUpdateArgsV2
    pub fn new() -> SlackConfigurationUpdateArgsV2 {
        SlackConfigurationUpdateArgsV2 {
            data: None,
        }
    }
