...
/// CreateInitialUserArgs : CreateInitialUserArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CreateInitialUserArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::CreateInitialUserData>>,
}

impl CreateInitialUserArgs {
    /// CreateInitialUserArgs
    pub fn new() -> CreateInitialUserArgs {
        CreateInitialUserArgs {
            data: None,
        }
    }
