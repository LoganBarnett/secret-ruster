...
/// ScriptAdditionalDataModel : Additional data for this script including parameters and settings
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScriptAdditionalDataModel {
    #[serde(rename = "sqlSettings", skip_serializing_if = "Option::is_none")]
    pub sql_settings: Option<Box<models::ScriptSqlAdditionalDataModel>>,
    #[serde(rename = "sshSettings", skip_serializing_if = "Option::is_none")]
    pub ssh_settings: Option<Box<models::ScriptSshAdditionalDataModel>>,
}

impl ScriptAdditionalDataModel {
    /// Additional data for this script including parameters and settings
    pub fn new() -> ScriptAdditionalDataModel {
