...
/// SshCommandMenuCreateArgs : Options to create SSH Command Menu
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SshCommandMenuCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SshCommandMenuCreateModel>>,
}

impl SshCommandMenuCreateArgs {
    /// Options to create SSH Command Menu
    pub fn new() -> SshCommandMenuCreateArgs {
