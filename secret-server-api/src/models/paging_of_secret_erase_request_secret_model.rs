...
/// PagingOfSecretEraseRequestSecretModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSecretEraseRequestSecretModel {
    ...
    pub records: Option<Vec<models::SecretEraseRequestSecretModel>>,
...
impl PagingOfSecretEraseRequestSecretModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSecretEraseRequestSecretModel {
