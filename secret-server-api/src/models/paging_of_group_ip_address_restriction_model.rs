...
/// PagingOfGroupIpAddressRestrictionModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfGroupIpAddressRestrictionModel {
    ...
    pub records: Option<Vec<models::GroupIpAddressRestrictionModel>>,
...
impl PagingOfGroupIpAddressRestrictionModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfGroupIpAddressRestrictionModel {
