...
/// AssignSecretsToSiteArgs : AssignSecretsToSiteArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AssignSecretsToSiteArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::AssignSecretsToSiteModel>>,
}

impl AssignSecretsToSiteArgs {
    /// AssignSecretsToSiteArgs
    pub fn new() -> AssignSecretsToSiteArgs {
        AssignSecretsToSiteArgs {
            data: None,
        }
    }
