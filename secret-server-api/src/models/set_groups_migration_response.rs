...
/// SetGroupsMigrationResponse : Set Groups Migration Response
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SetGroupsMigrationResponse {
    /// Whether migration was set successfully.
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl SetGroupsMigrationResponse {
    /// Set Groups Migration Response
    pub fn new() -> SetGroupsMigrationResponse {
