...
/// ConfigurationEmailPatchArgs : ConfigurationEmailPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationEmailPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConfigurationEmailPatchModel>>,
}

impl ConfigurationEmailPatchArgs {
    /// ConfigurationEmailPatchArgs
    pub fn new() -> ConfigurationEmailPatchArgs {
        ConfigurationEmailPatchArgs {
            data: None,
        }
    }
