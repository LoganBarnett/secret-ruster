...
/// ConfigurationReadOnlyModeModel : Read Only Mode Configuration
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationReadOnlyModeModel {
    /// Whether read only mode is enabled.
    #[serde(rename = "enabled", skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
}

impl ConfigurationReadOnlyModeModel {
    /// Read Only Mode Configuration
    pub fn new() -> ConfigurationReadOnlyModeModel {
