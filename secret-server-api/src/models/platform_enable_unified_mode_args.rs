...
/// PlatformEnableUnifiedModeArgs : Args to be used when enabling Unified Mode
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlatformEnableUnifiedModeArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::PlatformEnableUnifiedModeModel>>,
}

impl PlatformEnableUnifiedModeArgs {
    /// Args to be used when enabling Unified Mode
    pub fn new() -> PlatformEnableUnifiedModeArgs {
