...
/// MdiIntegrationConfigurationArgs : MdiIntegrationConfigurationArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct MdiIntegrationConfigurationArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::MdiIntegrationConfigurationUpdateModel>>,
}

impl MdiIntegrationConfigurationArgs {
    /// MdiIntegrationConfigurationArgs
    pub fn new() -> MdiIntegrationConfigurationArgs {
        MdiIntegrationConfigurationArgs {
            data: None,
        }
    }
