...
/// InboxTemplateLocaleCreateArgs : InboxTemplateLocaleCreateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InboxTemplateLocaleCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::InboxTemplateLocaleCreateModel>>,
}

impl InboxTemplateLocaleCreateArgs {
    /// InboxTemplateLocaleCreateArgs
    pub fn new() -> InboxTemplateLocaleCreateArgs {
        InboxTemplateLocaleCreateArgs {
            data: None,
        }
    }
