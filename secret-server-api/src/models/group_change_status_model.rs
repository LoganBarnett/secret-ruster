...
/// GroupChangeStatusModel : The status of the group change action.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GroupChangeStatusModel {
    /// The success or failure of the user group action.
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl GroupChangeStatusModel {
    /// The status of the group change action.
    pub fn new() -> GroupChangeStatusModel {
