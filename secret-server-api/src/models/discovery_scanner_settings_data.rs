...
/// DiscoveryScannerSettingsData : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryScannerSettingsData {
    /// Settings
    #[serde(rename = "settings", skip_serializing_if = "Option::is_none")]
    pub settings: Option<Vec<models::DiscoveryScannerSettingValue>>,
}

impl DiscoveryScannerSettingsData {
    /// Data
    pub fn new() -> DiscoveryScannerSettingsData {
        DiscoveryScannerSettingsData {
            settings: None,
        }
    }
}
