...
/// AssociatedSecretUpdateArgs : Associated Secret Update Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AssociatedSecretUpdateArgs {
    /// Associated Secret Update Model
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::AssociatedSecretUpdateModel>>,
}

impl AssociatedSecretUpdateArgs {
    /// Associated Secret Update Args
    pub fn new() -> AssociatedSecretUpdateArgs {
        AssociatedSecretUpdateArgs {
            data: None,
        }
    }
}
