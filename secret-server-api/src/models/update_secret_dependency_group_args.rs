...
/// UpdateSecretDependencyGroupArgs : UpdateSecretDependencyGroupArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateSecretDependencyGroupArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::UpdateSecretDependencyGroupModel>>,
}

impl UpdateSecretDependencyGroupArgs {
    /// UpdateSecretDependencyGroupArgs
    pub fn new() -> UpdateSecretDependencyGroupArgs {
        UpdateSecretDependencyGroupArgs {
            data: None,
        }
    }
