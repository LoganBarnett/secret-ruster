...
/// DomainNameIndexUpdateArgs : DomainNameIndexUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DomainNameIndexUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DomainNameIndexUpdateModel>>,
}

impl DomainNameIndexUpdateArgs {
    /// DomainNameIndexUpdateArgs
    pub fn new() -> DomainNameIndexUpdateArgs {
        DomainNameIndexUpdateArgs {
            data: None,
        }
    }
