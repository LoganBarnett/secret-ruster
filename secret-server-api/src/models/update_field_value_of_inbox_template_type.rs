...
/// UpdateFieldValueOfInboxTemplateType : TemplateType
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfInboxTemplateType {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<models::InboxTemplateType>,
}

impl UpdateFieldValueOfInboxTemplateType {
    /// TemplateType
    pub fn new() -> UpdateFieldValueOfInboxTemplateType {
