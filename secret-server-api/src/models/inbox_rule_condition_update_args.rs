...
/// InboxRuleConditionUpdateArgs : InboxRuleConditionUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InboxRuleConditionUpdateArgs {
    /// Data
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::InboxRuleConditionUpdateModel>>,
}

impl InboxRuleConditionUpdateArgs {
    /// InboxRuleConditionUpdateArgs
    pub fn new() -> InboxRuleConditionUpdateArgs {
        InboxRuleConditionUpdateArgs {
            data: None,
        }
    }
