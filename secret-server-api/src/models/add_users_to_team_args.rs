...
/// AddUsersToTeamArgs : AddUsersToTeamArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AddUsersToTeamArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::AddUsersToTeamModel>>,
}

impl AddUsersToTeamArgs {
    /// AddUsersToTeamArgs
    pub fn new() -> AddUsersToTeamArgs {
        AddUsersToTeamArgs {
            data: None,
        }
    }
