...
/// SecretDetailUpdateSecurityGeneralArgs : Secret General Information Update Message
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretDetailUpdateSecurityGeneralArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretDetailSecurityGeneralUpdateModel>>,
}

impl SecretDetailUpdateSecurityGeneralArgs {
    /// Secret General Information Update Message
    pub fn new() -> SecretDetailUpdateSecurityGeneralArgs {
