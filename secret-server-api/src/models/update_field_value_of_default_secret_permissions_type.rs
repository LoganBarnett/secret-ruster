...
/// UpdateFieldValueOfDefaultSecretPermissionsType : When a new Secret is created these permissions will be assigned
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfDefaultSecretPermissionsType {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<models::DefaultSecretPermissionsType>,
}

impl UpdateFieldValueOfDefaultSecretPermissionsType {
    /// When a new Secret is created these permissions will be assigned
    pub fn new() -> UpdateFieldValueOfDefaultSecretPermissionsType {
