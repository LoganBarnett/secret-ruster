...
/// EnableInheritPermissionsSecretsArgs : EnableInheritPermissionsSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableInheritPermissionsSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EnableInheritPermissionsSecretsModel>>,
}

impl EnableInheritPermissionsSecretsArgs {
    /// EnableInheritPermissionsSecretsArgs
    pub fn new() -> EnableInheritPermissionsSecretsArgs {
        EnableInheritPermissionsSecretsArgs {
            data: None,
        }
    }
