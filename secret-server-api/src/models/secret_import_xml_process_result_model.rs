...
/// SecretImportXmlProcessResultModel : SecretImportXmlProcessResultModel
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretImportXmlProcessResultModel {
    /// TaskIdentifier
    #[serde(rename = "taskIdentifier", skip_serializing_if = "Option::is_none")]
    pub task_identifier: Option<String>,
}

impl SecretImportXmlProcessResultModel {
    /// SecretImportXmlProcessResultModel
    pub fn new() -> SecretImportXmlProcessResultModel {
        SecretImportXmlProcessResultModel {
