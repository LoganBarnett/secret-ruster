...
/// PagingOfSecretPermissionSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSecretPermissionSummary {
    ...
    pub records: Option<Vec<models::SecretPermissionSummary>>,
...
impl PagingOfSecretPermissionSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSecretPermissionSummary {
