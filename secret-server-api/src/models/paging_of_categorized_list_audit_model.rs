...
/// PagingOfCategorizedListAuditModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfCategorizedListAuditModel {
    ...
    pub records: Option<Vec<models::CategorizedListAuditModel>>,
...
impl PagingOfCategorizedListAuditModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfCategorizedListAuditModel {
