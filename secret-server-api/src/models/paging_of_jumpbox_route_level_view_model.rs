...
/// PagingOfJumpboxRouteLevelViewModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfJumpboxRouteLevelViewModel {
    ...
    pub records: Option<Vec<models::JumpboxRouteLevelViewModel>>,
...
impl PagingOfJumpboxRouteLevelViewModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfJumpboxRouteLevelViewModel {
