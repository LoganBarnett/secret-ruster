...
/// BulkOperationResponseMessage : BulkOperationResponseMessage
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct BulkOperationResponseMessage {
    /// BulkOperationId
    #[serde(rename = "bulkOperationId", skip_serializing_if = "Option::is_none")]
    pub bulk_operation_id: Option<String>,
}

impl BulkOperationResponseMessage {
    /// BulkOperationResponseMessage
    pub fn new() -> BulkOperationResponseMessage {
        BulkOperationResponseMessage {
