...
/// InboxRuleCreateArgs : InboxRuleCreateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InboxRuleCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::InboxRuleCreateModel>>,
}

impl InboxRuleCreateArgs {
    /// InboxRuleCreateArgs
    pub fn new() -> InboxRuleCreateArgs {
        InboxRuleCreateArgs {
            data: None,
        }
    }
