...
/// PagingOfCategorizedListItemModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfCategorizedListItemModel {
    ...
    pub records: Option<Vec<models::CategorizedListItemModel>>,
...
impl PagingOfCategorizedListItemModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfCategorizedListItemModel {
