...
/// UpdateFieldValueOfOptionalAuthType : AuthType for OpenLdap
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfOptionalAuthType {
    /// Dirty
...
impl UpdateFieldValueOfOptionalAuthType {
    /// AuthType for OpenLdap
    pub fn new() -> UpdateFieldValueOfOptionalAuthType {
