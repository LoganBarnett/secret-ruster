...
/// CreateInitialUserResponseModel : CreateInitialUserResponseModel
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CreateInitialUserResponseModel {
    /// Success
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl CreateInitialUserResponseModel {
    /// CreateInitialUserResponseModel
    pub fn new() -> CreateInitialUserResponseModel {
        CreateInitialUserResponseModel {
            success: None,
        }
    }
