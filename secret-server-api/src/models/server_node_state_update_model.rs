...
/// ServerNodeStateUpdateModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ServerNodeStateUpdateModel {
    #[serde(rename = "enableClustering", skip_serializing_if = "Option::is_none")]
    pub enable_clustering: Option<Box<models::UpdateFieldValueOfBoolean>>,
}

impl ServerNodeStateUpdateModel {
    /// Data
    pub fn new() -> ServerNodeStateUpdateModel {
