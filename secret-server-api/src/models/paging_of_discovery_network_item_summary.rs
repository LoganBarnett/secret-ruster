...
/// PagingOfDiscoveryNetworkItemSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfDiscoveryNetworkItemSummary {
    ...
    pub records: Option<Vec<models::DiscoveryNetworkItemSummary>>,
...
impl PagingOfDiscoveryNetworkItemSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfDiscoveryNetworkItemSummary {
