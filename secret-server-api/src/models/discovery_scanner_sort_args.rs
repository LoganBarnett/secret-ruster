...
/// DiscoveryScannerSortArgs : Sort scanner args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryScannerSortArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryScannerSortData>>,
}

impl DiscoveryScannerSortArgs {
    /// Sort scanner args
    pub fn new() -> DiscoveryScannerSortArgs {
