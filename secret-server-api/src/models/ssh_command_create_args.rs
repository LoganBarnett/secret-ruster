...
/// SshCommandCreateArgs : Options to create SSH Command
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SshCommandCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SshCommandCreateModel>>,
}

impl SshCommandCreateArgs {
    /// Options to create SSH Command
    pub fn new() -> SshCommandCreateArgs {
