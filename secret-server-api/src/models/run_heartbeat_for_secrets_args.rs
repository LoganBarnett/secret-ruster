...
/// RunHeartbeatForSecretsArgs : RunHeartbeatForSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct RunHeartbeatForSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::RunHeartbeatForSecretsModel>>,
}

impl RunHeartbeatForSecretsArgs {
    /// RunHeartbeatForSecretsArgs
    pub fn new() -> RunHeartbeatForSecretsArgs {
        RunHeartbeatForSecretsArgs {
            data: None,
        }
    }
