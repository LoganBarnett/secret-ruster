...
/// DiscoveryCommandSetUpdateArgs : Update args for a command set
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryCommandSetUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryCommandSetUpdateData>>,
}

impl DiscoveryCommandSetUpdateArgs {
    /// Update args for a command set
    pub fn new() -> DiscoveryCommandSetUpdateArgs {
