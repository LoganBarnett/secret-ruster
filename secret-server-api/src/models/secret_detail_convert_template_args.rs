...
/// SecretDetailConvertTemplateArgs : Wrapper around secret template conversion arguments
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretDetailConvertTemplateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConvertTemplateActionModel>>,
}

impl SecretDetailConvertTemplateArgs {
    /// Wrapper around secret template conversion arguments
    pub fn new() -> SecretDetailConvertTemplateArgs {
