...
/// PlatformUpdateUnifiedModeStatusResponse : Platform Update Unified Mode Status Response
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlatformUpdateUnifiedModeStatusResponse {
    /// Success
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl PlatformUpdateUnifiedModeStatusResponse {
    /// Platform Update Unified Mode Status Response
    pub fn new() -> PlatformUpdateUnifiedModeStatusResponse {
        PlatformUpdateUnifiedModeStatusResponse {
            success: None,
        }
    }
}
