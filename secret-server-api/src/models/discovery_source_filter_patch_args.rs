...
/// DiscoverySourceFilterPatchArgs : DiscoverySourceFilterPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoverySourceFilterPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DomainDiscoveryScopeFilterPatchModel>>,
}

impl DiscoverySourceFilterPatchArgs {
    /// DiscoverySourceFilterPatchArgs
    pub fn new() -> DiscoverySourceFilterPatchArgs {
        DiscoverySourceFilterPatchArgs {
            data: None,
        }
    }
