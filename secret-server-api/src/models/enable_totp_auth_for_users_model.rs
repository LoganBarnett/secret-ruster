...
/// EnableTotpAuthForUsersModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableTotpAuthForUsersModel {
    /// User Ids to set TOTP Auth to enabled.
    #[serde(rename = "userIds", skip_serializing_if = "Option::is_none")]
    pub user_ids: Option<Vec<i32>>,
}

impl EnableTotpAuthForUsersModel {
    /// Data
    pub fn new() -> EnableTotpAuthForUsersModel {
