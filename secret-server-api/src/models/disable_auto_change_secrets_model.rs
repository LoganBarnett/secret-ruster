...
/// DisableAutoChangeSecretsModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableAutoChangeSecretsModel {
    /// Ids of Secrets to set AutoChange to disabled.
    #[serde(rename = "secretIds", skip_serializing_if = "Option::is_none")]
    pub secret_ids: Option<Vec<i32>>,
}

impl DisableAutoChangeSecretsModel {
    /// Data
    pub fn new() -> DisableAutoChangeSecretsModel {
