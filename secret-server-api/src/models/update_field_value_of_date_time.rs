...
/// UpdateFieldValueOfDateTime : BackupStartDateTime
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfDateTime {
    /// Dirty
...
impl UpdateFieldValueOfDateTime {
    /// BackupStartDateTime
    pub fn new() -> UpdateFieldValueOfDateTime {
