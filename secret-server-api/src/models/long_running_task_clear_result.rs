...
/// LongRunningTaskClearResult : LongRunningTaskClearResult
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LongRunningTaskClearResult {
    /// Success
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl LongRunningTaskClearResult {
    /// LongRunningTaskClearResult
    pub fn new() -> LongRunningTaskClearResult {
        LongRunningTaskClearResult {
            success: None,
        }
    }
