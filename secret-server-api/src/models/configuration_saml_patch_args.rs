...
/// ConfigurationSamlPatchArgs : ConfigurationSamlPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationSamlPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConfigurationSamlPatchModel>>,
}

impl ConfigurationSamlPatchArgs {
    /// ConfigurationSamlPatchArgs
    pub fn new() -> ConfigurationSamlPatchArgs {
        ConfigurationSamlPatchArgs {
            data: None,
        }
    }
