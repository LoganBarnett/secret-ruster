...
/// PagingOfMdiIntegrationConfigurationAuditViewModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfMdiIntegrationConfigurationAuditViewModel {
    ...
    pub records: Option<Vec<models::MdiIntegrationConfigurationAuditViewModel>>,
...
impl PagingOfMdiIntegrationConfigurationAuditViewModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfMdiIntegrationConfigurationAuditViewModel {
