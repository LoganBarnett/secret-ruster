...
/// SessionFrameModel : SessionFrameModel[]
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SessionFrameModel {
    /// Capture Time
    #[serde(rename = "captureTime", skip_serializing_if = "Option::is_none")]
...
impl SessionFrameModel {
    /// SessionFrameModel[]
    pub fn new() -> SessionFrameModel {
        SessionFrameModel {
            capture_time: None,
            description: None,
            image_id: None,
