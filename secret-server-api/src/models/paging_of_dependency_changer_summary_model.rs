...
/// PagingOfDependencyChangerSummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfDependencyChangerSummaryModel {
    ...
    pub records: Option<Vec<models::DependencyChangerSummaryModel>>,
...
impl PagingOfDependencyChangerSummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfDependencyChangerSummaryModel {
