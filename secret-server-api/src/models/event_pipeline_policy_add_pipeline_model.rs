...
/// EventPipelinePolicyAddPipelineModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EventPipelinePolicyAddPipelineModel {
    #[serde(rename = "eventPipelineId", skip_serializing_if = "Option::is_none")]
    pub event_pipeline_id: Option<Box<models::UpdateFieldValueOfInt32>>,
}

impl EventPipelinePolicyAddPipelineModel {
    /// Data
    pub fn new() -> EventPipelinePolicyAddPipelineModel {
