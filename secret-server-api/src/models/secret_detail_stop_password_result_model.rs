...
/// SecretDetailStopPasswordResultModel : SecretDetailStopPasswordResultModel
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretDetailStopPasswordResultModel {
    /// Success
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl SecretDetailStopPasswordResultModel {
    /// SecretDetailStopPasswordResultModel
    pub fn new() -> SecretDetailStopPasswordResultModel {
        SecretDetailStopPasswordResultModel {
            success: None,
        }
    }
