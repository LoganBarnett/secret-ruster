...
/// WorkflowStepTemplateUpdateArgs : WorkflowStepTemplateUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct WorkflowStepTemplateUpdateArgs {
    /// WorkflowStepTemplates
    #[serde(rename = "workflowStepTemplates", skip_serializing_if = "Option::is_none")]
    pub workflow_step_templates: Option<Vec<models::WorkflowStepTemplateDetailModel>>,
}

impl WorkflowStepTemplateUpdateArgs {
    /// WorkflowStepTemplateUpdateArgs
    pub fn new() -> WorkflowStepTemplateUpdateArgs {
        WorkflowStepTemplateUpdateArgs {
            workflow_step_templates: None,
        }
    }
}
