...
/// PagingOfSecretTemplateListModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSecretTemplateListModel {
    ...
    pub records: Option<Vec<models::SecretTemplateListModel>>,
...
impl PagingOfSecretTemplateListModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSecretTemplateListModel {
