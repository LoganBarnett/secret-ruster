...
/// InboxTemplateCopyArgs : InboxTemplateCopyArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InboxTemplateCopyArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::InboxTemplateCopyModel>>,
}

impl InboxTemplateCopyArgs {
    /// InboxTemplateCopyArgs
    pub fn new() -> InboxTemplateCopyArgs {
        InboxTemplateCopyArgs {
            data: None,
        }
    }
