...
/// ReportPermissionsUpdateArgs : Report Permissions Update Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ReportPermissionsUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ReportPermissionsUpdateModel>>,
}

impl ReportPermissionsUpdateArgs {
    /// Report Permissions Update Args
    pub fn new() -> ReportPermissionsUpdateArgs {
