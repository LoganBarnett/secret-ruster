...
/// PagingOfSdkClientAccountSummaryAndSdkClientAccountFilter : Specify filtering, paging, sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSdkClientAccountSummaryAndSdkClientAccountFilter {
    ...
    pub filter: Option<Box<models::SdkClientAccountFilter>>,
    ...
    pub records: Option<Vec<models::SdkClientAccountSummary>>,
...
impl PagingOfSdkClientAccountSummaryAndSdkClientAccountFilter {
    /// Specify filtering, paging, sorting options for querying records and returning results
    pub fn new() -> PagingOfSdkClientAccountSummaryAndSdkClientAccountFilter {
