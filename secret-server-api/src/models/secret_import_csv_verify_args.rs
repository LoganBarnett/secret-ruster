...
/// SecretImportCsvVerifyArgs : SecretImportCsvVerifyArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretImportCsvVerifyArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretImportCsvVerifyData>>,
}

impl SecretImportCsvVerifyArgs {
    /// SecretImportCsvVerifyArgs
    pub fn new() -> SecretImportCsvVerifyArgs {
        SecretImportCsvVerifyArgs {
            data: None,
        }
    }
