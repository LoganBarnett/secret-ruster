...
/// EnableDuoAuthForUsersArgs : EnableDuoAuthForUsersArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableDuoAuthForUsersArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EnableDuoAuthForUsersModel>>,
}

impl EnableDuoAuthForUsersArgs {
    /// EnableDuoAuthForUsersArgs
    pub fn new() -> EnableDuoAuthForUsersArgs {
        EnableDuoAuthForUsersArgs {
            data: None,
        }
    }
