...
/// SecretTemplateLauncherCreateArgs : SecretTemplateLauncherCreateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretTemplateLauncherCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretTemplateLauncherCreateModel>>,
}

impl SecretTemplateLauncherCreateArgs {
    /// SecretTemplateLauncherCreateArgs
    pub fn new() -> SecretTemplateLauncherCreateArgs {
        SecretTemplateLauncherCreateArgs {
            data: None,
        }
    }
