...
/// SecretDetailRestrictedSshCommandMenuPermissionUpdateModel : Secret Detail SSH Command Menu Permission Update Model
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretDetailRestrictedSshCommandMenuPermissionUpdateModel {
    /// Group Id
...
impl SecretDetailRestrictedSshCommandMenuPermissionUpdateModel {
    /// Secret Detail SSH Command Menu Permission Update Model
    pub fn new() -> SecretDetailRestrictedSshCommandMenuPermissionUpdateModel {
