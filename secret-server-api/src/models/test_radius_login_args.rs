...
/// TestRadiusLoginArgs : TestRadiusLoginArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TestRadiusLoginArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::TestRadiusLoginRequestModel>>,
}

impl TestRadiusLoginArgs {
    /// TestRadiusLoginArgs
    pub fn new() -> TestRadiusLoginArgs {
        TestRadiusLoginArgs {
            data: None,
        }
    }
