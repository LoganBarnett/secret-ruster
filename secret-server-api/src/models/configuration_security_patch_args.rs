...
/// ConfigurationSecurityPatchArgs : ConfigurationSecurityPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationSecurityPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConfigurationSecurityPatchModel>>,
}

impl ConfigurationSecurityPatchArgs {
    /// ConfigurationSecurityPatchArgs
    pub fn new() -> ConfigurationSecurityPatchArgs {
        ConfigurationSecurityPatchArgs {
            data: None,
        }
    }
