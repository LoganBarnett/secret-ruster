...
/// ApplicationAccessRequestUpdateModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApplicationAccessRequestUpdateModel {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<Box<models::UpdateFieldValueOfApplicationAccessStatusRequestType>>,
}

impl ApplicationAccessRequestUpdateModel {
    /// Data
    pub fn new() -> ApplicationAccessRequestUpdateModel {
