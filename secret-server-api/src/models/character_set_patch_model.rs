...
/// CharacterSetPatchModel : Character Set Patch Model
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CharacterSetPatchModel {
    #[serde(rename = "abbreviation", skip_serializing_if = "Option::is_none")]
    pub abbreviation: Option<Box<models::UpdateFieldValueOfString>>,
...
impl CharacterSetPatchModel {
    /// Character Set Patch Model
    pub fn new() -> CharacterSetPatchModel {
