...
/// PagingOfSecretTemplateLauncherSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSecretTemplateLauncherSummary {
    ...
    pub records: Option<Vec<models::SecretTemplateLauncherSummary>>,
...
impl PagingOfSecretTemplateLauncherSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSecretTemplateLauncherSummary {
