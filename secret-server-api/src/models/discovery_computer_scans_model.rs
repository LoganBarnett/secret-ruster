...
/// DiscoveryComputerScansModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryComputerScansModel {
    /// ComputerScans
    #[serde(rename = "computerScans", skip_serializing_if = "Option::is_none")]
    pub computer_scans: Option<Vec<models::DiscoveryComputerScanModel>>,
}

impl DiscoveryComputerScansModel {
    /// Data
    pub fn new() -> DiscoveryComputerScansModel {
        DiscoveryComputerScansModel {
            computer_scans: None,
        }
    }
}
