...
/// FolderSynchronizationUpdateArgs : FolderSynchronizationUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct FolderSynchronizationUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::FolderSynchronizationUpdateModel>>,
}

impl FolderSynchronizationUpdateArgs {
    /// FolderSynchronizationUpdateArgs
    pub fn new() -> FolderSynchronizationUpdateArgs {
        FolderSynchronizationUpdateArgs {
            data: None,
        }
    }
