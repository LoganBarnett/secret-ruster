...
/// ApplicationAccessRequestUpdateArgs : ApplicationAccessRequestUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApplicationAccessRequestUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ApplicationAccessRequestUpdateModel>>,
}

impl ApplicationAccessRequestUpdateArgs {
    /// ApplicationAccessRequestUpdateArgs
    pub fn new() -> ApplicationAccessRequestUpdateArgs {
        ApplicationAccessRequestUpdateArgs {
            data: None,
        }
    }
