...
/// PagingOfProxyClientHistorySummaryAndSshProxyClientHistoryFilterQuery : Specify filtering, paging, sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfProxyClientHistorySummaryAndSshProxyClientHistoryFilterQuery {
    ...
    pub filter: Option<Box<models::SshProxyClientHistoryFilterQuery>>,
    ...
    pub records: Option<Vec<models::ProxyClientHistorySummary>>,
...
impl PagingOfProxyClientHistorySummaryAndSshProxyClientHistoryFilterQuery {
    /// Specify filtering, paging, sorting options for querying records and returning results
    pub fn new() -> PagingOfProxyClientHistorySummaryAndSshProxyClientHistoryFilterQuery {
