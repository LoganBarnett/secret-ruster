...
/// IpAddressRestrictionUpdateArgs : IpAddressRestrictionUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct IpAddressRestrictionUpdateArgs {
    /// Id
...
impl IpAddressRestrictionUpdateArgs {
    /// IpAddressRestrictionUpdateArgs
    pub fn new() -> IpAddressRestrictionUpdateArgs {
        IpAddressRestrictionUpdateArgs {
            id: None,
            name: None,
            range: None,
