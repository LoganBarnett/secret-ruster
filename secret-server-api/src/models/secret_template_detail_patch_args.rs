...
/// SecretTemplateDetailPatchArgs : SecretTemplateDetailPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretTemplateDetailPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretTemplateDetailPatchModel>>,
}

impl SecretTemplateDetailPatchArgs {
    /// SecretTemplateDetailPatchArgs
    pub fn new() -> SecretTemplateDetailPatchArgs {
        SecretTemplateDetailPatchArgs {
            data: None,
        }
    }
