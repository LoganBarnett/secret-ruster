...
/// PagingOfDiscoveryBaseScannerSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfDiscoveryBaseScannerSummary {
    ...
    pub records: Option<Vec<models::DiscoveryBaseScannerSummary>>,
...
impl PagingOfDiscoveryBaseScannerSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfDiscoveryBaseScannerSummary {
