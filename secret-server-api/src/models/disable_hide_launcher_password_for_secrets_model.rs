...
/// DisableHideLauncherPasswordForSecretsModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableHideLauncherPasswordForSecretsModel {
    /// Ids of Secrets to set Hide Launcher Password to disabled.
    #[serde(rename = "secretIds", skip_serializing_if = "Option::is_none")]
    pub secret_ids: Option<Vec<i32>>,
}

impl DisableHideLauncherPasswordForSecretsModel {
    /// Data
    pub fn new() -> DisableHideLauncherPasswordForSecretsModel {
