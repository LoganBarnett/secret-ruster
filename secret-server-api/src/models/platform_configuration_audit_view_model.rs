...
/// PlatformConfigurationAuditViewModel : Platform Configuration Audit
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlatformConfigurationAuditViewModel {
    /// Action
...
impl PlatformConfigurationAuditViewModel {
    /// Platform Configuration Audit
    pub fn new() -> PlatformConfigurationAuditViewModel {
