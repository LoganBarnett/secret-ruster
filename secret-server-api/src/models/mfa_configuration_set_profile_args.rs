...
/// MfaConfigurationSetProfileArgs : MfaConfigurationSetProfileArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct MfaConfigurationSetProfileArgs {
    /// AuthProfileId
    #[serde(rename = "authProfileId", skip_serializing_if = "Option::is_none")]
    pub auth_profile_id: Option<uuid::Uuid>,
}

impl MfaConfigurationSetProfileArgs {
    /// MfaConfigurationSetProfileArgs
    pub fn new() -> MfaConfigurationSetProfileArgs {
        MfaConfigurationSetProfileArgs {
