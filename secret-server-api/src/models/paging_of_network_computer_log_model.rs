...
/// PagingOfNetworkComputerLogModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfNetworkComputerLogModel {
    ...
    pub records: Option<Vec<models::NetworkComputerLogModel>>,
...
impl PagingOfNetworkComputerLogModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfNetworkComputerLogModel {
