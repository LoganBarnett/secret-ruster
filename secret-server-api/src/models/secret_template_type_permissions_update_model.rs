...
/// SecretTemplateTypePermissionsUpdateModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretTemplateTypePermissionsUpdateModel {
    /// Permissions
    #[serde(rename = "permissions", skip_serializing_if = "Option::is_none")]
    pub permissions: Option<Vec<models::SecretTemplateTypePermissionsUpdateGroup>>,
}

impl SecretTemplateTypePermissionsUpdateModel {
    /// Data
    pub fn new() -> SecretTemplateTypePermissionsUpdateModel {
