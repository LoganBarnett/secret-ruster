...
/// PagingOfIpAddressRestrictionSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfIpAddressRestrictionSummary {
    ...
    pub records: Option<Vec<models::IpAddressRestrictionSummary>>,
...
impl PagingOfIpAddressRestrictionSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfIpAddressRestrictionSummary {
