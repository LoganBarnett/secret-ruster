...
/// PagingOfSiteConnectorSummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSiteConnectorSummaryModel {
    ...
    pub records: Option<Vec<models::SiteConnectorSummaryModel>>,
...
impl PagingOfSiteConnectorSummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSiteConnectorSummaryModel {
