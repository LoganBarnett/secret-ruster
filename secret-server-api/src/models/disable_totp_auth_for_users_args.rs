...
/// DisableTotpAuthForUsersArgs : DisableTOTPAuthForUsersArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableTotpAuthForUsersArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DisableTotpAuthForUsersModel>>,
}

impl DisableTotpAuthForUsersArgs {
    /// DisableTOTPAuthForUsersArgs
    pub fn new() -> DisableTotpAuthForUsersArgs {
        DisableTotpAuthForUsersArgs {
            data: None,
        }
    }
