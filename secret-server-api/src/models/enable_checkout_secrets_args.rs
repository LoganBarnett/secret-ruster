...
/// EnableCheckoutSecretsArgs : EnableCheckoutSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableCheckoutSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EnableCheckoutSecretsModel>>,
}

impl EnableCheckoutSecretsArgs {
    /// EnableCheckoutSecretsArgs
    pub fn new() -> EnableCheckoutSecretsArgs {
        EnableCheckoutSecretsArgs {
            data: None,
        }
    }
