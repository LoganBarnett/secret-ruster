...
/// PagingOfConfigurationAuditItem : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfConfigurationAuditItem {
    ...
    pub records: Option<Vec<models::ConfigurationAuditItem>>,
