...
/// EventPipelinePolicyImportArgs : EventPipelinePolicyImportArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EventPipelinePolicyImportArgs {
    /// Data
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<String>,
}

impl EventPipelinePolicyImportArgs {
    /// EventPipelinePolicyImportArgs
    pub fn new() -> EventPipelinePolicyImportArgs {
        EventPipelinePolicyImportArgs {
            data: None,
        }
    }
