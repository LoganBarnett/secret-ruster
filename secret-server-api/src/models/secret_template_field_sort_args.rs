...
/// SecretTemplateFieldSortArgs : Secret Template Field Sort Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretTemplateFieldSortArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretTemplateFieldSortModel>>,
}

impl SecretTemplateFieldSortArgs {
    /// Secret Template Field Sort Args
    pub fn new() -> SecretTemplateFieldSortArgs {
