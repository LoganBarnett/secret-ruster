...
/// EnableEmailTwoFactorForUsersArgs : EnableEmailTwoFactorForUsersArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableEmailTwoFactorForUsersArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EnableEmailTwoFactorForUsersModel>>,
}

impl EnableEmailTwoFactorForUsersArgs {
    /// EnableEmailTwoFactorForUsersArgs
    pub fn new() -> EnableEmailTwoFactorForUsersArgs {
        EnableEmailTwoFactorForUsersArgs {
            data: None,
        }
    }
