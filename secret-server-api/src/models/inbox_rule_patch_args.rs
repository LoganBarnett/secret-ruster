...
/// InboxRulePatchArgs : InboxRulePatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InboxRulePatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::InboxRulePatchModel>>,
}

impl InboxRulePatchArgs {
    /// InboxRulePatchArgs
    pub fn new() -> InboxRulePatchArgs {
        InboxRulePatchArgs {
            data: None,
        }
    }
