...
/// PlatformDataMigrationSettings : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlatformDataMigrationSettings {
    /// GroupIds
    #[serde(rename = "groupIds", skip_serializing_if = "Option::is_none")]
    pub group_ids: Option<Vec<i32>>,
    /// MigrationName
    #[serde(rename = "migrationName", skip_serializing_if = "Option::is_none")]
...
impl PlatformDataMigrationSettings {
    /// Data
    pub fn new() -> PlatformDataMigrationSettings {
        PlatformDataMigrationSettings {
            group_ids: None,
            migration_name: None,
            user_ids: None,
        }
