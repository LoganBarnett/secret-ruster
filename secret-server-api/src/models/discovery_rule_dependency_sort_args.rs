...
/// DiscoveryRuleDependencySortArgs : Discovery Sort Rule Dependency Sort Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryRuleDependencySortArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryRuleDependencySortData>>,
}

impl DiscoveryRuleDependencySortArgs {
    /// Discovery Sort Rule Dependency Sort Args
    pub fn new() -> DiscoveryRuleDependencySortArgs {
