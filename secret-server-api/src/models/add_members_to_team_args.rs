...
/// AddMembersToTeamArgs : AddMembersToTeamArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AddMembersToTeamArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::AddMembersToTeamModel>>,
}

impl AddMembersToTeamArgs {
    /// AddMembersToTeamArgs
    pub fn new() -> AddMembersToTeamArgs {
        AddMembersToTeamArgs {
            data: None,
        }
    }
