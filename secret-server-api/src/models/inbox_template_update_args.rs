...
/// InboxTemplateUpdateArgs : InboxTemplateUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InboxTemplateUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::InboxTemplateUpdateModel>>,
}

impl InboxTemplateUpdateArgs {
    /// InboxTemplateUpdateArgs
    pub fn new() -> InboxTemplateUpdateArgs {
        InboxTemplateUpdateArgs {
            data: None,
        }
    }
