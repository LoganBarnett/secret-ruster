...
/// ReportCategoryCreateArgs : Report Category Create Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ReportCategoryCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ReportCategoryCreateModel>>,
}

impl ReportCategoryCreateArgs {
    /// Report Category Create Args
    pub fn new() -> ReportCategoryCreateArgs {
