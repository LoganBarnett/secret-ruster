...
/// CharacterSetCreateArgs : Character Set Create Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CharacterSetCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::CharacterSetCreateModel>>,
}

impl CharacterSetCreateArgs {
    /// Character Set Create Args
    pub fn new() -> CharacterSetCreateArgs {
