...
/// PlatformCreateUsersAndGroupsCommand : PlatformCreateUsersAndGroupsCommand
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlatformCreateUsersAndGroupsCommand {
    /// Data
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::PlatformCreateEntityItem>>,
}

impl PlatformCreateUsersAndGroupsCommand {
    /// PlatformCreateUsersAndGroupsCommand
    pub fn new() -> PlatformCreateUsersAndGroupsCommand {
        PlatformCreateUsersAndGroupsCommand {
            data: None,
        }
    }
