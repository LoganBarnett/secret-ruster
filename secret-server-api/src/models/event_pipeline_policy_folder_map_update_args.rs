...
/// EventPipelinePolicyFolderMapUpdateArgs : EventPipelinePolicyFolderMapUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EventPipelinePolicyFolderMapUpdateArgs {
    /// Data
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<i32>>,
}

impl EventPipelinePolicyFolderMapUpdateArgs {
    /// EventPipelinePolicyFolderMapUpdateArgs
    pub fn new() -> EventPipelinePolicyFolderMapUpdateArgs {
        EventPipelinePolicyFolderMapUpdateArgs {
            data: None,
        }
    }
