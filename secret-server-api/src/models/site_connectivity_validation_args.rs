...
/// SiteConnectivityValidationArgs : SiteConnectivityValidationArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SiteConnectivityValidationArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SiteConnectivityValidationModel>>,
}

impl SiteConnectivityValidationArgs {
    /// SiteConnectivityValidationArgs
    pub fn new() -> SiteConnectivityValidationArgs {
        SiteConnectivityValidationArgs {
            data: None,
        }
    }
