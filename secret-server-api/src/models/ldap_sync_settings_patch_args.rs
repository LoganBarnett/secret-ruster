...
/// LdapSyncSettingsPatchArgs : LdapSyncSettingsPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LdapSyncSettingsPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::LdapSyncSettingsPatchModel>>,
}

impl LdapSyncSettingsPatchArgs {
    /// LdapSyncSettingsPatchArgs
    pub fn new() -> LdapSyncSettingsPatchArgs {
        LdapSyncSettingsPatchArgs {
            data: None,
        }
    }
