...
/// DiscoverySourceCreateArgs : DiscoverySourceCreateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoverySourceCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoverySourceCreateModel>>,
}

impl DiscoverySourceCreateArgs {
    /// DiscoverySourceCreateArgs
    pub fn new() -> DiscoverySourceCreateArgs {
        DiscoverySourceCreateArgs {
            data: None,
        }
    }
