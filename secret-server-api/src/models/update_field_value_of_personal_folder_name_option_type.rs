...
/// UpdateFieldValueOfPersonalFolderNameOptionType : The format for the personal folder name for each user
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfPersonalFolderNameOptionType {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<models::PersonalFolderNameOptionType>,
}

impl UpdateFieldValueOfPersonalFolderNameOptionType {
    /// The format for the personal folder name for each user
    pub fn new() -> UpdateFieldValueOfPersonalFolderNameOptionType {
