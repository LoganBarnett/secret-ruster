...
/// DiscoveryConfigurationUpdateArgs : DiscoveryConfigurationUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryConfigurationUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryConfigurationUpdateModel>>,
}

impl DiscoveryConfigurationUpdateArgs {
    /// DiscoveryConfigurationUpdateArgs
    pub fn new() -> DiscoveryConfigurationUpdateArgs {
        DiscoveryConfigurationUpdateArgs {
            data: None,
        }
    }
