...
/// RecurringScheduleCreateArgs : RecurringScheduleCreateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct RecurringScheduleCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::RecurringScheduleCreateModel>>,
}

impl RecurringScheduleCreateArgs {
    /// RecurringScheduleCreateArgs
    pub fn new() -> RecurringScheduleCreateArgs {
        RecurringScheduleCreateArgs {
            data: None,
        }
    }
