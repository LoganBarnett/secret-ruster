...
/// PagingOfDevOpsSecretsVaultSyncStatusSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfDevOpsSecretsVaultSyncStatusSummary {
    ...
    pub records: Option<Vec<models::DevOpsSecretsVaultSyncStatusSummary>>,
...
impl PagingOfDevOpsSecretsVaultSyncStatusSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfDevOpsSecretsVaultSyncStatusSummary {
