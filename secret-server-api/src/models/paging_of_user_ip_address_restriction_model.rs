...
/// PagingOfUserIpAddressRestrictionModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfUserIpAddressRestrictionModel {
    ...
    pub records: Option<Vec<models::UserIpAddressRestrictionModel>>,
...
impl PagingOfUserIpAddressRestrictionModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfUserIpAddressRestrictionModel {
