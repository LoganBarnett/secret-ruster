...
/// PagingOfMasterEncryptionKeyRotationInfoAuditViewModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfMasterEncryptionKeyRotationInfoAuditViewModel {
    ...
    pub records: Option<Vec<models::MasterEncryptionKeyRotationInfoAuditViewModel>>,
...
impl PagingOfMasterEncryptionKeyRotationInfoAuditViewModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfMasterEncryptionKeyRotationInfoAuditViewModel {
