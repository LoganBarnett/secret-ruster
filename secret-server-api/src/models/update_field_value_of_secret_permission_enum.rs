...
/// UpdateFieldValueOfSecretPermissionEnum : Secret Permissions
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfSecretPermissionEnum {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<models::SecretPermissionEnum>,
}

impl UpdateFieldValueOfSecretPermissionEnum {
    /// Secret Permissions
    pub fn new() -> UpdateFieldValueOfSecretPermissionEnum {
