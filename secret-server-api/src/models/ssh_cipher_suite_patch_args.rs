...
/// SshCipherSuitePatchArgs : SSH Cipher Suite Patch arguments
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SshCipherSuitePatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SshCipherSuitePatchModel>>,
}

impl SshCipherSuitePatchArgs {
    /// SSH Cipher Suite Patch arguments
    pub fn new() -> SshCipherSuitePatchArgs {
