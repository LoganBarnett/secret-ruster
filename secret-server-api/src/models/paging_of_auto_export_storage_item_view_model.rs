...
/// PagingOfAutoExportStorageItemViewModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfAutoExportStorageItemViewModel {
    ...
    pub records: Option<Vec<models::AutoExportStorageItemViewModel>>,
...
impl PagingOfAutoExportStorageItemViewModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfAutoExportStorageItemViewModel {
