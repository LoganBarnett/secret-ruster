...
/// DisableCheckoutSecretsModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableCheckoutSecretsModel {
    /// Ids of Secrets to set Checkout to disabled.
    #[serde(rename = "secretIds", skip_serializing_if = "Option::is_none")]
    pub secret_ids: Option<Vec<i32>>,
}

impl DisableCheckoutSecretsModel {
    /// Data
    pub fn new() -> DisableCheckoutSecretsModel {
