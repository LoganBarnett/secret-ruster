...
/// RemoteScriptPsTestData : If this is a PS script populate these settings
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct RemoteScriptPsTestData {
    /// Any args that will get passed to the script
    #[serde(rename = "scriptArgs", skip_serializing_if = "Option::is_none")]
    pub script_args: Option<String>,
}

impl RemoteScriptPsTestData {
    /// If this is a PS script populate these settings
    pub fn new() -> RemoteScriptPsTestData {
