...
/// DevOpsSecretsVaultCreateSyncArgs : DevOpsSecretsVaultCreateSyncArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DevOpsSecretsVaultCreateSyncArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DevOpsSecretVaultSyncUpdateModel>>,
}

impl DevOpsSecretsVaultCreateSyncArgs {
    /// DevOpsSecretsVaultCreateSyncArgs
    pub fn new() -> DevOpsSecretsVaultCreateSyncArgs {
        DevOpsSecretsVaultCreateSyncArgs {
            data: None,
        }
    }
