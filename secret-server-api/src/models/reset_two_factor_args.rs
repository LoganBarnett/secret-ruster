...
/// ResetTwoFactorArgs : ResetTwoFactorArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ResetTwoFactorArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ResetTwoFactorRequestModel>>,
}

impl ResetTwoFactorArgs {
    /// ResetTwoFactorArgs
    pub fn new() -> ResetTwoFactorArgs {
        ResetTwoFactorArgs {
            data: None,
        }
    }
