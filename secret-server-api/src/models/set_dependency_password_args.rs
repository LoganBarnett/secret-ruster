...
/// SetDependencyPasswordArgs : SetDependencyPasswordArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SetDependencyPasswordArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SetDependencyPasswordModel>>,
}

impl SetDependencyPasswordArgs {
    /// SetDependencyPasswordArgs
    pub fn new() -> SetDependencyPasswordArgs {
        SetDependencyPasswordArgs {
            data: None,
        }
    }
