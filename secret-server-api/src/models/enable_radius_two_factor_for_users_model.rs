...
/// EnableRadiusTwoFactorForUsersModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableRadiusTwoFactorForUsersModel {
    /// User Ids to set Radius Two Factor to enabled.
    #[serde(rename = "userIds", skip_serializing_if = "Option::is_none")]
    pub user_ids: Option<Vec<i32>>,
}

impl EnableRadiusTwoFactorForUsersModel {
    /// Data
    pub fn new() -> EnableRadiusTwoFactorForUsersModel {
