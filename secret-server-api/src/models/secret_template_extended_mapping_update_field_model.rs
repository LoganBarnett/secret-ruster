...
/// SecretTemplateExtendedMappingUpdateFieldModel : Value
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretTemplateExtendedMappingUpdateFieldModel {
    /// ExtendedFieldId
...
impl SecretTemplateExtendedMappingUpdateFieldModel {
    /// Value
    pub fn new() -> SecretTemplateExtendedMappingUpdateFieldModel {
