...
/// UserGroupMapType : User Group Map Type
/// User Group Map Type
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum UserGroupMapType {
    #[serde(rename = "User")]
    User,
    #[serde(rename = "Group")]
    Group,
...
impl std::fmt::Display for UserGroupMapType {
...
impl Default for UserGroupMapType {
    fn default() -> UserGroupMapType {
        Self::User
    }
}
