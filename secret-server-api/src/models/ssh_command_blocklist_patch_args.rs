...
/// SshCommandBlocklistPatchArgs : SshCommandBlocklistPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SshCommandBlocklistPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SshCommandBlocklistPatchModel>>,
}

impl SshCommandBlocklistPatchArgs {
    /// SshCommandBlocklistPatchArgs
    pub fn new() -> SshCommandBlocklistPatchArgs {
        SshCommandBlocklistPatchArgs {
            data: None,
        }
    }
