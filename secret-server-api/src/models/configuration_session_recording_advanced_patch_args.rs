...
/// ConfigurationSessionRecordingAdvancedPatchArgs : ConfigurationSessionRecordingAdvancedPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationSessionRecordingAdvancedPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConfigurationSessionRecordingAdvancedPatchModel>>,
}

impl ConfigurationSessionRecordingAdvancedPatchArgs {
    /// ConfigurationSessionRecordingAdvancedPatchArgs
    pub fn new() -> ConfigurationSessionRecordingAdvancedPatchArgs {
        ConfigurationSessionRecordingAdvancedPatchArgs {
            data: None,
        }
    }
