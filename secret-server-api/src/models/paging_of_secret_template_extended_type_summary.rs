...
/// PagingOfSecretTemplateExtendedTypeSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSecretTemplateExtendedTypeSummary {
    ...
    pub records: Option<Vec<models::SecretTemplateExtendedTypeSummary>>,
...
impl PagingOfSecretTemplateExtendedTypeSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSecretTemplateExtendedTypeSummary {
