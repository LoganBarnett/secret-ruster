...
/// PagingOfTeamMembershipSearchModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfTeamMembershipSearchModel {
    ...
    pub records: Option<Vec<models::TeamMembershipSearchModel>>,
...
impl PagingOfTeamMembershipSearchModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfTeamMembershipSearchModel {
