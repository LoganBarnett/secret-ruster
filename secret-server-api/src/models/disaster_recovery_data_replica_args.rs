...
/// DisasterRecoveryDataReplicaArgs : DisasterRecoveryDataReplicaArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisasterRecoveryDataReplicaArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DisasterRecoveryDataReplicaUpdateModel>>,
}

impl DisasterRecoveryDataReplicaArgs {
    /// DisasterRecoveryDataReplicaArgs
    pub fn new() -> DisasterRecoveryDataReplicaArgs {
        DisasterRecoveryDataReplicaArgs {
            data: None,
        }
    }
