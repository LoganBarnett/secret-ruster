...
/// ConfigurationSamlIdentityProviderCreateArgs : ConfigurationSamlIdentityProviderCreateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationSamlIdentityProviderCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConfigurationSamlIdentityProviderCreateModel>>,
}

impl ConfigurationSamlIdentityProviderCreateArgs {
    /// ConfigurationSamlIdentityProviderCreateArgs
    pub fn new() -> ConfigurationSamlIdentityProviderCreateArgs {
        ConfigurationSamlIdentityProviderCreateArgs {
            data: None,
        }
    }
