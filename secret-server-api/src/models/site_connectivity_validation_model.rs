...
/// SiteConnectivityValidationModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SiteConnectivityValidationModel {
    /// Millisecond timeout length for testing connectivity.
    #[serde(rename = "timeout", skip_serializing_if = "Option::is_none")]
    pub timeout: Option<i32>,
}

impl SiteConnectivityValidationModel {
    /// Data
    pub fn new() -> SiteConnectivityValidationModel {
