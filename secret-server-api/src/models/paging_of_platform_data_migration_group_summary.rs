...
/// PagingOfPlatformDataMigrationGroupSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfPlatformDataMigrationGroupSummary {
...
impl PagingOfPlatformDataMigrationGroupSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfPlatformDataMigrationGroupSummary {
