...
/// PagingOfSecretViewedByUserModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSecretViewedByUserModel {
    ...
    pub records: Option<Vec<models::SecretViewedByUserModel>>,
...
impl PagingOfSecretViewedByUserModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSecretViewedByUserModel {
