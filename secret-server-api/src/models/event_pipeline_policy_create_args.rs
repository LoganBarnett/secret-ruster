...
/// EventPipelinePolicyCreateArgs : EventPipelinePolicyCreateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EventPipelinePolicyCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EventPipelinePolicyCreateModel>>,
}

impl EventPipelinePolicyCreateArgs {
    /// EventPipelinePolicyCreateArgs
    pub fn new() -> EventPipelinePolicyCreateArgs {
        EventPipelinePolicyCreateArgs {
            data: None,
        }
    }
