...
/// ApiTokenViewModel : ApiTokenViewModel
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ApiTokenViewModel {
    #[serde(rename = "generatedToken", skip_serializing_if = "Option::is_none")]
    pub generated_token: Option<Box<models::ViewFieldValueOfString>>,
}

impl ApiTokenViewModel {
    /// ApiTokenViewModel
    pub fn new() -> ApiTokenViewModel {
        ApiTokenViewModel {
