...
/// DevOpsSecretsVaultUpdateTenantArgs : DevOpsSecretsVaultUpdateTenantArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DevOpsSecretsVaultUpdateTenantArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DevOpsSecretsVaultTenantUpdateModel>>,
}

impl DevOpsSecretsVaultUpdateTenantArgs {
    /// DevOpsSecretsVaultUpdateTenantArgs
    pub fn new() -> DevOpsSecretsVaultUpdateTenantArgs {
        DevOpsSecretsVaultUpdateTenantArgs {
            data: None,
        }
    }
