...
/// UpdateFieldValueOfSecretPolicyDataItemOfOptionalCommandRestrictionType : Ssh Command Restriction Type depends on Enable Ssh Command Restrictions being set
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfSecretPolicyDataItemOfOptionalCommandRestrictionType {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<Box<models::SecretPolicyDataItemOfOptionalCommandRestrictionType>>,
}

impl UpdateFieldValueOfSecretPolicyDataItemOfOptionalCommandRestrictionType {
    /// Ssh Command Restriction Type depends on Enable Ssh Command Restrictions being set
    pub fn new() -> UpdateFieldValueOfSecretPolicyDataItemOfOptionalCommandRestrictionType {
