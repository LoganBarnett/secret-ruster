...
/// LinkExternalGroupArgs : LinkExternalGroupArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LinkExternalGroupArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::LinkExternalGroupSettings>>,
}

impl LinkExternalGroupArgs {
    /// LinkExternalGroupArgs
    pub fn new() -> LinkExternalGroupArgs {
        LinkExternalGroupArgs {
            data: None,
        }
    }
