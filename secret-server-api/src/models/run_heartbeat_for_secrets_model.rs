...
/// RunHeartbeatForSecretsModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct RunHeartbeatForSecretsModel {
    /// Ids of Secrets to run Heartbeat for.
    #[serde(rename = "secretIds", skip_serializing_if = "Option::is_none")]
    pub secret_ids: Option<Vec<i32>>,
}

impl RunHeartbeatForSecretsModel {
    /// Data
    pub fn new() -> RunHeartbeatForSecretsModel {
