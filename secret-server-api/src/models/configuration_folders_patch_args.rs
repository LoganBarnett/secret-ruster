...
/// ConfigurationFoldersPatchArgs : ConfigurationFoldersPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationFoldersPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConfigurationFoldersPatchModel>>,
}

impl ConfigurationFoldersPatchArgs {
    /// ConfigurationFoldersPatchArgs
    pub fn new() -> ConfigurationFoldersPatchArgs {
        ConfigurationFoldersPatchArgs {
            data: None,
        }
    }
