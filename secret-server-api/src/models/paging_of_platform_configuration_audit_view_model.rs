...
/// PagingOfPlatformConfigurationAuditViewModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfPlatformConfigurationAuditViewModel {
    ...
    pub records: Option<Vec<models::PlatformConfigurationAuditViewModel>>,
...
impl PagingOfPlatformConfigurationAuditViewModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfPlatformConfigurationAuditViewModel {
