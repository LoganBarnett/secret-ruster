...
/// PagingOfSshCipherSuiteAuditModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSshCipherSuiteAuditModel {
    ...
    pub records: Option<Vec<models::SshCipherSuiteAuditModel>>,
...
impl PagingOfSshCipherSuiteAuditModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSshCipherSuiteAuditModel {
