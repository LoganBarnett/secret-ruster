...
/// EngineActivationRequestModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EngineActivationRequestModel {
    /// Engines
    #[serde(rename = "engines", skip_serializing_if = "Option::is_none")]
    pub engines: Option<Vec<models::EngineStatusChangeModel>>,
}

impl EngineActivationRequestModel {
    /// Data
    pub fn new() -> EngineActivationRequestModel {
