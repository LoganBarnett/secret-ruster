...
/// ConfigurationReadOnlyModeUpdateModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationReadOnlyModeUpdateModel {
    #[serde(rename = "enabled", skip_serializing_if = "Option::is_none")]
    pub enabled: Option<Box<models::UpdateFieldValueOfBoolean>>,
}

impl ConfigurationReadOnlyModeUpdateModel {
    /// Data
    pub fn new() -> ConfigurationReadOnlyModeUpdateModel {
