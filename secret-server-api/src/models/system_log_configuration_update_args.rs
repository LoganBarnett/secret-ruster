...
/// SystemLogConfigurationUpdateArgs : SystemLogConfigurationUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SystemLogConfigurationUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SystemLogConfigurationUpdateModel>>,
}

impl SystemLogConfigurationUpdateArgs {
    /// SystemLogConfigurationUpdateArgs
    pub fn new() -> SystemLogConfigurationUpdateArgs {
        SystemLogConfigurationUpdateArgs {
            data: None,
        }
    }
