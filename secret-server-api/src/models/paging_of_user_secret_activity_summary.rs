...
/// PagingOfUserSecretActivitySummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfUserSecretActivitySummary {
    ...
    pub records: Option<Vec<models::UserSecretActivitySummary>>,
...
impl PagingOfUserSecretActivitySummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfUserSecretActivitySummary {
