...
/// SecretTemplateImportArgs : Secret Template Import Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretTemplateImportArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretTemplateImportModel>>,
}

impl SecretTemplateImportArgs {
    /// Secret Template Import Args
    pub fn new() -> SecretTemplateImportArgs {
