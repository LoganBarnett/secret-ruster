...
/// ConfigurationStateModel : The configuration sections avaible to the current user
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationStateModel {
    /// Sections
    #[serde(rename = "sections", skip_serializing_if = "Option::is_none")]
    pub sections: Option<Vec<models::ConfigurationSectionAccessModel>>,
}

impl ConfigurationStateModel {
    /// The configuration sections avaible to the current user
    pub fn new() -> ConfigurationStateModel {
