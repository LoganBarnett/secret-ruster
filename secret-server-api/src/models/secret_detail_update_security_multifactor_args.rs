...
/// SecretDetailUpdateSecurityMultifactorArgs : Secret Security Multifactor Authentication Options
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretDetailUpdateSecurityMultifactorArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretDetailSecurityMultifactorUpdateModel>>,
}

impl SecretDetailUpdateSecurityMultifactorArgs {
    /// Secret Security Multifactor Authentication Options
    pub fn new() -> SecretDetailUpdateSecurityMultifactorArgs {
