...
/// PagingOfDirectoryServicesSynchronizationLogEntry : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfDirectoryServicesSynchronizationLogEntry {
    ...
    pub records: Option<Vec<models::DirectoryServicesSynchronizationLogEntry>>,
...
impl PagingOfDirectoryServicesSynchronizationLogEntry {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfDirectoryServicesSynchronizationLogEntry {
