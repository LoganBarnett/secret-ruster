...
/// PagingOfWorkflowTemplateDetailModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfWorkflowTemplateDetailModel {
    ...
    pub records: Option<Vec<models::WorkflowTemplateDetailModel>>,
...
impl PagingOfWorkflowTemplateDetailModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfWorkflowTemplateDetailModel {
