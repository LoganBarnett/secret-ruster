...
/// UpdateFieldValueOfScanTargetType : The scan target type for the member
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfScanTargetType {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<models::ScanTargetType>,
}

impl UpdateFieldValueOfScanTargetType {
    /// The scan target type for the member
    pub fn new() -> UpdateFieldValueOfScanTargetType {
