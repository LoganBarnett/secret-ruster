...
/// ReportScheduleUpdateArgs : Report Schedule Update Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ReportScheduleUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ReportScheduleUpdateModel>>,
}

impl ReportScheduleUpdateArgs {
    /// Report Schedule Update Args
    pub fn new() -> ReportScheduleUpdateArgs {
