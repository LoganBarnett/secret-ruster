...
/// BackupConfigurationArgs : BackupConfigurationArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct BackupConfigurationArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::BackupConfigurationUpdateModel>>,
}

impl BackupConfigurationArgs {
    /// BackupConfigurationArgs
    pub fn new() -> BackupConfigurationArgs {
        BackupConfigurationArgs {
            data: None,
        }
    }
