...
/// EventPipelinePolicyAddPipelineArgs : EventPipelinePolicyAddPipelineArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EventPipelinePolicyAddPipelineArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EventPipelinePolicyAddPipelineModel>>,
}

impl EventPipelinePolicyAddPipelineArgs {
    /// EventPipelinePolicyAddPipelineArgs
    pub fn new() -> EventPipelinePolicyAddPipelineArgs {
        EventPipelinePolicyAddPipelineArgs {
            data: None,
        }
    }
