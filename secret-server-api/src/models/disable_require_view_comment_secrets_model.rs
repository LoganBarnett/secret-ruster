...
/// DisableRequireViewCommentSecretsModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableRequireViewCommentSecretsModel {
    /// Ids of Secrets to set Require View Comment to disabled.
    #[serde(rename = "secretIds", skip_serializing_if = "Option::is_none")]
    pub secret_ids: Option<Vec<i32>>,
}

impl DisableRequireViewCommentSecretsModel {
    /// Data
    pub fn new() -> DisableRequireViewCommentSecretsModel {
