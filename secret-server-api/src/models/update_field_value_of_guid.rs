...
/// UpdateFieldValueOfGuid : The Current Multifactor Authentication Profile that is being used by Secret Server
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfGuid {
    /// Dirty
...
impl UpdateFieldValueOfGuid {
    /// The Current Multifactor Authentication Profile that is being used by Secret Server
    pub fn new() -> UpdateFieldValueOfGuid {
