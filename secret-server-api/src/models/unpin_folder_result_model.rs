...
/// UnpinFolderResultModel : Indicates if the folder was pinned successfully
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UnpinFolderResultModel {
    /// True to indicate success
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl UnpinFolderResultModel {
    /// Indicates if the folder was pinned successfully
    pub fn new() -> UnpinFolderResultModel {
