...
/// ScriptUpdateArgs : Update script args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScriptUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ScriptUpdateModel>>,
}

impl ScriptUpdateArgs {
    /// Update script args
    pub fn new() -> ScriptUpdateArgs {
        ScriptUpdateArgs {
            data: None,
        }
    }
