...
pub struct CategorizedListItemValueResult {
    /// Value
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<Vec<models::ICategorizedListItemValue>>,
}

impl CategorizedListItemValueResult {
    /// CategorizedListItemValueResult
    pub fn new() -> CategorizedListItemValueResult {
        CategorizedListItemValueResult {
            value: None,
        }
    }
