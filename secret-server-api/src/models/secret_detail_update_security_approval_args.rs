...
/// SecretDetailUpdateSecurityApprovalArgs : Secret Update Security Approval Message
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretDetailUpdateSecurityApprovalArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretDetailSecurityApprovalUpdateModel>>,
}

impl SecretDetailUpdateSecurityApprovalArgs {
    /// Secret Update Security Approval Message
    pub fn new() -> SecretDetailUpdateSecurityApprovalArgs {
