...
/// SecretTemplateTypePermissionsUpdateResponse : SecretTemplateTypePermissionsUpdateResponse
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretTemplateTypePermissionsUpdateResponse {
    /// Success
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl SecretTemplateTypePermissionsUpdateResponse {
    /// SecretTemplateTypePermissionsUpdateResponse
    pub fn new() -> SecretTemplateTypePermissionsUpdateResponse {
        SecretTemplateTypePermissionsUpdateResponse {
            success: None,
        }
    }
