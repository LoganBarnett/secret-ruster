...
/// UpdateFieldValueOfSecretPolicyDataItemOfAutoChangeScheduleDataModel : Auto Change Schedule depends on Auto Change On Expiration being set
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfSecretPolicyDataItemOfAutoChangeScheduleDataModel {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<Box<models::SecretPolicyDataItemOfAutoChangeScheduleDataModel>>,
}

impl UpdateFieldValueOfSecretPolicyDataItemOfAutoChangeScheduleDataModel {
    /// Auto Change Schedule depends on Auto Change On Expiration being set
    pub fn new() -> UpdateFieldValueOfSecretPolicyDataItemOfAutoChangeScheduleDataModel {
