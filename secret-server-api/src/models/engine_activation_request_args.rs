...
/// EngineActivationRequestArgs : EngineActivationRequestArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EngineActivationRequestArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EngineActivationRequestModel>>,
}

impl EngineActivationRequestArgs {
    /// EngineActivationRequestArgs
    pub fn new() -> EngineActivationRequestArgs {
        EngineActivationRequestArgs {
            data: None,
        }
    }
