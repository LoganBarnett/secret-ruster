...
/// CollectLogCollectionResultModel : CollectLogCollectionResultModel
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CollectLogCollectionResultModel {
    /// Success
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl CollectLogCollectionResultModel {
    /// CollectLogCollectionResultModel
    pub fn new() -> CollectLogCollectionResultModel {
        CollectLogCollectionResultModel {
            success: None,
        }
    }
