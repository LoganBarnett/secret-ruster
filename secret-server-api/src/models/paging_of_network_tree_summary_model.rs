...
/// PagingOfNetworkTreeSummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfNetworkTreeSummaryModel {
    ...
    pub records: Option<Vec<models::NetworkTreeSummaryModel>>,
...
impl PagingOfNetworkTreeSummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfNetworkTreeSummaryModel {
