...
/// PagingOfSshCommandItemAuditSummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSshCommandItemAuditSummaryModel {
    ...
    pub records: Option<Vec<models::SshCommandItemAuditSummaryModel>>,
...
impl PagingOfSshCommandItemAuditSummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSshCommandItemAuditSummaryModel {
