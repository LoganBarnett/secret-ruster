...
/// PagingOfSshCommandBlocklistSummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSshCommandBlocklistSummaryModel {
    ...
    pub records: Option<Vec<models::SshCommandBlocklistSummaryModel>>,
...
impl PagingOfSshCommandBlocklistSummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSshCommandBlocklistSummaryModel {
