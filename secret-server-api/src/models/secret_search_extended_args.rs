...
pub struct SecretSearchExtendedArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretSearchExtendedData>>,
}

impl SecretSearchExtendedArgs {
    /// SecretSearchExtendedArgs
    pub fn new() -> SecretSearchExtendedArgs {
        SecretSearchExtendedArgs {
            data: None,
        }
    }
