...
pub struct UpdateFieldValueOfSecretDetailExpirationUpdateType {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<models::SecretDetailExpirationUpdateType>,
}

impl UpdateFieldValueOfSecretDetailExpirationUpdateType {
    /// ExpirationType
    pub fn new() -> UpdateFieldValueOfSecretDetailExpirationUpdateType {
