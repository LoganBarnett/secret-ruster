...
/// PasswordRequirementPatchArgs : PasswordRequirementPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PasswordRequirementPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::PasswordRequirementPatchModel>>,
}

impl PasswordRequirementPatchArgs {
    /// PasswordRequirementPatchArgs
    pub fn new() -> PasswordRequirementPatchArgs {
        PasswordRequirementPatchArgs {
            data: None,
        }
    }
