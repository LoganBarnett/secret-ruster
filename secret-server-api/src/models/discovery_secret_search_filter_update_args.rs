...
/// DiscoverySecretSearchFilterUpdateArgs : DiscoverySecretSearchFilterUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoverySecretSearchFilterUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoverySecretSearchFilterUpdateData>>,
}

impl DiscoverySecretSearchFilterUpdateArgs {
    /// DiscoverySecretSearchFilterUpdateArgs
    pub fn new() -> DiscoverySecretSearchFilterUpdateArgs {
        DiscoverySecretSearchFilterUpdateArgs {
            data: None,
        }
    }
