...
/// SecretDetailUpdateGeneralArgs : Secret General Settings Update Message
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretDetailUpdateGeneralArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretDetailGeneralUpdateModel>>,
}

impl SecretDetailUpdateGeneralArgs {
    /// Secret General Settings Update Message
    pub fn new() -> SecretDetailUpdateGeneralArgs {
