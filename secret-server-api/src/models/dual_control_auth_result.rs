...
/// DualControlAuthResult : The result of the authorization request
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DualControlAuthResult {
    /// True if the auth succeeded
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl DualControlAuthResult {
    /// The result of the authorization request
    pub fn new() -> DualControlAuthResult {
