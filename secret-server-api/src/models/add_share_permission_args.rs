...
/// AddSharePermissionArgs : AddSharePermissionArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AddSharePermissionArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::AddSharePermissionModel>>,
}

impl AddSharePermissionArgs {
    /// AddSharePermissionArgs
    pub fn new() -> AddSharePermissionArgs {
        AddSharePermissionArgs {
            data: None,
        }
    }
