...
/// EngineActivationResultModel : EngineActivationResultModel
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EngineActivationResultModel {
    /// Results
    #[serde(rename = "results", skip_serializing_if = "Option::is_none")]
    pub results: Option<Vec<models::EngineActivationResult>>,
}

impl EngineActivationResultModel {
    /// EngineActivationResultModel
    pub fn new() -> EngineActivationResultModel {
        EngineActivationResultModel {
            results: None,
        }
    }
