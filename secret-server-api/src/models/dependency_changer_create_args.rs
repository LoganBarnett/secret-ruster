...
/// DependencyChangerCreateArgs : Scanner Dependency Changer create args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DependencyChangerCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DependencyChangerCreateModel>>,
}

impl DependencyChangerCreateArgs {
    /// Scanner Dependency Changer create args
    pub fn new() -> DependencyChangerCreateArgs {
