...
/// UpdatePasswordRequirementForSecretsArgs : UpdatePasswordRequirementForSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdatePasswordRequirementForSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::UpdatePasswordRequirementForSecretsModel>>,
}

impl UpdatePasswordRequirementForSecretsArgs {
    /// UpdatePasswordRequirementForSecretsArgs
    pub fn new() -> UpdatePasswordRequirementForSecretsArgs {
        UpdatePasswordRequirementForSecretsArgs {
            data: None,
        }
    }
