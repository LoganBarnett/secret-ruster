...
/// RemoveUsersFromGroupModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct RemoveUsersFromGroupModel {
    /// Id of Group to remove selected users from.
    #[serde(rename = "groupId", skip_serializing_if = "Option::is_none")]
    pub group_id: Option<i32>,
    /// User Ids to remove from selected Group.
    #[serde(rename = "userIds", skip_serializing_if = "Option::is_none")]
    pub user_ids: Option<Vec<i32>>,
}

impl RemoveUsersFromGroupModel {
    /// Data
    pub fn new() -> RemoveUsersFromGroupModel {
