...
/// PagingOfSecretTemplateGroupedPermissionSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSecretTemplateGroupedPermissionSummary {
    ...
    pub records: Option<Vec<models::SecretTemplateGroupedPermissionSummary>>,
...
impl PagingOfSecretTemplateGroupedPermissionSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSecretTemplateGroupedPermissionSummary {
