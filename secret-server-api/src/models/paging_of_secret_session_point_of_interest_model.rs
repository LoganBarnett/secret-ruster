...
/// PagingOfSecretSessionPointOfInterestModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSecretSessionPointOfInterestModel {
    ...
    pub records: Option<Vec<models::SecretSessionPointOfInterestModel>>,
...
impl PagingOfSecretSessionPointOfInterestModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSecretSessionPointOfInterestModel {
