...
/// GroupMembershipAssignmentResponse : GroupMembershipAssignmentResponse
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GroupMembershipAssignmentResponse {
    /// Success
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl GroupMembershipAssignmentResponse {
    /// GroupMembershipAssignmentResponse
    pub fn new() -> GroupMembershipAssignmentResponse {
        GroupMembershipAssignmentResponse {
            success: None,
        }
    }
