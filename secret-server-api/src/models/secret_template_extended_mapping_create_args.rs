...
/// SecretTemplateExtendedMappingCreateArgs : SecretTemplateExtendedMappingCreateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretTemplateExtendedMappingCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretTemplateExtendedMappingCreateModel>>,
}

impl SecretTemplateExtendedMappingCreateArgs {
    /// SecretTemplateExtendedMappingCreateArgs
    pub fn new() -> SecretTemplateExtendedMappingCreateArgs {
        SecretTemplateExtendedMappingCreateArgs {
            data: None,
        }
    }
