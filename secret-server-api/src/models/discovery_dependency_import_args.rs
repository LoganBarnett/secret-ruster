...
/// DiscoveryDependencyImportArgs : The args for dependency import
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryDependencyImportArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryDependencyImportModel>>,
}

impl DiscoveryDependencyImportArgs {
    /// The args for dependency import
    pub fn new() -> DiscoveryDependencyImportArgs {
        DiscoveryDependencyImportArgs {
            data: None,
        }
    }
}
