...
/// DisasterRecoveryDataReplicaMessageResponse : DisasterRecoveryDataReplicaMessageResponse
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisasterRecoveryDataReplicaMessageResponse {
    /// Message
...
impl DisasterRecoveryDataReplicaMessageResponse {
    /// DisasterRecoveryDataReplicaMessageResponse
    pub fn new() -> DisasterRecoveryDataReplicaMessageResponse {
        DisasterRecoveryDataReplicaMessageResponse {
            message: None,
            status: None,
            success: None,
