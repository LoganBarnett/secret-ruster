...
/// PagingOfBlocklistSecretPolicySummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfBlocklistSecretPolicySummaryModel {
    ...
    pub records: Option<Vec<models::BlocklistSecretPolicySummaryModel>>,
...
impl PagingOfBlocklistSecretPolicySummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfBlocklistSecretPolicySummaryModel {
