...
/// UpdateFieldValueOfRecurringScheduleType : The iteration period for the schedule.  The schedule will restart after this cycle.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfRecurringScheduleType {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<models::RecurringScheduleType>,
}

impl UpdateFieldValueOfRecurringScheduleType {
    /// The iteration period for the schedule.  The schedule will restart after this cycle.
    pub fn new() -> UpdateFieldValueOfRecurringScheduleType {
