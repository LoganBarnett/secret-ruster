...
/// PagingOfWorkflowStepTemplateDetailModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfWorkflowStepTemplateDetailModel {
    ...
    pub records: Option<Vec<models::WorkflowStepTemplateDetailModel>>,
...
impl PagingOfWorkflowStepTemplateDetailModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfWorkflowStepTemplateDetailModel {
