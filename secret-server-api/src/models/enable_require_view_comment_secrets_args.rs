...
/// EnableRequireViewCommentSecretsArgs : EnableRequireViewCommentSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableRequireViewCommentSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EnableRequireViewCommentSecretsModel>>,
}

impl EnableRequireViewCommentSecretsArgs {
    /// EnableRequireViewCommentSecretsArgs
    pub fn new() -> EnableRequireViewCommentSecretsArgs {
        EnableRequireViewCommentSecretsArgs {
            data: None,
        }
    }
