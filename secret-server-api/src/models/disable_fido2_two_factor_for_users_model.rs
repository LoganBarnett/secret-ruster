...
/// DisableFido2TwoFactorForUsersModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableFido2TwoFactorForUsersModel {
    /// User Ids to set Fido2 Two Factor to disabled.
    #[serde(rename = "userIds", skip_serializing_if = "Option::is_none")]
    pub user_ids: Option<Vec<i32>>,
}

impl DisableFido2TwoFactorForUsersModel {
    /// Data
    pub fn new() -> DisableFido2TwoFactorForUsersModel {
