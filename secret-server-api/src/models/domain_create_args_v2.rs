...
/// DomainCreateArgsV2 : DomainCreateArgsV2
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DomainCreateArgsV2 {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DomainCreateModelV2>>,
}

impl DomainCreateArgsV2 {
    /// DomainCreateArgsV2
    pub fn new() -> DomainCreateArgsV2 {
        DomainCreateArgsV2 {
            data: None,
        }
    }
