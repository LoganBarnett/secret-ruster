...
/// CommandPermissionType : Allowed or Blocked
/// Allowed or Blocked
...
impl std::fmt::Display for CommandPermissionType {
...
impl Default for CommandPermissionType {
    fn default() -> CommandPermissionType {
        Self::Allowed
    }
}
