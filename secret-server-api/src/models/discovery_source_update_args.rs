...
/// DiscoverySourceUpdateArgs : DiscoverySourceUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoverySourceUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoverySourceUpdateModel>>,
}

impl DiscoverySourceUpdateArgs {
    /// DiscoverySourceUpdateArgs
    pub fn new() -> DiscoverySourceUpdateArgs {
        DiscoverySourceUpdateArgs {
            data: None,
        }
    }
