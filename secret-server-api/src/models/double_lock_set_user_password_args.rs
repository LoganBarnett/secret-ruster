...
/// DoubleLockSetUserPasswordArgs : DoubleLockSetUserPasswordArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DoubleLockSetUserPasswordArgs {
    /// Password
    #[serde(rename = "password", skip_serializing_if = "Option::is_none")]
    pub password: Option<String>,
}

impl DoubleLockSetUserPasswordArgs {
    /// DoubleLockSetUserPasswordArgs
    pub fn new() -> DoubleLockSetUserPasswordArgs {
        DoubleLockSetUserPasswordArgs {
            password: None,
        }
    }
