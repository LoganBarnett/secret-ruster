...
/// PagingOfSecretEraseRequestModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSecretEraseRequestModel {
    ...
    pub records: Option<Vec<models::SecretEraseRequestModel>>,
...
impl PagingOfSecretEraseRequestModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSecretEraseRequestModel {
