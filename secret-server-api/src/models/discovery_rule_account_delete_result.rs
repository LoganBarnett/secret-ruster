...
/// DiscoveryRuleAccountDeleteResult : Discovery Rule Account Delete Result
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryRuleAccountDeleteResult {
    /// Success
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl DiscoveryRuleAccountDeleteResult {
    /// Discovery Rule Account Delete Result
    pub fn new() -> DiscoveryRuleAccountDeleteResult {
