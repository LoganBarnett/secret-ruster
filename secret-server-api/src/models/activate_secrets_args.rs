...
/// ActivateSecretsArgs : ActivateSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ActivateSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ActivateSecretsModel>>,
}

impl ActivateSecretsArgs {
    /// ActivateSecretsArgs
    pub fn new() -> ActivateSecretsArgs {
        ActivateSecretsArgs {
            data: None,
        }
    }
