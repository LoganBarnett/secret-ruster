...
/// PagingOfSshCommandMenuAuditSummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSshCommandMenuAuditSummaryModel {
    ...
    pub records: Option<Vec<models::SshCommandMenuAuditSummaryModel>>,
...
impl PagingOfSshCommandMenuAuditSummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSshCommandMenuAuditSummaryModel {
