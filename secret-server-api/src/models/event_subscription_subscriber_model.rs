...
/// EventSubscriptionSubscriberModel : A list of the groups subscribed to the event
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EventSubscriptionSubscriberModel {
    /// DisplayName
...
impl EventSubscriptionSubscriberModel {
    /// A list of the groups subscribed to the event
    pub fn new() -> EventSubscriptionSubscriberModel {
