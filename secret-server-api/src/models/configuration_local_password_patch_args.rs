...
/// ConfigurationLocalPasswordPatchArgs : ConfigurationLocalPasswordPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationLocalPasswordPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConfigurationLocalPasswordPatchModel>>,
}

impl ConfigurationLocalPasswordPatchArgs {
    /// ConfigurationLocalPasswordPatchArgs
    pub fn new() -> ConfigurationLocalPasswordPatchArgs {
        ConfigurationLocalPasswordPatchArgs {
            data: None,
        }
    }
