...
/// PagingOfSecretTemplateFieldSummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSecretTemplateFieldSummaryModel {
    ...
    pub records: Option<Vec<models::SecretTemplateFieldSummaryModel>>,
...
impl PagingOfSecretTemplateFieldSummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSecretTemplateFieldSummaryModel {
