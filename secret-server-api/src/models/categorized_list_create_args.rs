...
/// CategorizedListCreateArgs : CategorizedListCreateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CategorizedListCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::CategorizedListUpdateModel>>,
}

impl CategorizedListCreateArgs {
    /// CategorizedListCreateArgs
    pub fn new() -> CategorizedListCreateArgs {
        CategorizedListCreateArgs {
            data: None,
        }
    }
