...
/// ScriptCreateArgsV2 : Create script args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScriptCreateArgsV2 {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ScriptCreateModel>>,
}

impl ScriptCreateArgsV2 {
    /// Create script args
    pub fn new() -> ScriptCreateArgsV2 {
        ScriptCreateArgsV2 {
            data: None,
        }
    }
