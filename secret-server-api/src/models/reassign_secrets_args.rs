...
/// ReassignSecretsArgs : ReassignSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ReassignSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ReassignSecretsModel>>,
}

impl ReassignSecretsArgs {
    /// ReassignSecretsArgs
    pub fn new() -> ReassignSecretsArgs {
        ReassignSecretsArgs {
            data: None,
        }
    }
