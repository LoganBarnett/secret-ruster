...
/// DiscoveryRuleAccountCreateArgs : Discovery Rule Account Create Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryRuleAccountCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryRuleAccountCreateModel>>,
}

impl DiscoveryRuleAccountCreateArgs {
    /// Discovery Rule Account Create Args
    pub fn new() -> DiscoveryRuleAccountCreateArgs {
