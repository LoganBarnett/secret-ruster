...
/// EventPipelinePolicySortOrderUpdateArgs : EventPipelinePolicySortOrderUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EventPipelinePolicySortOrderUpdateArgs {
    /// NewSortOrder
    #[serde(rename = "newSortOrder", skip_serializing_if = "Option::is_none")]
    pub new_sort_order: Option<i32>,
}

impl EventPipelinePolicySortOrderUpdateArgs {
    /// EventPipelinePolicySortOrderUpdateArgs
    pub fn new() -> EventPipelinePolicySortOrderUpdateArgs {
        EventPipelinePolicySortOrderUpdateArgs {
            new_sort_order: None,
        }
    }
