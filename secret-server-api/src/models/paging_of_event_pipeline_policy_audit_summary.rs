...
/// PagingOfEventPipelinePolicyAuditSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfEventPipelinePolicyAuditSummary {
    ...
    pub records: Option<Vec<models::EventPipelinePolicyAuditSummary>>,
...
impl PagingOfEventPipelinePolicyAuditSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfEventPipelinePolicyAuditSummary {
