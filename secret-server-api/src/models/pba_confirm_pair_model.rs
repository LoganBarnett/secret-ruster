...
/// PbaConfirmPairModel : PBA Confirm Pair
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PbaConfirmPairModel {
    /// Already Approved
    #[serde(rename = "alreadyApproved", skip_serializing_if = "Option::is_none")]
    pub already_approved: Option<bool>,
    /// Success
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl PbaConfirmPairModel {
    /// PBA Confirm Pair
    pub fn new() -> PbaConfirmPairModel {
        PbaConfirmPairModel {
