...
/// ChangeSecurityOptionsSecretsArgs : ChangeSecurityOptionsSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ChangeSecurityOptionsSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ChangeSecurityOptionsSecretsModel>>,
}

impl ChangeSecurityOptionsSecretsArgs {
    /// ChangeSecurityOptionsSecretsArgs
    pub fn new() -> ChangeSecurityOptionsSecretsArgs {
        ChangeSecurityOptionsSecretsArgs {
            data: None,
        }
    }
