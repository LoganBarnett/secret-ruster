...
/// MoveSecretsToFolderArgs : MoveSecretsToFolderArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct MoveSecretsToFolderArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::MoveSecretsToFolderModel>>,
}

impl MoveSecretsToFolderArgs {
    /// MoveSecretsToFolderArgs
    pub fn new() -> MoveSecretsToFolderArgs {
        MoveSecretsToFolderArgs {
            data: None,
        }
    }
