...
/// ClearLogCollectionResultModel : ClearLogCollectionResultModel
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ClearLogCollectionResultModel {
    /// Success
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl ClearLogCollectionResultModel {
    /// ClearLogCollectionResultModel
    pub fn new() -> ClearLogCollectionResultModel {
        ClearLogCollectionResultModel {
            success: None,
        }
    }
