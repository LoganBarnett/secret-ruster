...
/// UpdateFieldValueOfSyslogCefTimeZoneType : Time Zone to use when sending Syslog/CEF Protocol log entries
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfSyslogCefTimeZoneType {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<models::SyslogCefTimeZoneType>,
}

impl UpdateFieldValueOfSyslogCefTimeZoneType {
    /// Time Zone to use when sending Syslog/CEF Protocol log entries
    pub fn new() -> UpdateFieldValueOfSyslogCefTimeZoneType {
