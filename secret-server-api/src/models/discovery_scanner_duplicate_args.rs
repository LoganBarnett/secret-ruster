...
/// DiscoveryScannerDuplicateArgs : Duplicate scanner args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryScannerDuplicateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryScannerDuplicateData>>,
}

impl DiscoveryScannerDuplicateArgs {
    /// Duplicate scanner args
    pub fn new() -> DiscoveryScannerDuplicateArgs {
