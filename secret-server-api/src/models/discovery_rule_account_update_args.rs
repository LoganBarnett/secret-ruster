...
/// DiscoveryRuleAccountUpdateArgs : Discovery Rule Account Update Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryRuleAccountUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryRuleAccountUpdateModel>>,
}

impl DiscoveryRuleAccountUpdateArgs {
    /// Discovery Rule Account Update Args
    pub fn new() -> DiscoveryRuleAccountUpdateArgs {
