...
/// PagingOfISecretSessionPointOfInterestSummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfISecretSessionPointOfInterestSummaryModel {
    ...
    pub records: Option<Vec<models::ISecretSessionPointOfInterestSummaryModel>>,
...
impl PagingOfISecretSessionPointOfInterestSummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfISecretSessionPointOfInterestSummaryModel {
