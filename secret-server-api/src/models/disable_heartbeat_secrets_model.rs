...
/// DisableHeartbeatSecretsModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableHeartbeatSecretsModel {
    /// Ids of Secrets to set Heartbeat to disabled.
    #[serde(rename = "secretIds", skip_serializing_if = "Option::is_none")]
    pub secret_ids: Option<Vec<i32>>,
}

impl DisableHeartbeatSecretsModel {
    /// Data
    pub fn new() -> DisableHeartbeatSecretsModel {
