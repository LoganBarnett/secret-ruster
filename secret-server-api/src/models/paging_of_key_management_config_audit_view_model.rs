...
/// PagingOfKeyManagementConfigAuditViewModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfKeyManagementConfigAuditViewModel {
    ...
    pub records: Option<Vec<models::KeyManagementConfigAuditViewModel>>,
...
impl PagingOfKeyManagementConfigAuditViewModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfKeyManagementConfigAuditViewModel {
