...
/// DiscoveryUpdateCredentialsResultModel : Result of updating discovery scanner credentials
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryUpdateCredentialsResultModel {
    /// Indicates if the update was successful
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl DiscoveryUpdateCredentialsResultModel {
    /// Result of updating discovery scanner credentials
    pub fn new() -> DiscoveryUpdateCredentialsResultModel {
        DiscoveryUpdateCredentialsResultModel {
            success: None,
        }
    }
}
