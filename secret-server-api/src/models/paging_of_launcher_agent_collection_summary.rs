...
/// PagingOfLauncherAgentCollectionSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfLauncherAgentCollectionSummary {
    ...
    pub records: Option<Vec<models::LauncherAgentCollectionSummary>>,
...
impl PagingOfLauncherAgentCollectionSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfLauncherAgentCollectionSummary {
