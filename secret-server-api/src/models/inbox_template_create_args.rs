...
/// InboxTemplateCreateArgs : InboxTemplateCreateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InboxTemplateCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::InboxTemplateCreateModel>>,
}

impl InboxTemplateCreateArgs {
    /// InboxTemplateCreateArgs
    pub fn new() -> InboxTemplateCreateArgs {
        InboxTemplateCreateArgs {
            data: None,
        }
    }
