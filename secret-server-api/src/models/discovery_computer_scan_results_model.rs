...
/// DiscoveryComputerScanResultsModel : DiscoveryComputerScanResultsModel
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryComputerScanResultsModel {
    /// Individual computer scan results.
    #[serde(rename = "results", skip_serializing_if = "Option::is_none")]
    pub results: Option<Vec<models::DiscoveryComputerScanResultModel>>,
}

impl DiscoveryComputerScanResultsModel {
    /// DiscoveryComputerScanResultsModel
    pub fn new() -> DiscoveryComputerScanResultsModel {
        DiscoveryComputerScanResultsModel {
            results: None,
        }
    }
