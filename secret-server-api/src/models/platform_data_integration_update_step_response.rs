...
/// PlatformDataIntegrationUpdateStepResponse : Update Step Response
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlatformDataIntegrationUpdateStepResponse {
    /// Whether step update successful.
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl PlatformDataIntegrationUpdateStepResponse {
    /// Update Step Response
    pub fn new() -> PlatformDataIntegrationUpdateStepResponse {
        PlatformDataIntegrationUpdateStepResponse {
            success: None,
        }
    }
}
