...
/// DpapiDecryptRequestModel : DPAPI Decrypt Request
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DpapiDecryptRequestModel {
    /// Password for Decryption
    #[serde(rename = "password", skip_serializing_if = "Option::is_none")]
    pub password: Option<String>,
}

impl DpapiDecryptRequestModel {
    /// DPAPI Decrypt Request
    pub fn new() -> DpapiDecryptRequestModel {
