...
/// PagingOfDomainSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfDomainSummary {
    ...
    pub records: Option<Vec<models::DomainSummary>>,
