...
/// TicketSystemCreateArgs : TicketSystemCreateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TicketSystemCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::TicketSystemCreateModel>>,
}

impl TicketSystemCreateArgs {
    /// TicketSystemCreateArgs
    pub fn new() -> TicketSystemCreateArgs {
        TicketSystemCreateArgs {
            data: None,
        }
    }
