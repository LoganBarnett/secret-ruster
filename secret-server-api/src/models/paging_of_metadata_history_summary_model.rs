...
/// PagingOfMetadataHistorySummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfMetadataHistorySummaryModel {
    ...
    pub records: Option<Vec<models::MetadataHistorySummaryModel>>,
...
impl PagingOfMetadataHistorySummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfMetadataHistorySummaryModel {
