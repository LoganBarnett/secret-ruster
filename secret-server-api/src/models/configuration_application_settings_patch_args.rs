...
/// ConfigurationApplicationSettingsPatchArgs : ConfigurationApplicationSettingsPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationApplicationSettingsPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConfigurationApplicationSettingsPatchModel>>,
}

impl ConfigurationApplicationSettingsPatchArgs {
    /// ConfigurationApplicationSettingsPatchArgs
    pub fn new() -> ConfigurationApplicationSettingsPatchArgs {
        ConfigurationApplicationSettingsPatchArgs {
            data: None,
        }
    }
