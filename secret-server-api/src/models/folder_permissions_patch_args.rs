...
/// FolderPermissionsPatchArgs : FolderPermissionsPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct FolderPermissionsPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::FolderPermissionsPatchData>>,
}

impl FolderPermissionsPatchArgs {
    /// FolderPermissionsPatchArgs
    pub fn new() -> FolderPermissionsPatchArgs {
        FolderPermissionsPatchArgs {
            data: None,
        }
    }
