...
/// PagingOfEventPipelineSummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfEventPipelineSummaryModel {
    ...
    pub records: Option<Vec<models::EventPipelineSummaryModel>>,
...
impl PagingOfEventPipelineSummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfEventPipelineSummaryModel {
