...
/// DisableDuoAuthForUsersModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableDuoAuthForUsersModel {
    /// User Ids to set Duo Auth to disabled.
    #[serde(rename = "userIds", skip_serializing_if = "Option::is_none")]
    pub user_ids: Option<Vec<i32>>,
}

impl DisableDuoAuthForUsersModel {
    /// Data
    pub fn new() -> DisableDuoAuthForUsersModel {
