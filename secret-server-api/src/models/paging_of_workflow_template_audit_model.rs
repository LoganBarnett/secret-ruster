...
/// PagingOfWorkflowTemplateAuditModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfWorkflowTemplateAuditModel {
    ...
    pub records: Option<Vec<models::WorkflowTemplateAuditModel>>,
...
impl PagingOfWorkflowTemplateAuditModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfWorkflowTemplateAuditModel {
