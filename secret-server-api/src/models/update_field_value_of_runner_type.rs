...
/// UpdateFieldValueOfRunnerType : Runner Type
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfRunnerType {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<models::RunnerType>,
}

impl UpdateFieldValueOfRunnerType {
    /// Runner Type
    pub fn new() -> UpdateFieldValueOfRunnerType {
