...
/// DiscoveryRuleDependencyDeleteResult : Discovery Rule Dependency Delete Result
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryRuleDependencyDeleteResult {
    /// Success
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl DiscoveryRuleDependencyDeleteResult {
    /// Discovery Rule Dependency Delete Result
    pub fn new() -> DiscoveryRuleDependencyDeleteResult {
