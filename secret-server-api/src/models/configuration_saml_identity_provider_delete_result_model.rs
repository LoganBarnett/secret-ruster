...
/// ConfigurationSamlIdentityProviderDeleteResultModel : SAML Identity Provider Delete Result
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationSamlIdentityProviderDeleteResultModel {
    /// Whether or not the call to Delete was successful
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl ConfigurationSamlIdentityProviderDeleteResultModel {
    /// SAML Identity Provider Delete Result
    pub fn new() -> ConfigurationSamlIdentityProviderDeleteResultModel {
