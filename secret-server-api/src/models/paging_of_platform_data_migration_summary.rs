...
/// PagingOfPlatformDataMigrationSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfPlatformDataMigrationSummary {
    ...
    pub records: Option<Vec<models::PlatformDataMigrationSummary>>,
...
impl PagingOfPlatformDataMigrationSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfPlatformDataMigrationSummary {
