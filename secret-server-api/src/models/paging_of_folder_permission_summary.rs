...
/// PagingOfFolderPermissionSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfFolderPermissionSummary {
    ...
    pub records: Option<Vec<models::FolderPermissionSummary>>,
...
impl PagingOfFolderPermissionSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfFolderPermissionSummary {
