...
/// CharacterSetPatchArgs : Character Set Patch Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CharacterSetPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::CharacterSetPatchModel>>,
}

impl CharacterSetPatchArgs {
    /// Character Set Patch Args
    pub fn new() -> CharacterSetPatchArgs {
