...
/// UpdateFieldValueOfGuidLeftSquareBracketRightSquareBracket : SshCommandIds
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfGuidLeftSquareBracketRightSquareBracket {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    /// Value
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<Vec<uuid::Uuid>>,
}

impl UpdateFieldValueOfGuidLeftSquareBracketRightSquareBracket {
    /// SshCommandIds
    pub fn new() -> UpdateFieldValueOfGuidLeftSquareBracketRightSquareBracket {
