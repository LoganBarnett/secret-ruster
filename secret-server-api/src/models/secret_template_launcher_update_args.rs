...
/// SecretTemplateLauncherUpdateArgs : SecretTemplateLauncherUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretTemplateLauncherUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretTemplateLauncherUpdateModel>>,
}

impl SecretTemplateLauncherUpdateArgs {
    /// SecretTemplateLauncherUpdateArgs
    pub fn new() -> SecretTemplateLauncherUpdateArgs {
        SecretTemplateLauncherUpdateArgs {
            data: None,
        }
    }
