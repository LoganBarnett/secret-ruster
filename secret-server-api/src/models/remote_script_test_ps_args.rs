...
/// RemoteScriptTestPsArgs : PowerShell test args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct RemoteScriptTestPsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::RemoteScriptTestPsData>>,
}

impl RemoteScriptTestPsArgs {
    /// PowerShell test args
    pub fn new() -> RemoteScriptTestPsArgs {
