...
/// DiscoveryRuleAccountSortArgs : Discovery Sort Rule Account Sort Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryRuleAccountSortArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryRuleAccountSortData>>,
}

impl DiscoveryRuleAccountSortArgs {
    /// Discovery Sort Rule Account Sort Args
    pub fn new() -> DiscoveryRuleAccountSortArgs {
