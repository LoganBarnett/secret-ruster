...
/// PagingOfJumpboxRouteSummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfJumpboxRouteSummaryModel {
    ...
    pub records: Option<Vec<models::JumpboxRouteSummaryModel>>,
...
impl PagingOfJumpboxRouteSummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfJumpboxRouteSummaryModel {
