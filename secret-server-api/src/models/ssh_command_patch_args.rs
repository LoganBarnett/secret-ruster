...
/// SshCommandPatchArgs : SshCommandPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SshCommandPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SshCommandPatchModel>>,
}

impl SshCommandPatchArgs {
    /// SshCommandPatchArgs
    pub fn new() -> SshCommandPatchArgs {
        SshCommandPatchArgs {
            data: None,
        }
    }
