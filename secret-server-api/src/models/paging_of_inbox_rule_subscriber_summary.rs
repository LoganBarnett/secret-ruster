...
/// PagingOfInboxRuleSubscriberSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfInboxRuleSubscriberSummary {
    ...
    pub records: Option<Vec<models::InboxRuleSubscriberSummary>>,
...
impl PagingOfInboxRuleSubscriberSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfInboxRuleSubscriberSummary {
