...
/// EnterpriseSearchRequestArgs : Arguments for an Enterprise Search Request
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnterpriseSearchRequestArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EnterpriseSearchRequestFilter>>,
}

impl EnterpriseSearchRequestArgs {
    /// Arguments for an Enterprise Search Request
    pub fn new() -> EnterpriseSearchRequestArgs {
