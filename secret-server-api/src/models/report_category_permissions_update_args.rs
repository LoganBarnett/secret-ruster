...
/// ReportCategoryPermissionsUpdateArgs : Report Category Permissions Update Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ReportCategoryPermissionsUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ReportCategoryPermissionsUpdateModel>>,
}

impl ReportCategoryPermissionsUpdateArgs {
    /// Report Category Permissions Update Args
    pub fn new() -> ReportCategoryPermissionsUpdateArgs {
