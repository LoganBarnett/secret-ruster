...
/// EnableHeartbeatSecretsArgs : EnableHeartbeatSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableHeartbeatSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EnableHeartbeatSecretsModel>>,
}

impl EnableHeartbeatSecretsArgs {
    /// EnableHeartbeatSecretsArgs
    pub fn new() -> EnableHeartbeatSecretsArgs {
        EnableHeartbeatSecretsArgs {
            data: None,
        }
    }
