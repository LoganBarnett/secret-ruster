...
/// PagingOfConfigurationAdvancedSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfConfigurationAdvancedSummary {
    ...
    pub records: Option<Vec<models::ConfigurationAdvancedSummary>>,
...
impl PagingOfConfigurationAdvancedSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfConfigurationAdvancedSummary {
