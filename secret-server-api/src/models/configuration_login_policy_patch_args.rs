...
/// ConfigurationLoginPolicyPatchArgs : ConfigurationLoginPolicyPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationLoginPolicyPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConfigurationLoginPolicyPatchModel>>,
}

impl ConfigurationLoginPolicyPatchArgs {
    /// ConfigurationLoginPolicyPatchArgs
    pub fn new() -> ConfigurationLoginPolicyPatchArgs {
        ConfigurationLoginPolicyPatchArgs {
            data: None,
        }
    }
