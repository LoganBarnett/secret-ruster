...
/// SetPrivilegedAccountForSecretsArgs : SetPrivilegedAccountForSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SetPrivilegedAccountForSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SetPrivilegedAccountForSecretsModel>>,
}

impl SetPrivilegedAccountForSecretsArgs {
    /// SetPrivilegedAccountForSecretsArgs
    pub fn new() -> SetPrivilegedAccountForSecretsArgs {
        SetPrivilegedAccountForSecretsArgs {
            data: None,
        }
    }
