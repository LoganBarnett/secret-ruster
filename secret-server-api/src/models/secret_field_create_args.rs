...
/// SecretFieldCreateArgs : Secret Field Create Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretFieldCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretTemplateFieldCreateModel>>,
}

impl SecretFieldCreateArgs {
    /// Secret Field Create Args
    pub fn new() -> SecretFieldCreateArgs {
