...
/// ScriptParameterUpdateArgs : Update script parameter args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScriptParameterUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ScriptParameterUpdateData>>,
}

impl ScriptParameterUpdateArgs {
    /// Update script parameter args
    pub fn new() -> ScriptParameterUpdateArgs {
