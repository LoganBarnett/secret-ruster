...
/// SecretSshTerminalModel : SecretSshTerminalModel
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretSshTerminalModel {
...
impl SecretSshTerminalModel {
    /// SecretSshTerminalModel
    pub fn new() -> SecretSshTerminalModel {
        SecretSshTerminalModel {
            host: None,
            port: None,
            secret_id: None,
