...
/// UpdateFieldValueOfProcessingLocationType : Processing Location of Site
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfProcessingLocationType {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<models::ProcessingLocationType>,
}

impl UpdateFieldValueOfProcessingLocationType {
    /// Processing Location of Site
    pub fn new() -> UpdateFieldValueOfProcessingLocationType {
