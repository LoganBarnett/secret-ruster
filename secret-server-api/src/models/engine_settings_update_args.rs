...
/// EngineSettingsUpdateArgs : EngineSettingsUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EngineSettingsUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EngineSettingsUpdateModel>>,
}

impl EngineSettingsUpdateArgs {
    /// EngineSettingsUpdateArgs
    pub fn new() -> EngineSettingsUpdateArgs {
        EngineSettingsUpdateArgs {
            data: None,
        }
    }
