...
/// PagingOfDevOpsSecretsVaultTenantAuditSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfDevOpsSecretsVaultTenantAuditSummary {
    ...
    pub records: Option<Vec<models::DevOpsSecretsVaultTenantAuditSummary>>,
...
impl PagingOfDevOpsSecretsVaultTenantAuditSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfDevOpsSecretsVaultTenantAuditSummary {
