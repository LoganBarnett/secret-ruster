...
/// SecretEraseRequestHistoryModel : Query results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretEraseRequestHistoryModel {
    /// Action
...
impl SecretEraseRequestHistoryModel {
    /// Query results
    pub fn new() -> SecretEraseRequestHistoryModel {
