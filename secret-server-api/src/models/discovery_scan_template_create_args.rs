...
/// DiscoveryScanTemplateCreateArgs : Scan template create args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryScanTemplateCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryScanTemplateCreateData>>,
}

impl DiscoveryScanTemplateCreateArgs {
    /// Scan template create args
    pub fn new() -> DiscoveryScanTemplateCreateArgs {
