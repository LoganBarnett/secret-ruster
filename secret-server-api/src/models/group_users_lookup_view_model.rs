...
/// GroupUsersLookupViewModel : GroupUsersLookupViewModel
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GroupUsersLookupViewModel {
    /// Users
    #[serde(rename = "users", skip_serializing_if = "Option::is_none")]
    pub users: Option<Vec<String>>,
}

impl GroupUsersLookupViewModel {
    /// GroupUsersLookupViewModel
    pub fn new() -> GroupUsersLookupViewModel {
        GroupUsersLookupViewModel {
            users: None,
        }
    }
