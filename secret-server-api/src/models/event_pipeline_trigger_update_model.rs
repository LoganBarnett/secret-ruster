...
/// EventPipelineTriggerUpdateModel : Value
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EventPipelineTriggerUpdateModel {
...
impl EventPipelineTriggerUpdateModel {
    /// Value
    pub fn new() -> EventPipelineTriggerUpdateModel {
