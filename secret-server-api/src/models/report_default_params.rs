...
/// ReportDefaultParams : ReportExecution
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ReportDefaultParams {
    /// DefaultParameterValues
    #[serde(rename = "defaultParameterValues", skip_serializing_if = "Option::is_none")]
    pub default_parameter_values: Option<Vec<models::ICustomReportParameterValue>>,
}

impl ReportDefaultParams {
    /// ReportExecution
    pub fn new() -> ReportDefaultParams {
        ReportDefaultParams {
