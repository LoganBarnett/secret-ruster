...
/// DisableEmailTwoFactorForUsersArgs : DisableEmailTwoFactorForUsersArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableEmailTwoFactorForUsersArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DisableEmailTwoFactorForUsersModel>>,
}

impl DisableEmailTwoFactorForUsersArgs {
    /// DisableEmailTwoFactorForUsersArgs
    pub fn new() -> DisableEmailTwoFactorForUsersArgs {
        DisableEmailTwoFactorForUsersArgs {
            data: None,
        }
    }
