...
/// CategorizedListItemCreateArgs : List Option Create Argument
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CategorizedListItemCreateArgs {
    /// Value(s) of the list options to add
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::CategorizedListItemCreateModel>>,
}

impl CategorizedListItemCreateArgs {
    /// List Option Create Argument
    pub fn new() -> CategorizedListItemCreateArgs {
