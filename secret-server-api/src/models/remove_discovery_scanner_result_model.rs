...
/// RemoveDiscoveryScannerResultModel : RemoveDiscoveryScannerResultModel
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct RemoveDiscoveryScannerResultModel {
    /// Success
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl RemoveDiscoveryScannerResultModel {
    /// RemoveDiscoveryScannerResultModel
    pub fn new() -> RemoveDiscoveryScannerResultModel {
        RemoveDiscoveryScannerResultModel {
            success: None,
        }
    }
