...
/// DisableAutoChangeSecretsArgs : DisableAutoChangeSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableAutoChangeSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DisableAutoChangeSecretsModel>>,
}

impl DisableAutoChangeSecretsArgs {
    /// DisableAutoChangeSecretsArgs
    pub fn new() -> DisableAutoChangeSecretsArgs {
        DisableAutoChangeSecretsArgs {
            data: None,
        }
    }
