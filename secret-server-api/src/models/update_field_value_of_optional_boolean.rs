...
/// UpdateFieldValueOfOptionalBoolean : Use RADIUS Username for DUO
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfOptionalBoolean {
    /// Dirty
...
impl UpdateFieldValueOfOptionalBoolean {
    /// Use RADIUS Username for DUO
    pub fn new() -> UpdateFieldValueOfOptionalBoolean {
