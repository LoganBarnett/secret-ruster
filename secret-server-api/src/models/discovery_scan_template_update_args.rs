...
/// DiscoveryScanTemplateUpdateArgs : Scan template update args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryScanTemplateUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryScanTemplateUpdateData>>,
}

impl DiscoveryScanTemplateUpdateArgs {
    /// Scan template update args
    pub fn new() -> DiscoveryScanTemplateUpdateArgs {
