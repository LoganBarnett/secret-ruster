...
/// ConfigurationPermissionOptionsPatchArgs : ConfigurationPermissionOptionsPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationPermissionOptionsPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConfigurationPermissionOptionsPatchModel>>,
}

impl ConfigurationPermissionOptionsPatchArgs {
    /// ConfigurationPermissionOptionsPatchArgs
    pub fn new() -> ConfigurationPermissionOptionsPatchArgs {
        ConfigurationPermissionOptionsPatchArgs {
            data: None,
        }
    }
