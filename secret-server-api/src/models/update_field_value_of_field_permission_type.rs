...
/// UpdateFieldValueOfFieldPermissionType : Type of permission required in order to edit this field
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfFieldPermissionType {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<models::FieldPermissionType>,
}

impl UpdateFieldValueOfFieldPermissionType {
    /// Type of permission required in order to edit this field
    pub fn new() -> UpdateFieldValueOfFieldPermissionType {
