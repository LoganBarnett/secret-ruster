...
/// DpapiEncryptArgs : DpapiEncryptArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DpapiEncryptArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DpapiEncryptRequestModel>>,
}

impl DpapiEncryptArgs {
    /// DpapiEncryptArgs
    pub fn new() -> DpapiEncryptArgs {
        DpapiEncryptArgs {
            data: None,
        }
    }
