...
/// DeleteDependenciesArgs : DeleteDependenciesArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DeleteDependenciesArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DeleteDependenciesModel>>,
}

impl DeleteDependenciesArgs {
    /// DeleteDependenciesArgs
    pub fn new() -> DeleteDependenciesArgs {
        DeleteDependenciesArgs {
            data: None,
        }
    }
