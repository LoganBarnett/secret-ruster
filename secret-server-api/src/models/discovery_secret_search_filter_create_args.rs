...
/// DiscoverySecretSearchFilterCreateArgs : DiscoverySecretSearchFilterCreateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoverySecretSearchFilterCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoverySecretSearchFilterCreateData>>,
}

impl DiscoverySecretSearchFilterCreateArgs {
    /// DiscoverySecretSearchFilterCreateArgs
    pub fn new() -> DiscoverySecretSearchFilterCreateArgs {
        DiscoverySecretSearchFilterCreateArgs {
            data: None,
        }
    }
