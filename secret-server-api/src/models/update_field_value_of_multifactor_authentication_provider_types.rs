...
/// UpdateFieldValueOfMultifactorAuthenticationProviderTypes : Domain multifactor authentication provider.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfMultifactorAuthenticationProviderTypes {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<models::MultifactorAuthenticationProviderTypes>,
}

impl UpdateFieldValueOfMultifactorAuthenticationProviderTypes {
    /// Domain multifactor authentication provider.
    pub fn new() -> UpdateFieldValueOfMultifactorAuthenticationProviderTypes {
