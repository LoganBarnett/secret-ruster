...
/// DiscoveryRunModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryRunModel {
    #[serde(rename = "commandType", skip_serializing_if = "Option::is_none")]
    pub command_type: Option<models::DiscoveryCommandType>,
}

impl DiscoveryRunModel {
    /// Data
    pub fn new() -> DiscoveryRunModel {
        DiscoveryRunModel {
            command_type: None,
        }
    }
