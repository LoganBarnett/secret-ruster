...
/// SecretDetailUpdateEmailArgs : Secret User Email Update Message
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretDetailUpdateEmailArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretDetailEmailUpdateModel>>,
}

impl SecretDetailUpdateEmailArgs {
    /// Secret User Email Update Message
    pub fn new() -> SecretDetailUpdateEmailArgs {
