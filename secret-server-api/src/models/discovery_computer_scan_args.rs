...
/// DiscoveryComputerScanArgs : DiscoveryComputerScanArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryComputerScanArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryComputerScansModel>>,
}

impl DiscoveryComputerScanArgs {
    /// DiscoveryComputerScanArgs
    pub fn new() -> DiscoveryComputerScanArgs {
        DiscoveryComputerScanArgs {
            data: None,
        }
    }
