...
/// DiscoverySourceFiltersUpdateModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoverySourceFiltersUpdateModel {
    /// Filters
    #[serde(rename = "filters", skip_serializing_if = "Option::is_none")]
    pub filters: Option<Vec<models::DomainDiscoveryScopeFilterUpdateModel>>,
}

impl DiscoverySourceFiltersUpdateModel {
    /// Data
    pub fn new() -> DiscoverySourceFiltersUpdateModel {
