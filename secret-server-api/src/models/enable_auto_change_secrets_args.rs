...
/// EnableAutoChangeSecretsArgs : EnableAutoChangeSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableAutoChangeSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EnableAutoChangeSecretsModel>>,
}

impl EnableAutoChangeSecretsArgs {
    /// EnableAutoChangeSecretsArgs
    pub fn new() -> EnableAutoChangeSecretsArgs {
        EnableAutoChangeSecretsArgs {
            data: None,
        }
    }
