...
/// DiscoveryImportArgs : The args for discovery import
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryImportArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryImportModel>>,
}

impl DiscoveryImportArgs {
    /// The args for discovery import
    pub fn new() -> DiscoveryImportArgs {
        DiscoveryImportArgs {
            data: None,
        }
    }
