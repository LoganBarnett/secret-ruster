...
/// SecretFieldPatchArgs : Secret Field Patch Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretFieldPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretTemplateFieldPatchModel>>,
}

impl SecretFieldPatchArgs {
    /// Secret Field Patch Args
    pub fn new() -> SecretFieldPatchArgs {
