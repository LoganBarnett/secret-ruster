...
/// JumpboxRouteLevelCreateArgs : JumpboxRouteLevelCreateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct JumpboxRouteLevelCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::JumpboxRouteLevelCreateModel>>,
}

impl JumpboxRouteLevelCreateArgs {
    /// JumpboxRouteLevelCreateArgs
    pub fn new() -> JumpboxRouteLevelCreateArgs {
        JumpboxRouteLevelCreateArgs {
            data: None,
        }
    }
