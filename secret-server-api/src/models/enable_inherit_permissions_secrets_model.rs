...
/// EnableInheritPermissionsSecretsModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableInheritPermissionsSecretsModel {
    /// Ids of Secrets to set Inherit Permissions to enabled.
    #[serde(rename = "secretIds", skip_serializing_if = "Option::is_none")]
    pub secret_ids: Option<Vec<i32>>,
}

impl EnableInheritPermissionsSecretsModel {
    /// Data
    pub fn new() -> EnableInheritPermissionsSecretsModel {
