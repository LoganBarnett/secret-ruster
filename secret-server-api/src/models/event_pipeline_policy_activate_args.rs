...
/// EventPipelinePolicyActivateArgs : EventPipelinePolicyActivateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EventPipelinePolicyActivateArgs {
    /// Activate
    #[serde(rename = "activate", skip_serializing_if = "Option::is_none")]
    pub activate: Option<bool>,
}

impl EventPipelinePolicyActivateArgs {
    /// EventPipelinePolicyActivateArgs
    pub fn new() -> EventPipelinePolicyActivateArgs {
        EventPipelinePolicyActivateArgs {
            activate: None,
        }
    }
