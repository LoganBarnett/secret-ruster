...
/// PasswordTypeUpdateArgsV2 : PasswordTypeUpdateArgsV2
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PasswordTypeUpdateArgsV2 {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::PasswordTypeUpdateModel>>,
}

impl PasswordTypeUpdateArgsV2 {
    /// PasswordTypeUpdateArgsV2
    pub fn new() -> PasswordTypeUpdateArgsV2 {
        PasswordTypeUpdateArgsV2 {
            data: None,
        }
    }
