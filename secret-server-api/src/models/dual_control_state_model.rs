...
/// DualControlStateModel : Whether or not dual control access has been authorized
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DualControlStateModel {
    #[serde(rename = "stateResult", skip_serializing_if = "Option::is_none")]
    pub state_result: Option<models::DualControlStateResultType>,
}

impl DualControlStateModel {
    /// Whether or not dual control access has been authorized
    pub fn new() -> DualControlStateModel {
