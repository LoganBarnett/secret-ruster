...
/// DisableDuoAuthForUsersArgs : DisableDuoAuthForUsersArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableDuoAuthForUsersArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DisableDuoAuthForUsersModel>>,
}

impl DisableDuoAuthForUsersArgs {
    /// DisableDuoAuthForUsersArgs
    pub fn new() -> DisableDuoAuthForUsersArgs {
        DisableDuoAuthForUsersArgs {
            data: None,
        }
    }
