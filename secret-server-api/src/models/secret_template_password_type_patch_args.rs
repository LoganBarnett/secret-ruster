...
/// SecretTemplatePasswordTypePatchArgs : SecretTemplatePasswordTypePatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretTemplatePasswordTypePatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretTemplatePasswordTypePatchModel>>,
}

impl SecretTemplatePasswordTypePatchArgs {
    /// SecretTemplatePasswordTypePatchArgs
    pub fn new() -> SecretTemplatePasswordTypePatchArgs {
        SecretTemplatePasswordTypePatchArgs {
            data: None,
        }
    }
