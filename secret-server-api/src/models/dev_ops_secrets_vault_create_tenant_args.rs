...
/// DevOpsSecretsVaultCreateTenantArgs : DevOpsSecretsVaultCreateTenantArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DevOpsSecretsVaultCreateTenantArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DevOpsSecretsVaultTenantUpdateModel>>,
}

impl DevOpsSecretsVaultCreateTenantArgs {
    /// DevOpsSecretsVaultCreateTenantArgs
    pub fn new() -> DevOpsSecretsVaultCreateTenantArgs {
        DevOpsSecretsVaultCreateTenantArgs {
            data: None,
        }
    }
