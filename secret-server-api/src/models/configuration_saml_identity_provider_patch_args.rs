...
/// ConfigurationSamlIdentityProviderPatchArgs : ConfigurationSamlIdentityProviderPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationSamlIdentityProviderPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConfigurationSamlIdentityProviderPatchModel>>,
}

impl ConfigurationSamlIdentityProviderPatchArgs {
    /// ConfigurationSamlIdentityProviderPatchArgs
    pub fn new() -> ConfigurationSamlIdentityProviderPatchArgs {
        ConfigurationSamlIdentityProviderPatchArgs {
            data: None,
        }
    }
