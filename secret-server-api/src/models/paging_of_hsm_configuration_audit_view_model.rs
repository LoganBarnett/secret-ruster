...
/// PagingOfHsmConfigurationAuditViewModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfHsmConfigurationAuditViewModel {
    ...
    pub records: Option<Vec<models::HsmConfigurationAuditViewModel>>,
...
impl PagingOfHsmConfigurationAuditViewModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfHsmConfigurationAuditViewModel {
