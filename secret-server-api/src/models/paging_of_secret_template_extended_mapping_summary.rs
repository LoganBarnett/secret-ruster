...
/// PagingOfSecretTemplateExtendedMappingSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSecretTemplateExtendedMappingSummary {
    ...
    pub records: Option<Vec<models::SecretTemplateExtendedMappingSummary>>,
...
impl PagingOfSecretTemplateExtendedMappingSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSecretTemplateExtendedMappingSummary {
