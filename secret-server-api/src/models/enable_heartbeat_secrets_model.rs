...
/// EnableHeartbeatSecretsModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableHeartbeatSecretsModel {
    /// Ids of Secrets to set Heartbeat to enabled.
    #[serde(rename = "secretIds", skip_serializing_if = "Option::is_none")]
    pub secret_ids: Option<Vec<i32>>,
}

impl EnableHeartbeatSecretsModel {
    /// Data
    pub fn new() -> EnableHeartbeatSecretsModel {
