...
/// PasswordTypeAuthUpdateArgs : The update arguments for password auth
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PasswordTypeAuthUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::PasswordTypeAuthUpdateModel>>,
}

impl PasswordTypeAuthUpdateArgs {
    /// The update arguments for password auth
    pub fn new() -> PasswordTypeAuthUpdateArgs {
