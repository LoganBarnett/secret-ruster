...
/// EnableRadiusTwoFactorForUsersArgs : EnableRadiusTwoFactorForUsersArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableRadiusTwoFactorForUsersArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EnableRadiusTwoFactorForUsersModel>>,
}

impl EnableRadiusTwoFactorForUsersArgs {
    /// EnableRadiusTwoFactorForUsersArgs
    pub fn new() -> EnableRadiusTwoFactorForUsersArgs {
        EnableRadiusTwoFactorForUsersArgs {
            data: None,
        }
    }
