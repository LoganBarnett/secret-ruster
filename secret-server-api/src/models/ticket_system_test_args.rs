...
/// TicketSystemTestArgs : TicketSystemTestArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TicketSystemTestArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::TicketSystemTestData>>,
}

impl TicketSystemTestArgs {
    /// TicketSystemTestArgs
    pub fn new() -> TicketSystemTestArgs {
        TicketSystemTestArgs {
            data: None,
        }
    }
