...
/// EnableHideLauncherPasswordSecretsArgs : EnableHideLauncherPasswordSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableHideLauncherPasswordSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EnableHideLauncherPasswordSecretsModel>>,
}

impl EnableHideLauncherPasswordSecretsArgs {
    /// EnableHideLauncherPasswordSecretsArgs
    pub fn new() -> EnableHideLauncherPasswordSecretsArgs {
        EnableHideLauncherPasswordSecretsArgs {
            data: None,
        }
    }
