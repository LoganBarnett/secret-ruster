...
/// SecretPolicyCreateArgsV2 : SecretPolicyCreateArgsV2
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretPolicyCreateArgsV2 {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretPolicyCreateModelV2>>,
}

impl SecretPolicyCreateArgsV2 {
    /// SecretPolicyCreateArgsV2
    pub fn new() -> SecretPolicyCreateArgsV2 {
        SecretPolicyCreateArgsV2 {
            data: None,
        }
    }
