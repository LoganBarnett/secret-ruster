...
/// DisableFido2TwoFactorForUsersArgs : DisableFido2TwoFactorForUsersArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableFido2TwoFactorForUsersArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DisableFido2TwoFactorForUsersModel>>,
}

impl DisableFido2TwoFactorForUsersArgs {
    /// DisableFido2TwoFactorForUsersArgs
    pub fn new() -> DisableFido2TwoFactorForUsersArgs {
        DisableFido2TwoFactorForUsersArgs {
            data: None,
        }
    }
