...
/// ConfigurationProtocolHandlerSettingsPatchArgs : ConfigurationProtocolHandlerSettingsPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationProtocolHandlerSettingsPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConfigurationProtocolHandlerSettingsPatchModel>>,
}

impl ConfigurationProtocolHandlerSettingsPatchArgs {
    /// ConfigurationProtocolHandlerSettingsPatchArgs
    pub fn new() -> ConfigurationProtocolHandlerSettingsPatchArgs {
        ConfigurationProtocolHandlerSettingsPatchArgs {
            data: None,
        }
    }
