...
/// DpapiEncryptRequestModel : DPAPI Encypt Request
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DpapiEncryptRequestModel {
    /// Password for Encryption
    #[serde(rename = "password", skip_serializing_if = "Option::is_none")]
    pub password: Option<String>,
}

impl DpapiEncryptRequestModel {
    /// DPAPI Encypt Request
    pub fn new() -> DpapiEncryptRequestModel {
