...
/// EventSubscriptionStubViewModel : EventSubscriptionStubViewModel
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EventSubscriptionStubViewModel {
    ...
    pub send_slack: Option<Box<models::ViewFieldValueOfBoolean>>,
}

impl EventSubscriptionStubViewModel {
    /// EventSubscriptionStubViewModel
    pub fn new() -> EventSubscriptionStubViewModel {
        EventSubscriptionStubViewModel {
            send_email: None,
            send_slack: None,
        }
