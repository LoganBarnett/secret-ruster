...
/// ForceLogoutForUsersArgs : ForceLogoutForUsersArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ForceLogoutForUsersArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ForceLogoutForUsersModel>>,
}

impl ForceLogoutForUsersArgs {
    /// ForceLogoutForUsersArgs
    pub fn new() -> ForceLogoutForUsersArgs {
        ForceLogoutForUsersArgs {
            data: None,
        }
    }
