...
/// PagingOfEventSubscriptionSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfEventSubscriptionSummary {
    ...
    pub records: Option<Vec<models::EventSubscriptionSummary>>,
...
impl PagingOfEventSubscriptionSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfEventSubscriptionSummary {
