...
/// PagingOfTeamGroupMembershipModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfTeamGroupMembershipModel {
    ...
    pub records: Option<Vec<models::TeamGroupMembershipModel>>,
...
impl PagingOfTeamGroupMembershipModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfTeamGroupMembershipModel {
