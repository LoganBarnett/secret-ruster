...
/// PagingOfSecretAccessRequestHistoryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSecretAccessRequestHistoryModel {
    ...
    pub records: Option<Vec<models::SecretAccessRequestHistoryModel>>,
...
impl PagingOfSecretAccessRequestHistoryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSecretAccessRequestHistoryModel {
