...
/// SecretDetailConvertTemplateInfoArgs : Get information used to convert a secret to a different template
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretDetailConvertTemplateInfoArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConvertTemplateInfoModel>>,
}

impl SecretDetailConvertTemplateInfoArgs {
    /// Get information used to convert a secret to a different template
    pub fn new() -> SecretDetailConvertTemplateInfoArgs {
