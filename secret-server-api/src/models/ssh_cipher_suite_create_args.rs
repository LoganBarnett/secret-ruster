...
/// SshCipherSuiteCreateArgs : SSH Cipher Suite Creation Arguments
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SshCipherSuiteCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SshCipherSuiteCreateModel>>,
}

impl SshCipherSuiteCreateArgs {
    /// SSH Cipher Suite Creation Arguments
    pub fn new() -> SshCipherSuiteCreateArgs {
