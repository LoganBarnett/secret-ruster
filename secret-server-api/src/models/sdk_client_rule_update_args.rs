...
/// SdkClientRuleUpdateArgs : SdkClientRuleUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SdkClientRuleUpdateArgs {
    /// Details
...
impl SdkClientRuleUpdateArgs {
    /// SdkClientRuleUpdateArgs
    pub fn new(name: String) -> SdkClientRuleUpdateArgs {
        SdkClientRuleUpdateArgs {
            details: None,
            name,
