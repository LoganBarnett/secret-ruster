...
/// SetUsersMigrationResponse : Set Users Migration Response
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SetUsersMigrationResponse {
    /// Whether migration was set successfully.
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl SetUsersMigrationResponse {
    /// Set Users Migration Response
    pub fn new() -> SetUsersMigrationResponse {
        SetUsersMigrationResponse {
            success: None,
        }
    }
}
