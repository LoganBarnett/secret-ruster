...
/// SecretTemplateFieldSortResultModel : The result of the sort
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretTemplateFieldSortResultModel {
    /// Did the sort succeed
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl SecretTemplateFieldSortResultModel {
    /// The result of the sort
    pub fn new() -> SecretTemplateFieldSortResultModel {
