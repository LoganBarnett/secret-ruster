...
/// EventPipelineOrderUpdateArgs : EventPipelineOrderUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EventPipelineOrderUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EventPipelineOrderUpdateModel>>,
}

impl EventPipelineOrderUpdateArgs {
    /// EventPipelineOrderUpdateArgs
    pub fn new() -> EventPipelineOrderUpdateArgs {
        EventPipelineOrderUpdateArgs {
            data: None,
        }
    }
