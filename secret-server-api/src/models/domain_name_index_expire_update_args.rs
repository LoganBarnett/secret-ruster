...
/// DomainNameIndexExpireUpdateArgs : DomainNameIndexExpireUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DomainNameIndexExpireUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DomainNameIndexExpireUpdateModel>>,
}

impl DomainNameIndexExpireUpdateArgs {
    /// DomainNameIndexExpireUpdateArgs
    pub fn new() -> DomainNameIndexExpireUpdateArgs {
        DomainNameIndexExpireUpdateArgs {
            data: None,
        }
    }
