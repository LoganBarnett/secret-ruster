...
/// DependencyChangerUpdateArgs : Scanner Dependency Changer update args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DependencyChangerUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DependencyChangerUpdateModel>>,
}

impl DependencyChangerUpdateArgs {
    /// Scanner Dependency Changer update args
    pub fn new() -> DependencyChangerUpdateArgs {
