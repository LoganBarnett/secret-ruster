...
/// UpdateFieldValueOfOptionalDouble : The value when the field is a number
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfOptionalDouble {
    /// Dirty
...
impl UpdateFieldValueOfOptionalDouble {
    /// The value when the field is a number
    pub fn new() -> UpdateFieldValueOfOptionalDouble {
