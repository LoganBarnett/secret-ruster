...
/// ConfigurationReadOnlyModeArgs : ConfigurationReadOnlyModeArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationReadOnlyModeArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConfigurationReadOnlyModeUpdateModel>>,
}

impl ConfigurationReadOnlyModeArgs {
    /// ConfigurationReadOnlyModeArgs
    pub fn new() -> ConfigurationReadOnlyModeArgs {
        ConfigurationReadOnlyModeArgs {
            data: None,
        }
    }
