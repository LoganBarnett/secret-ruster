...
/// ResetTotpAuthForUsersArgs : ResetTOTPAuthForUsersArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ResetTotpAuthForUsersArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ResetTotpAuthForUsersModel>>,
}

impl ResetTotpAuthForUsersArgs {
    /// ResetTOTPAuthForUsersArgs
    pub fn new() -> ResetTotpAuthForUsersArgs {
        ResetTotpAuthForUsersArgs {
            data: None,
        }
    }
