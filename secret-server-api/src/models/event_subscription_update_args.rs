...
/// EventSubscriptionUpdateArgs : EventSubscriptionUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EventSubscriptionUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EventSubscriptionUpdateModel>>,
}

impl EventSubscriptionUpdateArgs {
    /// EventSubscriptionUpdateArgs
    pub fn new() -> EventSubscriptionUpdateArgs {
        EventSubscriptionUpdateArgs {
            data: None,
        }
    }
