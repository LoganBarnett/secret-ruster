...
/// DevOpsSecretsVaultSyncSecretsArgs : DevOpsSecretsVaultSyncSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DevOpsSecretsVaultSyncSecretsArgs {
    /// Data
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<i32>>,
}

impl DevOpsSecretsVaultSyncSecretsArgs {
    /// DevOpsSecretsVaultSyncSecretsArgs
    pub fn new() -> DevOpsSecretsVaultSyncSecretsArgs {
        DevOpsSecretsVaultSyncSecretsArgs {
            data: None,
        }
    }
