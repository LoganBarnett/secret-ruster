...
/// PlatformDataMigrationResponse : Platform Data Migration Response
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlatformDataMigrationResponse {
    /// Whether or not Platform Migration was started successfully.
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl PlatformDataMigrationResponse {
    /// Platform Data Migration Response
    pub fn new() -> PlatformDataMigrationResponse {
        PlatformDataMigrationResponse {
            success: None,
        }
    }
}
