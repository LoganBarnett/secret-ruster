...
/// EventSubscriptionCreateArgs : EventSubscriptionCreateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EventSubscriptionCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EventSubscriptionCreateModel>>,
}

impl EventSubscriptionCreateArgs {
    /// EventSubscriptionCreateArgs
    pub fn new() -> EventSubscriptionCreateArgs {
        EventSubscriptionCreateArgs {
            data: None,
        }
    }
