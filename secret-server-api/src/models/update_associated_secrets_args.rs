...
/// UpdateAssociatedSecretsArgs : UpdateAssociatedSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateAssociatedSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::UpdateAssociatedSecretsModel>>,
}

impl UpdateAssociatedSecretsArgs {
    /// UpdateAssociatedSecretsArgs
    pub fn new() -> UpdateAssociatedSecretsArgs {
        UpdateAssociatedSecretsArgs {
            data: None,
        }
    }
