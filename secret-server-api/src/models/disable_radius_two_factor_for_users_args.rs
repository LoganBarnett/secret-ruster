...
/// DisableRadiusTwoFactorForUsersArgs : DisableRadiusTwoFactorForUsersArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableRadiusTwoFactorForUsersArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DisableRadiusTwoFactorForUsersModel>>,
}

impl DisableRadiusTwoFactorForUsersArgs {
    /// DisableRadiusTwoFactorForUsersArgs
    pub fn new() -> DisableRadiusTwoFactorForUsersArgs {
        DisableRadiusTwoFactorForUsersArgs {
            data: None,
        }
    }
