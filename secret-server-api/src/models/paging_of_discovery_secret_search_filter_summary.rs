...
/// PagingOfDiscoverySecretSearchFilterSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfDiscoverySecretSearchFilterSummary {
    ...
    pub records: Option<Vec<models::DiscoverySecretSearchFilterSummary>>,
...
impl PagingOfDiscoverySecretSearchFilterSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfDiscoverySecretSearchFilterSummary {
