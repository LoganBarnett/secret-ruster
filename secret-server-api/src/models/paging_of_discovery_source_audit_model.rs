...
/// PagingOfDiscoverySourceAuditModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfDiscoverySourceAuditModel {
    ...
    pub records: Option<Vec<models::DiscoverySourceAuditModel>>,
...
impl PagingOfDiscoverySourceAuditModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfDiscoverySourceAuditModel {
