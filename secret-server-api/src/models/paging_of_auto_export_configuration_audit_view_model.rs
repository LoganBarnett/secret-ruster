...
/// PagingOfAutoExportConfigurationAuditViewModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfAutoExportConfigurationAuditViewModel {
    ...
    pub records: Option<Vec<models::AutoExportConfigurationAuditViewModel>>,
...
impl PagingOfAutoExportConfigurationAuditViewModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfAutoExportConfigurationAuditViewModel {
