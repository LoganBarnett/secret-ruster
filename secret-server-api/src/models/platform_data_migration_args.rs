...
/// PlatformDataMigrationArgs : PlatformDataMigrationArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlatformDataMigrationArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::PlatformDataMigrationSettings>>,
}

impl PlatformDataMigrationArgs {
    /// PlatformDataMigrationArgs
    pub fn new() -> PlatformDataMigrationArgs {
        PlatformDataMigrationArgs {
            data: None,
        }
    }
