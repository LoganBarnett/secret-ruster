...
/// SecretPermissionsIsCurrentUserSecretOwnerArgs : SecretPermissionsIsCurrentUserSecretOwnerArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretPermissionsIsCurrentUserSecretOwnerArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretPermissionsIsCurrentUserSecretOwnerModel>>,
}

impl SecretPermissionsIsCurrentUserSecretOwnerArgs {
    /// SecretPermissionsIsCurrentUserSecretOwnerArgs
    pub fn new() -> SecretPermissionsIsCurrentUserSecretOwnerArgs {
        SecretPermissionsIsCurrentUserSecretOwnerArgs {
            data: None,
        }
    }
