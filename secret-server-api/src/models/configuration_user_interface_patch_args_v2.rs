...
/// ConfigurationUserInterfacePatchArgsV2 : ConfigurationUserInterfacePatchArgsV2
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationUserInterfacePatchArgsV2 {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConfigurationUserInterfacePatchModelV2>>,
}

impl ConfigurationUserInterfacePatchArgsV2 {
    /// ConfigurationUserInterfacePatchArgsV2
    pub fn new() -> ConfigurationUserInterfacePatchArgsV2 {
        ConfigurationUserInterfacePatchArgsV2 {
            data: None,
        }
    }
