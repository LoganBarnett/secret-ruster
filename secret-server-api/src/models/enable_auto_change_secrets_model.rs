...
/// EnableAutoChangeSecretsModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableAutoChangeSecretsModel {
    /// Ids of Secrets to set AutoChange to enabled.
    #[serde(rename = "secretIds", skip_serializing_if = "Option::is_none")]
    pub secret_ids: Option<Vec<i32>>,
}

impl EnableAutoChangeSecretsModel {
    /// Data
    pub fn new() -> EnableAutoChangeSecretsModel {
