...
/// DualControlAuthArgs : Dual control auth args 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DualControlAuthArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DualControlAuthDataModel>>,
}

impl DualControlAuthArgs {
    /// Dual control auth args 
    pub fn new() -> DualControlAuthArgs {
        DualControlAuthArgs {
            data: None,
        }
    }
