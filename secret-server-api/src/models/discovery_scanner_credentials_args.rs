...
/// DiscoveryScannerCredentialsArgs : DiscoveryScannerCredentialsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryScannerCredentialsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryScannerCredentialsData>>,
}

impl DiscoveryScannerCredentialsArgs {
    /// DiscoveryScannerCredentialsArgs
    pub fn new() -> DiscoveryScannerCredentialsArgs {
        DiscoveryScannerCredentialsArgs {
            data: None,
        }
    }
