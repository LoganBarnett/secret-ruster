...
/// SshCommandMenuPatchArgs : SshCommandMenuPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SshCommandMenuPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SshCommandMenuPatchModel>>,
}

impl SshCommandMenuPatchArgs {
    /// SshCommandMenuPatchArgs
    pub fn new() -> SshCommandMenuPatchArgs {
        SshCommandMenuPatchArgs {
            data: None,
        }
    }
