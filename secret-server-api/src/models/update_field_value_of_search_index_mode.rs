...
/// UpdateFieldValueOfSearchIndexMode : The index mode: standard or extended
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfSearchIndexMode {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<models::SearchIndexMode>,
}

impl UpdateFieldValueOfSearchIndexMode {
    /// The index mode: standard or extended
    pub fn new() -> UpdateFieldValueOfSearchIndexMode {
