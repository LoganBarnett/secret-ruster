...
/// UnassignedPermissionsModel : Permissions not assigned to any Role
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UnassignedPermissionsModel {
    /// Names of all unassigned Permissions
    #[serde(rename = "permissions", skip_serializing_if = "Option::is_none")]
    pub permissions: Option<Vec<String>>,
}

impl UnassignedPermissionsModel {
    /// Permissions not assigned to any Role
    pub fn new() -> UnassignedPermissionsModel {
