...
/// UpdateFieldValueOfSecretPolicyDataItemOfOptionalBoolean : Web Launcher Requires Incognito Mode
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfSecretPolicyDataItemOfOptionalBoolean {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<Box<models::SecretPolicyDataItemOfOptionalBoolean>>,
}

impl UpdateFieldValueOfSecretPolicyDataItemOfOptionalBoolean {
    /// Web Launcher Requires Incognito Mode
    pub fn new() -> UpdateFieldValueOfSecretPolicyDataItemOfOptionalBoolean {
