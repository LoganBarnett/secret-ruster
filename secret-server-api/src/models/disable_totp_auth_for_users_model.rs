...
/// DisableTotpAuthForUsersModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableTotpAuthForUsersModel {
    /// User Ids to set TOTP Auth to disabled.
    #[serde(rename = "userIds", skip_serializing_if = "Option::is_none")]
    pub user_ids: Option<Vec<i32>>,
}

impl DisableTotpAuthForUsersModel {
    /// Data
    pub fn new() -> DisableTotpAuthForUsersModel {
