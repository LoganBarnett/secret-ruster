...
/// PagingOfPlatformDataMigrationRoleSummaryAndPlatformDataMigrationRoleFilter : Specify filtering, paging, sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfPlatformDataMigrationRoleSummaryAndPlatformDataMigrationRoleFilter {
    ...
    pub filter: Option<Box<models::PlatformDataMigrationRoleFilter>>,
    ...
    pub records: Option<Vec<models::PlatformDataMigrationRoleSummary>>,
...
impl PagingOfPlatformDataMigrationRoleSummaryAndPlatformDataMigrationRoleFilter {
    /// Specify filtering, paging, sorting options for querying records and returning results
    pub fn new() -> PagingOfPlatformDataMigrationRoleSummaryAndPlatformDataMigrationRoleFilter {
