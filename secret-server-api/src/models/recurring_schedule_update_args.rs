...
/// RecurringScheduleUpdateArgs : RecurringScheduleUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct RecurringScheduleUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::RecurringScheduleUpdateModel>>,
}

impl RecurringScheduleUpdateArgs {
    /// RecurringScheduleUpdateArgs
    pub fn new() -> RecurringScheduleUpdateArgs {
        RecurringScheduleUpdateArgs {
            data: None,
        }
    }
