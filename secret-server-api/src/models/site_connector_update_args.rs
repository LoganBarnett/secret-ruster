...
/// SiteConnectorUpdateArgs : SiteConnectorUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SiteConnectorUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SiteConnectorUpdateModel>>,
}

impl SiteConnectorUpdateArgs {
    /// SiteConnectorUpdateArgs
    pub fn new() -> SiteConnectorUpdateArgs {
        SiteConnectorUpdateArgs {
            data: None,
        }
    }
