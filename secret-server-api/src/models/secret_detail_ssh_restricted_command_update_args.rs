...
/// SecretDetailSshRestrictedCommandUpdateArgs : Update Secret SSH Command Arguments
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretDetailSshRestrictedCommandUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretDetailSshCommandUpdateData>>,
}

impl SecretDetailSshRestrictedCommandUpdateArgs {
    /// Update Secret SSH Command Arguments
    pub fn new() -> SecretDetailSshRestrictedCommandUpdateArgs {
