...
/// SetGroupsMigrationArgs : SetGroupsMigrationArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SetGroupsMigrationArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SetGroupsMigrationModel>>,
}

impl SetGroupsMigrationArgs {
    /// SetGroupsMigrationArgs
    pub fn new() -> SetGroupsMigrationArgs {
        SetGroupsMigrationArgs {
            data: None,
        }
    }
