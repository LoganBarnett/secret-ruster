...
/// DiscoveryRuleDependencyUpdateArgs : Discovery Rule Dependency Update Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryRuleDependencyUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryRuleDependencyUpdateModel>>,
}

impl DiscoveryRuleDependencyUpdateArgs {
    /// Discovery Rule Dependency Update Args
    pub fn new() -> DiscoveryRuleDependencyUpdateArgs {
