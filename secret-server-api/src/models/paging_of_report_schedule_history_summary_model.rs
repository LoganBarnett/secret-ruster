...
/// PagingOfReportScheduleHistorySummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfReportScheduleHistorySummaryModel {
    ...
    pub records: Option<Vec<models::ReportScheduleHistorySummaryModel>>,
...
impl PagingOfReportScheduleHistorySummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfReportScheduleHistorySummaryModel {
