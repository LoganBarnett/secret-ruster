...
/// SecretTemplateLauncherDeleteResultModel : Delete result message
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretTemplateLauncherDeleteResultModel {
    /// True if process has succeeded
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl SecretTemplateLauncherDeleteResultModel {
    /// Delete result message
    pub fn new() -> SecretTemplateLauncherDeleteResultModel {
