...
/// DisableHeartbeatSecretsArgs : DisableHeartbeatSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableHeartbeatSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DisableHeartbeatSecretsModel>>,
}

impl DisableHeartbeatSecretsArgs {
    /// DisableHeartbeatSecretsArgs
    pub fn new() -> DisableHeartbeatSecretsArgs {
        DisableHeartbeatSecretsArgs {
            data: None,
        }
    }
