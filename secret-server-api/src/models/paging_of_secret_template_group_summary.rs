...
/// PagingOfSecretTemplateGroupSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSecretTemplateGroupSummary {
    ...
    pub records: Option<Vec<models::SecretTemplateGroupSummary>>,
...
impl PagingOfSecretTemplateGroupSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSecretTemplateGroupSummary {
