...
/// EnableFido2TwoFactorForUsersArgs : EnableFido2TwoFactorForUsersArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableFido2TwoFactorForUsersArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EnableFido2TwoFactorForUsersModel>>,
}

impl EnableFido2TwoFactorForUsersArgs {
    /// EnableFido2TwoFactorForUsersArgs
    pub fn new() -> EnableFido2TwoFactorForUsersArgs {
        EnableFido2TwoFactorForUsersArgs {
            data: None,
        }
    }
