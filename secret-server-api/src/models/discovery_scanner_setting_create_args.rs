...
/// DiscoveryScannerSettingCreateArgs : Discovery Scanner Settings Create Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryScannerSettingCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryScannerSettingCreateData>>,
}

impl DiscoveryScannerSettingCreateArgs {
    /// Discovery Scanner Settings Create Args
    pub fn new() -> DiscoveryScannerSettingCreateArgs {
