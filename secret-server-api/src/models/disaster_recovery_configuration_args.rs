...
/// DisasterRecoveryConfigurationArgs : DisasterRecoveryConfigurationArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisasterRecoveryConfigurationArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DisasterRecoveryConfigurationUpdateModel>>,
}

impl DisasterRecoveryConfigurationArgs {
    /// DisasterRecoveryConfigurationArgs
    pub fn new() -> DisasterRecoveryConfigurationArgs {
        DisasterRecoveryConfigurationArgs {
            data: None,
        }
    }
