...
/// ExportSecretSettingsArgs : ExportSecretSettingsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ExportSecretSettingsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ExportSecretSettingsModel>>,
}

impl ExportSecretSettingsArgs {
    /// ExportSecretSettingsArgs
    pub fn new() -> ExportSecretSettingsArgs {
        ExportSecretSettingsArgs {
            data: None,
        }
    }
