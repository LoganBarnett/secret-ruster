...
/// PagingOfDiscoveryScannerSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfDiscoveryScannerSummary {
    ...
    pub records: Option<Vec<models::DiscoveryScannerSummary>>,
...
impl PagingOfDiscoveryScannerSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfDiscoveryScannerSummary {
