...
/// DiscoveryRuleDependencySortResultModel : Sort Response Model
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryRuleDependencySortResultModel {
    /// Whether or not the sort was successful.
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl DiscoveryRuleDependencySortResultModel {
    /// Sort Response Model
    pub fn new() -> DiscoveryRuleDependencySortResultModel {
