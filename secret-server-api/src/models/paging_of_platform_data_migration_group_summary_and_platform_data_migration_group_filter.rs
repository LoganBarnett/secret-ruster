...
/// PagingOfPlatformDataMigrationGroupSummaryAndPlatformDataMigrationGroupFilter : Specify filtering, paging, sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfPlatformDataMigrationGroupSummaryAndPlatformDataMigrationGroupFilter {
    ...
    pub filter: Option<Box<models::PlatformDataMigrationGroupFilter>>,
    ...
    pub records: Option<Vec<models::PlatformDataMigrationGroupSummary>>,
...
impl PagingOfPlatformDataMigrationGroupSummaryAndPlatformDataMigrationGroupFilter {
    /// Specify filtering, paging, sorting options for querying records and returning results
    pub fn new() -> PagingOfPlatformDataMigrationGroupSummaryAndPlatformDataMigrationGroupFilter {
