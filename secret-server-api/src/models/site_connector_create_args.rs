...
/// SiteConnectorCreateArgs : SiteConnectorCreateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SiteConnectorCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SiteConnectorCreateModel>>,
}

impl SiteConnectorCreateArgs {
    /// SiteConnectorCreateArgs
    pub fn new() -> SiteConnectorCreateArgs {
        SiteConnectorCreateArgs {
            data: None,
        }
    }
