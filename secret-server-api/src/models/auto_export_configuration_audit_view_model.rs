...
/// AutoExportConfigurationAuditViewModel : Automatic Export Configuration Audit
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AutoExportConfigurationAuditViewModel {
    /// Action
...
impl AutoExportConfigurationAuditViewModel {
    /// Automatic Export Configuration Audit
    pub fn new() -> AutoExportConfigurationAuditViewModel {
