...
/// DistributedEngineConfigurationUpdateArgs : DistributedEngineConfigurationUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DistributedEngineConfigurationUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DistributedEngineConfigurationUpdateModel>>,
}

impl DistributedEngineConfigurationUpdateArgs {
    /// DistributedEngineConfigurationUpdateArgs
    pub fn new() -> DistributedEngineConfigurationUpdateArgs {
        DistributedEngineConfigurationUpdateArgs {
            data: None,
        }
    }
