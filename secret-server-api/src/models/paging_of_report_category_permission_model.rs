...
/// PagingOfReportCategoryPermissionModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfReportCategoryPermissionModel {
    ...
    pub records: Option<Vec<models::ReportCategoryPermissionModel>>,
...
impl PagingOfReportCategoryPermissionModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfReportCategoryPermissionModel {
