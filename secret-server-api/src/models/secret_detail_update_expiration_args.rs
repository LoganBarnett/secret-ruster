...
pub struct SecretDetailUpdateExpirationArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretDetailExpirationUpdateModel>>,
}

impl SecretDetailUpdateExpirationArgs {
    /// SecretDetailUpdateExpirationArgs
    pub fn new() -> SecretDetailUpdateExpirationArgs {
        SecretDetailUpdateExpirationArgs {
            data: None,
        }
    }
