...
/// PrepareLauncherQueryResultModel : Prepare Launcher Query Result
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PrepareLauncherQueryResultModel {
    /// True when Prepare Launcher succeeds, otherwise false.
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl PrepareLauncherQueryResultModel {
    /// Prepare Launcher Query Result
    pub fn new() -> PrepareLauncherQueryResultModel {
