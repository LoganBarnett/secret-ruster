...
/// CategorizedListItemDeleteModel : CategorizedListItemDeleteModel
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CategorizedListItemDeleteModel {
    /// IsDeleted
    #[serde(rename = "isDeleted", skip_serializing_if = "Option::is_none")]
    pub is_deleted: Option<bool>,
}

impl CategorizedListItemDeleteModel {
    /// CategorizedListItemDeleteModel
    pub fn new() -> CategorizedListItemDeleteModel {
        CategorizedListItemDeleteModel {
            is_deleted: None,
        }
    }
