...
/// DiscoveryScannerSettingsArgs : DiscoveryScannerSettingsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryScannerSettingsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryScannerSettingsData>>,
}

impl DiscoveryScannerSettingsArgs {
    /// DiscoveryScannerSettingsArgs
    pub fn new() -> DiscoveryScannerSettingsArgs {
        DiscoveryScannerSettingsArgs {
            data: None,
        }
    }
