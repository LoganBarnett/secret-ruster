...
/// UpdateFieldValueOfOptionalDateTimeOffset : When should be global banner stop displaying to users
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfOptionalDateTimeOffset {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<Box<models::OptionalDateTimeOffset>>,
}

impl UpdateFieldValueOfOptionalDateTimeOffset {
    /// When should be global banner stop displaying to users
    pub fn new() -> UpdateFieldValueOfOptionalDateTimeOffset {
