...
/// ConfigurationTicketSystemArgs : ConfigurationTicketSystemArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationTicketSystemArgs {
    /// Data
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::TicketSystemPatchModel>>,
}

impl ConfigurationTicketSystemArgs {
    /// ConfigurationTicketSystemArgs
    pub fn new() -> ConfigurationTicketSystemArgs {
        ConfigurationTicketSystemArgs {
            data: None,
        }
    }
