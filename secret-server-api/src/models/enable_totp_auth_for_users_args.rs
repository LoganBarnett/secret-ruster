...
/// EnableTotpAuthForUsersArgs : EnableTOTPAuthForUsersArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableTotpAuthForUsersArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::EnableTotpAuthForUsersModel>>,
}

impl EnableTotpAuthForUsersArgs {
    /// EnableTOTPAuthForUsersArgs
    pub fn new() -> EnableTotpAuthForUsersArgs {
        EnableTotpAuthForUsersArgs {
            data: None,
        }
    }
