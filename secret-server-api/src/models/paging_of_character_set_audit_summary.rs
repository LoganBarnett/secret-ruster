...
/// PagingOfCharacterSetAuditSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfCharacterSetAuditSummary {
    ...
    pub records: Option<Vec<models::CharacterSetAuditSummary>>,
...
impl PagingOfCharacterSetAuditSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfCharacterSetAuditSummary {
