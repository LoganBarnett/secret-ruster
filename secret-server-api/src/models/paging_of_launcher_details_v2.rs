...
/// PagingOfLauncherDetailsV2 : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfLauncherDetailsV2 {
    ...
    pub records: Option<Vec<models::LauncherDetailsV2>>,
