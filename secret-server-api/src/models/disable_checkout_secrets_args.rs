...
/// DisableCheckoutSecretsArgs : DisableCheckoutSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableCheckoutSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DisableCheckoutSecretsModel>>,
}

impl DisableCheckoutSecretsArgs {
    /// DisableCheckoutSecretsArgs
    pub fn new() -> DisableCheckoutSecretsArgs {
        DisableCheckoutSecretsArgs {
            data: None,
        }
    }
