...
/// RemoteScriptTestSqlArgs : PowerShell test args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct RemoteScriptTestSqlArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::RemoteScriptTestSqlData>>,
}

impl RemoteScriptTestSqlArgs {
    /// PowerShell test args
    pub fn new() -> RemoteScriptTestSqlArgs {
