...
/// AlertNotificationReadEventArgs : AlertNotificationReadEventArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AlertNotificationReadEventArgs {
    /// NotificationId
    #[serde(rename = "notificationId", skip_serializing_if = "Option::is_none")]
    pub notification_id: Option<uuid::Uuid>,
}

impl AlertNotificationReadEventArgs {
    /// AlertNotificationReadEventArgs
    pub fn new() -> AlertNotificationReadEventArgs {
        AlertNotificationReadEventArgs {
