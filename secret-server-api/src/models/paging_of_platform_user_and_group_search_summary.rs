...
/// PagingOfPlatformUserAndGroupSearchSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfPlatformUserAndGroupSearchSummary {
    ...
    pub records: Option<Vec<models::PlatformUserAndGroupSearchSummary>>,
...
impl PagingOfPlatformUserAndGroupSearchSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfPlatformUserAndGroupSearchSummary {
