...
/// AlertNotificationUnreadEventArgs : AlertNotificationUnreadEventArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AlertNotificationUnreadEventArgs {
    /// NotificationId
    #[serde(rename = "notificationId", skip_serializing_if = "Option::is_none")]
    pub notification_id: Option<uuid::Uuid>,
}

impl AlertNotificationUnreadEventArgs {
    /// AlertNotificationUnreadEventArgs
    pub fn new() -> AlertNotificationUnreadEventArgs {
        AlertNotificationUnreadEventArgs {
