...
/// PagingOfDisasterRecoveryAuditViewModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfDisasterRecoveryAuditViewModel {
    ...
    pub records: Option<Vec<models::DisasterRecoveryAuditViewModel>>,
...
impl PagingOfDisasterRecoveryAuditViewModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfDisasterRecoveryAuditViewModel {
