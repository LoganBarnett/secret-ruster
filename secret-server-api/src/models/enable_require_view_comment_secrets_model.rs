...
/// EnableRequireViewCommentSecretsModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableRequireViewCommentSecretsModel {
    /// Ids of Secrets to set Require View Comment to enabled.
    #[serde(rename = "secretIds", skip_serializing_if = "Option::is_none")]
    pub secret_ids: Option<Vec<i32>>,
}

impl EnableRequireViewCommentSecretsModel {
    /// Data
    pub fn new() -> EnableRequireViewCommentSecretsModel {
