...
/// DeactivateSecretsArgs : DeactivateSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DeactivateSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DeactivateSecretsModel>>,
}

impl DeactivateSecretsArgs {
    /// DeactivateSecretsArgs
    pub fn new() -> DeactivateSecretsArgs {
        DeactivateSecretsArgs {
            data: None,
        }
    }
