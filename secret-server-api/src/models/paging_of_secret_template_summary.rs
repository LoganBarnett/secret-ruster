...
/// PagingOfSecretTemplateSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSecretTemplateSummary {
    ...
    pub records: Option<Vec<models::SecretTemplateSummary>>,
