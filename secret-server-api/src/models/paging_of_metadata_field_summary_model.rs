...
/// PagingOfMetadataFieldSummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfMetadataFieldSummaryModel {
    ...
    pub records: Option<Vec<models::MetadataFieldSummaryModel>>,
...
impl PagingOfMetadataFieldSummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfMetadataFieldSummaryModel {
