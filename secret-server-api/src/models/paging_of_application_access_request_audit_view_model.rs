...
/// PagingOfApplicationAccessRequestAuditViewModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfApplicationAccessRequestAuditViewModel {
    ...
    pub records: Option<Vec<models::ApplicationAccessRequestAuditViewModel>>,
...
impl PagingOfApplicationAccessRequestAuditViewModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfApplicationAccessRequestAuditViewModel {
