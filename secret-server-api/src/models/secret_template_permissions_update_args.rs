...
/// SecretTemplatePermissionsUpdateArgs : SecretTemplatePermissionsUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretTemplatePermissionsUpdateArgs {
    /// GroupId
    #[serde(rename = "groupId", skip_serializing_if = "Option::is_none")]
    pub group_id: Option<i32>,
    /// Permissions
    #[serde(rename = "permissions", skip_serializing_if = "Option::is_none")]
    pub permissions: Option<Vec<models::PermissionModel>>,
}

impl SecretTemplatePermissionsUpdateArgs {
    /// SecretTemplatePermissionsUpdateArgs
    pub fn new() -> SecretTemplatePermissionsUpdateArgs {
        SecretTemplatePermissionsUpdateArgs {
            group_id: None,
            permissions: None,
        }
