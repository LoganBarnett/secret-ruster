...
/// DiscoveryComputerDeleteArgs : DiscoveryComputerDeleteArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryComputerDeleteArgs {
    /// Data
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<i32>>,
}

impl DiscoveryComputerDeleteArgs {
    /// DiscoveryComputerDeleteArgs
    pub fn new() -> DiscoveryComputerDeleteArgs {
        DiscoveryComputerDeleteArgs {
            data: None,
        }
    }
