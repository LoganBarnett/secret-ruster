...
/// PagingOfSecurityAuditLogSummaryAndSecurityAuditLogFilter : Specify filtering, paging, sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSecurityAuditLogSummaryAndSecurityAuditLogFilter {
    ...
    pub filter: Option<Box<models::SecurityAuditLogFilter>>,
    ...
    pub records: Option<Vec<models::SecurityAuditLogSummary>>,
...
impl PagingOfSecurityAuditLogSummaryAndSecurityAuditLogFilter {
    /// Specify filtering, paging, sorting options for querying records and returning results
    pub fn new() -> PagingOfSecurityAuditLogSummaryAndSecurityAuditLogFilter {
