...
/// SecretTemplateCopyArgs : Secret Template Copy Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretTemplateCopyArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretTemplateCopyModel>>,
}

impl SecretTemplateCopyArgs {
    /// Secret Template Copy Args
    pub fn new() -> SecretTemplateCopyArgs {
