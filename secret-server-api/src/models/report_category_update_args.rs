...
/// ReportCategoryUpdateArgs : Report Category Update Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ReportCategoryUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ReportCategoryUpdateModel>>,
}

impl ReportCategoryUpdateArgs {
    /// Report Category Update Args
    pub fn new() -> ReportCategoryUpdateArgs {
