...
/// PagingOfPlatformDirectorySummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfPlatformDirectorySummary {
    ...
    pub records: Option<Vec<models::PlatformDirectorySummary>>,
...
impl PagingOfPlatformDirectorySummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfPlatformDirectorySummary {
