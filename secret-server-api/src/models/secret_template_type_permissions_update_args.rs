...
/// SecretTemplateTypePermissionsUpdateArgs : SecretTemplateTypePermissionsUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretTemplateTypePermissionsUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretTemplateTypePermissionsUpdateModel>>,
}

impl SecretTemplateTypePermissionsUpdateArgs {
    /// SecretTemplateTypePermissionsUpdateArgs
    pub fn new() -> SecretTemplateTypePermissionsUpdateArgs {
        SecretTemplateTypePermissionsUpdateArgs {
            data: None,
        }
    }
