...
/// DisableRequireViewCommentSecretsArgs : DisableRequireViewCommentSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableRequireViewCommentSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DisableRequireViewCommentSecretsModel>>,
}

impl DisableRequireViewCommentSecretsArgs {
    /// DisableRequireViewCommentSecretsArgs
    pub fn new() -> DisableRequireViewCommentSecretsArgs {
        DisableRequireViewCommentSecretsArgs {
            data: None,
        }
    }
