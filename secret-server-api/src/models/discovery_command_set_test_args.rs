...
/// DiscoveryCommandSetTestArgs : Test args for a command set
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryCommandSetTestArgs {
    /// Test data for a command set
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<serde_json::Value>,
}

impl DiscoveryCommandSetTestArgs {
    /// Test args for a command set
    pub fn new() -> DiscoveryCommandSetTestArgs {
        DiscoveryCommandSetTestArgs {
            data: None,
        }
    }
}
