...
/// PagingOfDiscoveryNetworkServiceAccount : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfDiscoveryNetworkServiceAccount {
    ...
    pub records: Option<Vec<models::DiscoveryNetworkServiceAccount>>,
...
impl PagingOfDiscoveryNetworkServiceAccount {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfDiscoveryNetworkServiceAccount {
