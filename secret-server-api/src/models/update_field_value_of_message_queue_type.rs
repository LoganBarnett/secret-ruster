...
/// UpdateFieldValueOfMessageQueueType : Queue Type of Site Connector
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfMessageQueueType {
    /// Dirty
...
impl UpdateFieldValueOfMessageQueueType {
    /// Queue Type of Site Connector
    pub fn new() -> UpdateFieldValueOfMessageQueueType {
