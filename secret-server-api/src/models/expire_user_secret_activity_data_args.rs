...
/// ExpireUserSecretActivityDataArgs : ExpireUserSecretActivityDataArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ExpireUserSecretActivityDataArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ExpireUserSecretActivityDataModel>>,
}

impl ExpireUserSecretActivityDataArgs {
    /// ExpireUserSecretActivityDataArgs
    pub fn new() -> ExpireUserSecretActivityDataArgs {
        ExpireUserSecretActivityDataArgs {
            data: None,
        }
    }
