...
/// DiscoveryRuleSecretTemplate : DiscoveryRuleSecretTemplate[]
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryRuleSecretTemplate {
    /// Secret Template Id
...
impl DiscoveryRuleSecretTemplate {
    /// DiscoveryRuleSecretTemplate[]
    pub fn new() -> DiscoveryRuleSecretTemplate {
        DiscoveryRuleSecretTemplate {
            id: None,
            name: None,
        }
