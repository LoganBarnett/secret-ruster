...
/// PagingOfApplicationAccessRequestViewModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfApplicationAccessRequestViewModel {
    ...
    pub records: Option<Vec<models::ApplicationAccessRequestViewModel>>,
...
impl PagingOfApplicationAccessRequestViewModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfApplicationAccessRequestViewModel {
