...
/// ConvertTemplateDestinationModel : Destination
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConvertTemplateDestinationModel {
    /// Fields
    #[serde(rename = "fields", skip_serializing_if = "Option::is_none")]
    pub fields: Option<Vec<models::ConvertTemplateDetailFieldModel>>,
}

impl ConvertTemplateDestinationModel {
    /// Destination
    pub fn new() -> ConvertTemplateDestinationModel {
