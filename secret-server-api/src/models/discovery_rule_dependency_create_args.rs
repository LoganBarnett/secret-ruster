...
/// DiscoveryRuleDependencyCreateArgs : Discovery Rule Dependency Create Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryRuleDependencyCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryRuleDependencyCreateModel>>,
}

impl DiscoveryRuleDependencyCreateArgs {
    /// Discovery Rule Dependency Create Args
    pub fn new() -> DiscoveryRuleDependencyCreateArgs {
