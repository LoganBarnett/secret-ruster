...
/// PagingOfEventPipelineRunViewModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfEventPipelineRunViewModel {
    ...
    pub records: Option<Vec<models::EventPipelineRunViewModel>>,
...
impl PagingOfEventPipelineRunViewModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfEventPipelineRunViewModel {
