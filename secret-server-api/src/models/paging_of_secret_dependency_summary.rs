...
/// PagingOfSecretDependencySummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSecretDependencySummary {
    ...
    pub records: Option<Vec<models::SecretDependencySummary>>,
...
impl PagingOfSecretDependencySummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSecretDependencySummary {
