...
/// PagingOfSdkClientAuditSummaryAndSdkClientAuditFilter : Specify filtering, paging, sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSdkClientAuditSummaryAndSdkClientAuditFilter {
    ...
    pub filter: Option<Box<models::SdkClientAuditFilter>>,
    ...
    pub records: Option<Vec<models::SdkClientAuditSummary>>,
...
impl PagingOfSdkClientAuditSummaryAndSdkClientAuditFilter {
    /// Specify filtering, paging, sorting options for querying records and returning results
    pub fn new() -> PagingOfSdkClientAuditSummaryAndSdkClientAuditFilter {
