...
/// PagingOfPlatformDataMigrationLogSummaryAndPlatformDataMigrationLogSearchFilter : Specify filtering, paging, sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfPlatformDataMigrationLogSummaryAndPlatformDataMigrationLogSearchFilter {
    ...
    pub filter: Option<Box<models::PlatformDataMigrationLogSearchFilter>>,
    ...
    pub records: Option<Vec<models::PlatformDataMigrationLogSummary>>,
...
impl PagingOfPlatformDataMigrationLogSummaryAndPlatformDataMigrationLogSearchFilter {
    /// Specify filtering, paging, sorting options for querying records and returning results
    pub fn new() -> PagingOfPlatformDataMigrationLogSummaryAndPlatformDataMigrationLogSearchFilter {
