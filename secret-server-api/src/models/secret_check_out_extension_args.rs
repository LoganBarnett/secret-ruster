...
/// SecretCheckOutExtensionArgs : Secret Check Out Extension Args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretCheckOutExtensionArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretCheckOutExtensionModel>>,
}

impl SecretCheckOutExtensionArgs {
    /// Secret Check Out Extension Args
    pub fn new() -> SecretCheckOutExtensionArgs {
