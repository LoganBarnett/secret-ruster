...
/// SecretTemplateFieldsModel : SecretTemplateFieldsModel
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretTemplateFieldsModel {
    /// Fields
    #[serde(rename = "fields", skip_serializing_if = "Option::is_none")]
    pub fields: Option<Vec<models::SecretTemplateFieldBasic>>,
}

impl SecretTemplateFieldsModel {
    /// SecretTemplateFieldsModel
    pub fn new() -> SecretTemplateFieldsModel {
        SecretTemplateFieldsModel {
            fields: None,
        }
    }
