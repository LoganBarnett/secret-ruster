...
/// SecretShareUpdateArgs : SecretShareUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretShareUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretShareUpdateModel>>,
}

impl SecretShareUpdateArgs {
    /// SecretShareUpdateArgs
    pub fn new() -> SecretShareUpdateArgs {
        SecretShareUpdateArgs {
            data: None,
        }
    }
