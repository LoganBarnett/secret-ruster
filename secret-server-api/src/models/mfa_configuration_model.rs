...
/// MfaConfigurationModel : Current Multifactor Authentication Configuration
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct MfaConfigurationModel {
    /// Authentication Profiles
    #[serde(rename = "authProfiles", skip_serializing_if = "Option::is_none")]
    pub auth_profiles: Option<Vec<models::AuthProfileModel>>,
}

impl MfaConfigurationModel {
    /// Current Multifactor Authentication Configuration
    pub fn new() -> MfaConfigurationModel {
