...
/// JumpboxRoutePatchArgs : JumpboxRoutePatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct JumpboxRoutePatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::JumpboxRoutePatchModel>>,
}

impl JumpboxRoutePatchArgs {
    /// JumpboxRoutePatchArgs
    pub fn new() -> JumpboxRoutePatchArgs {
        JumpboxRoutePatchArgs {
            data: None,
        }
    }
