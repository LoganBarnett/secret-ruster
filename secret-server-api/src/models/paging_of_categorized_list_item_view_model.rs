...
/// PagingOfCategorizedListItemViewModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfCategorizedListItemViewModel {
    ...
    pub records: Option<Vec<models::CategorizedListItemViewModel>>,
...
impl PagingOfCategorizedListItemViewModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfCategorizedListItemViewModel {
