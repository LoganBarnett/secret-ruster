...
/// UnlimitedAdminUpdateArgs : UnlimitedAdminUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UnlimitedAdminUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::UnlimitedAdminUpdateModel>>,
}

impl UnlimitedAdminUpdateArgs {
    /// UnlimitedAdminUpdateArgs
    pub fn new() -> UnlimitedAdminUpdateArgs {
        UnlimitedAdminUpdateArgs {
            data: None,
        }
    }
