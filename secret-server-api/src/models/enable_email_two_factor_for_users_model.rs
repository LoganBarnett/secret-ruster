...
/// EnableEmailTwoFactorForUsersModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableEmailTwoFactorForUsersModel {
    /// User Ids to set Email Two Factor to enabled.
    #[serde(rename = "userIds", skip_serializing_if = "Option::is_none")]
    pub user_ids: Option<Vec<i32>>,
}

impl EnableEmailTwoFactorForUsersModel {
    /// Data
    pub fn new() -> EnableEmailTwoFactorForUsersModel {
