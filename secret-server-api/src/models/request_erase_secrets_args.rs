...
/// RequestEraseSecretsArgs : RequestEraseSecretsArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct RequestEraseSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::RequestEraseSecretsModel>>,
}

impl RequestEraseSecretsArgs {
    /// RequestEraseSecretsArgs
    pub fn new() -> RequestEraseSecretsArgs {
        RequestEraseSecretsArgs {
            data: None,
        }
    }
