...
/// RecycleBackgroundProcessesResultModel : RecycleBackgroundProcessesResultModel
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct RecycleBackgroundProcessesResultModel {
    /// Success
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl RecycleBackgroundProcessesResultModel {
    /// RecycleBackgroundProcessesResultModel
    pub fn new() -> RecycleBackgroundProcessesResultModel {
        RecycleBackgroundProcessesResultModel {
            success: None,
        }
    }
