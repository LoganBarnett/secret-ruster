...
/// DiscoveryScannerCreateArgs : Create scanner args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryScannerCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryScannerCreateData>>,
}

impl DiscoveryScannerCreateArgs {
    /// Create scanner args
    pub fn new() -> DiscoveryScannerCreateArgs {
