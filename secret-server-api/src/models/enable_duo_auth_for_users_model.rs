...
/// EnableDuoAuthForUsersModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnableDuoAuthForUsersModel {
    /// User Ids to set Duo Auth to enabled.
    #[serde(rename = "userIds", skip_serializing_if = "Option::is_none")]
    pub user_ids: Option<Vec<i32>>,
}

impl EnableDuoAuthForUsersModel {
    /// Data
    pub fn new() -> EnableDuoAuthForUsersModel {
