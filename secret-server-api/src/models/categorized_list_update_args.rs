...
/// CategorizedListUpdateArgs : CategorizedListUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CategorizedListUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::CategorizedListUpdateModel>>,
}

impl CategorizedListUpdateArgs {
    /// CategorizedListUpdateArgs
    pub fn new() -> CategorizedListUpdateArgs {
        CategorizedListUpdateArgs {
            data: None,
        }
    }
