...
/// AssignSecretsToJumpboxRouteArgs : AssignSecretsToJumpboxRouteArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AssignSecretsToJumpboxRouteArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::AssignSecretsToJumpboxRouteModel>>,
}

impl AssignSecretsToJumpboxRouteArgs {
    /// AssignSecretsToJumpboxRouteArgs
    pub fn new() -> AssignSecretsToJumpboxRouteArgs {
        AssignSecretsToJumpboxRouteArgs {
            data: None,
        }
    }
