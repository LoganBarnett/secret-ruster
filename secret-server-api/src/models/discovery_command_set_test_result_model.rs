...
/// DiscoveryCommandSetTestResultModel : The result of the command set test
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryCommandSetTestResultModel {
    /// Success
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl DiscoveryCommandSetTestResultModel {
    /// The result of the command set test
    pub fn new() -> DiscoveryCommandSetTestResultModel {
