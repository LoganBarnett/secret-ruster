...
/// UpdateFieldValueOfApplicationAccessStatusRequestType : Application Access Status
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfApplicationAccessStatusRequestType {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<models::ApplicationAccessStatusRequestType>,
}

impl UpdateFieldValueOfApplicationAccessStatusRequestType {
    /// Application Access Status
    pub fn new() -> UpdateFieldValueOfApplicationAccessStatusRequestType {
