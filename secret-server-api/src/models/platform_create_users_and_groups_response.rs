...
/// PlatformCreateUsersAndGroupsResponse : PlatformCreateUsersAndGroupsResponse
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlatformCreateUsersAndGroupsResponse {
    /// Data
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::PlatformCreateEntityResponse>>,
    /// Error
    #[serde(rename = "error", skip_serializing_if = "Option::is_none")]
    pub error: Option<String>,
}

impl PlatformCreateUsersAndGroupsResponse {
    /// PlatformCreateUsersAndGroupsResponse
    pub fn new() -> PlatformCreateUsersAndGroupsResponse {
        PlatformCreateUsersAndGroupsResponse {
            data: None,
            error: None,
        }
