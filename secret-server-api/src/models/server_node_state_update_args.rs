...
/// ServerNodeStateUpdateArgs : ServerNodeStateUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ServerNodeStateUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ServerNodeStateUpdateModel>>,
}

impl ServerNodeStateUpdateArgs {
    /// ServerNodeStateUpdateArgs
    pub fn new() -> ServerNodeStateUpdateArgs {
        ServerNodeStateUpdateArgs {
            data: None,
        }
    }
