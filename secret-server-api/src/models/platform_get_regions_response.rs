...
/// PlatformGetRegionsResponse : Platform Get Region Response
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlatformGetRegionsResponse {
    /// The collection of available regions.
    #[serde(rename = "regions", skip_serializing_if = "Option::is_none")]
    pub regions: Option<Vec<models::PlatformRegion>>,
}

impl PlatformGetRegionsResponse {
    /// Platform Get Region Response
    pub fn new() -> PlatformGetRegionsResponse {
