...
/// RemoveMembersFromTeamArgs : RemoveMembersFromTeamArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct RemoveMembersFromTeamArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::RemoveMembersFromTeamModel>>,
}

impl RemoveMembersFromTeamArgs {
    /// RemoveMembersFromTeamArgs
    pub fn new() -> RemoveMembersFromTeamArgs {
        RemoveMembersFromTeamArgs {
            data: None,
        }
    }
