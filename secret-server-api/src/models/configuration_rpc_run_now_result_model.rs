...
/// ConfigurationRpcRunNowResultModel : RPC Run Now Result
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationRpcRunNowResultModel {
    /// Whether or not the call to Run Now was successful
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl ConfigurationRpcRunNowResultModel {
    /// RPC Run Now Result
    pub fn new() -> ConfigurationRpcRunNowResultModel {
