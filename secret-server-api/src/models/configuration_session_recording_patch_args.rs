...
/// ConfigurationSessionRecordingPatchArgs : ConfigurationSessionRecordingPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationSessionRecordingPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConfigurationSessionRecordingPatchModel>>,
}

impl ConfigurationSessionRecordingPatchArgs {
    /// ConfigurationSessionRecordingPatchArgs
    pub fn new() -> ConfigurationSessionRecordingPatchArgs {
        ConfigurationSessionRecordingPatchArgs {
            data: None,
        }
    }
