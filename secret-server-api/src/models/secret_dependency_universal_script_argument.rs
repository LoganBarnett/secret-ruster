...
/// SecretDependencyUniversalScriptArgument : Arguments used for Run Script Dependencies
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretDependencyUniversalScriptArgument {
...
impl SecretDependencyUniversalScriptArgument {
    /// Arguments used for Run Script Dependencies
    pub fn new() -> SecretDependencyUniversalScriptArgument {
