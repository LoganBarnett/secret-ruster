...
/// SecretTemplateImportModel : Secret Template Import Model
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretTemplateImportModel {
    /// Secret Template XML
    #[serde(rename = "templateXml", skip_serializing_if = "Option::is_none")]
    pub template_xml: Option<String>,
}

impl SecretTemplateImportModel {
    /// Secret Template Import Model
    pub fn new() -> SecretTemplateImportModel {
