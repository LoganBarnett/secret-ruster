...
/// AutoExportConfigurationArgs : AutoExportConfigurationArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AutoExportConfigurationArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::AutoExportConfigurationUpdateModel>>,
}

impl AutoExportConfigurationArgs {
    /// AutoExportConfigurationArgs
    pub fn new() -> AutoExportConfigurationArgs {
        AutoExportConfigurationArgs {
            data: None,
        }
    }
