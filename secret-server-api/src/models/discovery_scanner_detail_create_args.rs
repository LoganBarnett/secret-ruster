...
/// DiscoveryScannerDetailCreateArgs : DiscoveryScannerDetailCreateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryScannerDetailCreateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryScannerDetailCreateModel>>,
}

impl DiscoveryScannerDetailCreateArgs {
    /// DiscoveryScannerDetailCreateArgs
    pub fn new() -> DiscoveryScannerDetailCreateArgs {
        DiscoveryScannerDetailCreateArgs {
            data: None,
        }
    }
