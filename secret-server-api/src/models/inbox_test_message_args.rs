...
/// InboxTestMessageArgs : InboxTestMessageArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InboxTestMessageArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::InboxTestMessageModel>>,
}

impl InboxTestMessageArgs {
    /// InboxTestMessageArgs
    pub fn new() -> InboxTestMessageArgs {
        InboxTestMessageArgs {
            data: None,
        }
    }
