...
/// AssignSecretsToSecretPolicyArgs : AssignSecretsToSecretPolicyArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AssignSecretsToSecretPolicyArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::AssignSecretsToSecretPolicyModel>>,
}

impl AssignSecretsToSecretPolicyArgs {
    /// AssignSecretsToSecretPolicyArgs
    pub fn new() -> AssignSecretsToSecretPolicyArgs {
        AssignSecretsToSecretPolicyArgs {
            data: None,
        }
    }
