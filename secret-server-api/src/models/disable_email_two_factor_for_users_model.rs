...
/// DisableEmailTwoFactorForUsersModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DisableEmailTwoFactorForUsersModel {
    /// User Ids to set Email Two Factor to disabled.
    #[serde(rename = "userIds", skip_serializing_if = "Option::is_none")]
    pub user_ids: Option<Vec<i32>>,
}

impl DisableEmailTwoFactorForUsersModel {
    /// Data
    pub fn new() -> DisableEmailTwoFactorForUsersModel {
