...
/// ResetFido2TwoFactorForUsersModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ResetFido2TwoFactorForUsersModel {
    /// User Ids to reset Fido2 Two Factor for.
    #[serde(rename = "userIds", skip_serializing_if = "Option::is_none")]
    pub user_ids: Option<Vec<i32>>,
}

impl ResetFido2TwoFactorForUsersModel {
    /// Data
    pub fn new() -> ResetFido2TwoFactorForUsersModel {
