...
pub struct PagingOfRoleGroupSummaryAndGroupMembershipFilter {
    ...
    pub filter: Option<Box<models::GroupMembershipFilter>>,
    ...
    pub records: Option<Vec<models::RoleGroupSummary>>,
...
impl PagingOfRoleGroupSummaryAndGroupMembershipFilter {
    /// Specify filtering, paging, sorting options for querying records and returning results
    pub fn new() -> PagingOfRoleGroupSummaryAndGroupMembershipFilter {
