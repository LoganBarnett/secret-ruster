...
/// UpdateFieldValueOfLauncherDeploymentType : Launcher Deployment Type
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfLauncherDeploymentType {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<models::LauncherDeploymentType>,
}

impl UpdateFieldValueOfLauncherDeploymentType {
    /// Launcher Deployment Type
    pub fn new() -> UpdateFieldValueOfLauncherDeploymentType {
