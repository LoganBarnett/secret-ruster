...
/// ConfigurationGeneralPatchArgs : ConfigurationGeneralPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationGeneralPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConfigurationGeneralUpdateModel>>,
}

impl ConfigurationGeneralPatchArgs {
    /// ConfigurationGeneralPatchArgs
    pub fn new() -> ConfigurationGeneralPatchArgs {
        ConfigurationGeneralPatchArgs {
            data: None,
        }
    }
