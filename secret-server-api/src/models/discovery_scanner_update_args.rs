...
/// DiscoveryScannerUpdateArgs : Scanner update args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryScannerUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoveryScannerUpdateData>>,
}

impl DiscoveryScannerUpdateArgs {
    /// Scanner update args
    pub fn new() -> DiscoveryScannerUpdateArgs {
        DiscoveryScannerUpdateArgs {
            data: None,
        }
    }
}
