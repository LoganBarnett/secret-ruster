...
/// PbaConfigurationUpdateArgs : PbaConfigurationUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PbaConfigurationUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::PbaConfigurationUpdateModel>>,
}

impl PbaConfigurationUpdateArgs {
    /// PbaConfigurationUpdateArgs
    pub fn new() -> PbaConfigurationUpdateArgs {
        PbaConfigurationUpdateArgs {
            data: None,
        }
    }
