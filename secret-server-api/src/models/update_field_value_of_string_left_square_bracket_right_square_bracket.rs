...
/// UpdateFieldValueOfStringLeftSquareBracketRightSquareBracket : Characters that split keys to be indexed
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfStringLeftSquareBracketRightSquareBracket {
    /// Dirty
...
impl UpdateFieldValueOfStringLeftSquareBracketRightSquareBracket {
    /// Characters that split keys to be indexed
    pub fn new() -> UpdateFieldValueOfStringLeftSquareBracketRightSquareBracket {
