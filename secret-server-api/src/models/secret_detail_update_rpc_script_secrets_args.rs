...
/// SecretDetailUpdateRpcScriptSecretsArgs : RPC Script Update Message
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretDetailUpdateRpcScriptSecretsArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SecretDetailRpcScriptSecretsUpdateModel>>,
}

impl SecretDetailUpdateRpcScriptSecretsArgs {
    /// RPC Script Update Message
    pub fn new() -> SecretDetailUpdateRpcScriptSecretsArgs {
