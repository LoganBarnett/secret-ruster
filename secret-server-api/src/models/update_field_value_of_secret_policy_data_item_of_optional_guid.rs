...
/// UpdateFieldValueOfSecretPolicyDataItemOfOptionalGuid : Jumpbox Route Id
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfSecretPolicyDataItemOfOptionalGuid {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<Box<models::SecretPolicyDataItemOfOptionalGuid>>,
}

impl UpdateFieldValueOfSecretPolicyDataItemOfOptionalGuid {
    /// Jumpbox Route Id
    pub fn new() -> UpdateFieldValueOfSecretPolicyDataItemOfOptionalGuid {
