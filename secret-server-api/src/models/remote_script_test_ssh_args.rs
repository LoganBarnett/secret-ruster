...
/// RemoteScriptTestSshArgs : PowerShell test args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct RemoteScriptTestSshArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::RemoteScriptTestSshData>>,
}

impl RemoteScriptTestSshArgs {
    /// PowerShell test args
    pub fn new() -> RemoteScriptTestSshArgs {
