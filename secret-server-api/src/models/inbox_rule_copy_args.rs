...
/// InboxRuleCopyArgs : InboxRuleCopyArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InboxRuleCopyArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::InboxRuleCopyModel>>,
}

impl InboxRuleCopyArgs {
    /// InboxRuleCopyArgs
    pub fn new() -> InboxRuleCopyArgs {
        InboxRuleCopyArgs {
            data: None,
        }
    }
