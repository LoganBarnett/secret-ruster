...
/// PagingOfSecretEraseRequestHistoryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSecretEraseRequestHistoryModel {
    ...
    pub records: Option<Vec<models::SecretEraseRequestHistoryModel>>,
...
impl PagingOfSecretEraseRequestHistoryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSecretEraseRequestHistoryModel {
