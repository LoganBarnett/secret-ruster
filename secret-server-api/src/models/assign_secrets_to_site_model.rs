...
/// AssignSecretsToSiteModel : Data
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AssignSecretsToSiteModel {
    /// Ids of Secrets to assign to supplied site.
    #[serde(rename = "secretIds", skip_serializing_if = "Option::is_none")]
    pub secret_ids: Option<Vec<i32>>,
    /// Site Id to assign secrets to.
    #[serde(rename = "siteId", skip_serializing_if = "Option::is_none")]
    pub site_id: Option<i32>,
}

impl AssignSecretsToSiteModel {
    /// Data
    pub fn new() -> AssignSecretsToSiteModel {
