...
/// ConfigurationLauncherSettingsPatchArgs : ConfigurationLauncherSettingsPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ConfigurationLauncherSettingsPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ConfigurationLauncherSettingsPatchModel>>,
}

impl ConfigurationLauncherSettingsPatchArgs {
    /// ConfigurationLauncherSettingsPatchArgs
    pub fn new() -> ConfigurationLauncherSettingsPatchArgs {
        ConfigurationLauncherSettingsPatchArgs {
            data: None,
        }
    }
