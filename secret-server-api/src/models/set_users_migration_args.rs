...
/// SetUsersMigrationArgs : SetUsersMigrationArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SetUsersMigrationArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::SetUsersMigrationModel>>,
}

impl SetUsersMigrationArgs {
    /// SetUsersMigrationArgs
    pub fn new() -> SetUsersMigrationArgs {
        SetUsersMigrationArgs {
            data: None,
        }
    }
