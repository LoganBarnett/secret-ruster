...
/// PagingOfPlatformDataMigrationUserSummaryAndPlatformDataMigrationUserFilter : Specify filtering, paging, sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfPlatformDataMigrationUserSummaryAndPlatformDataMigrationUserFilter {
    ...
    pub filter: Option<Box<models::PlatformDataMigrationUserFilter>>,
    ...
    pub records: Option<Vec<models::PlatformDataMigrationUserSummary>>,
...
impl PagingOfPlatformDataMigrationUserSummaryAndPlatformDataMigrationUserFilter {
    /// Specify filtering, paging, sorting options for querying records and returning results
    pub fn new() -> PagingOfPlatformDataMigrationUserSummaryAndPlatformDataMigrationUserFilter {
