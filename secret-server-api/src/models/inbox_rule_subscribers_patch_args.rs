...
/// InboxRuleSubscribersPatchArgs : InboxRuleSubscribersPatchArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InboxRuleSubscribersPatchArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::InboxRuleSubscriberPatchModel>>,
}

impl InboxRuleSubscribersPatchArgs {
    /// InboxRuleSubscribersPatchArgs
    pub fn new() -> InboxRuleSubscribersPatchArgs {
        InboxRuleSubscribersPatchArgs {
            data: None,
        }
    }
