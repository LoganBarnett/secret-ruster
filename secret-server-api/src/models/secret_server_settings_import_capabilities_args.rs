...
/// SecretServerSettingsImportCapabilitiesArgs : SecretServerSettingsImportCapabilitiesArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretServerSettingsImportCapabilitiesArgs {
    /// File
...
impl SecretServerSettingsImportCapabilitiesArgs {
    /// SecretServerSettingsImportCapabilitiesArgs
    pub fn new() -> SecretServerSettingsImportCapabilitiesArgs {
        SecretServerSettingsImportCapabilitiesArgs {
            file: None,
            is_import: None,
        }
