...
/// MetadataFieldSectionUpdateArgs : Metadata field section update args
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct MetadataFieldSectionUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::MetadataFieldSectionUpdateModel>>,
}

impl MetadataFieldSectionUpdateArgs {
    /// Metadata field section update args
    pub fn new() -> MetadataFieldSectionUpdateArgs {
