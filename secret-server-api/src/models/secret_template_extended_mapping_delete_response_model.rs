...
/// SecretTemplateExtendedMappingDeleteResponseModel : SecretTemplateExtendedMappingDeleteResponseModel
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SecretTemplateExtendedMappingDeleteResponseModel {
    /// Success
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl SecretTemplateExtendedMappingDeleteResponseModel {
    /// SecretTemplateExtendedMappingDeleteResponseModel
    pub fn new() -> SecretTemplateExtendedMappingDeleteResponseModel {
        SecretTemplateExtendedMappingDeleteResponseModel {
            success: None,
        }
    }
