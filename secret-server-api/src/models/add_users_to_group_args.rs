...
/// AddUsersToGroupArgs : AddUsersToGroupArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AddUsersToGroupArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::AddUsersToGroupModel>>,
}

impl AddUsersToGroupArgs {
    /// AddUsersToGroupArgs
    pub fn new() -> AddUsersToGroupArgs {
        AddUsersToGroupArgs {
            data: None,
        }
    }
