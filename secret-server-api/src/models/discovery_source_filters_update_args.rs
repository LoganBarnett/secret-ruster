...
/// DiscoverySourceFiltersUpdateArgs : DiscoverySourceFiltersUpdateArgs
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoverySourceFiltersUpdateArgs {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::DiscoverySourceFiltersUpdateModel>>,
}

impl DiscoverySourceFiltersUpdateArgs {
    /// DiscoverySourceFiltersUpdateArgs
    pub fn new() -> DiscoverySourceFiltersUpdateArgs {
        DiscoverySourceFiltersUpdateArgs {
            data: None,
        }
    }
