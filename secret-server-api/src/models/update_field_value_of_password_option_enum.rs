...
/// UpdateFieldValueOfPasswordOptionEnum : Password Option
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfPasswordOptionEnum {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<models::PasswordOptionEnum>,
}

impl UpdateFieldValueOfPasswordOptionEnum {
    /// Password Option
    pub fn new() -> UpdateFieldValueOfPasswordOptionEnum {
