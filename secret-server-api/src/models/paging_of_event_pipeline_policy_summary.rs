...
/// PagingOfEventPipelinePolicySummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfEventPipelinePolicySummary {
    ...
    pub records: Option<Vec<models::EventPipelinePolicySummary>>,
...
impl PagingOfEventPipelinePolicySummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfEventPipelinePolicySummary {
