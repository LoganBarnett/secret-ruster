...
/// PagingOfDevOpsSecretsVaultTenantSummary : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfDevOpsSecretsVaultTenantSummary {
    ...
    pub records: Option<Vec<models::DevOpsSecretsVaultTenantSummary>>,
...
impl PagingOfDevOpsSecretsVaultTenantSummary {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfDevOpsSecretsVaultTenantSummary {
