...
/// DiscoveryScannerSortResultModel : Sort Response Model
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryScannerSortResultModel {
    /// Whether or not the sort was successful.
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl DiscoveryScannerSortResultModel {
    /// Sort Response Model
    pub fn new() -> DiscoveryScannerSortResultModel {
