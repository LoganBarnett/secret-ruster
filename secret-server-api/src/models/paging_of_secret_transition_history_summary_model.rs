...
/// PagingOfSecretTransitionHistorySummaryModel : Specify paging and sorting options for querying records and returning results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PagingOfSecretTransitionHistorySummaryModel {
    ...
    pub records: Option<Vec<models::SecretTransitionHistorySummaryModel>>,
...
impl PagingOfSecretTransitionHistorySummaryModel {
    /// Specify paging and sorting options for querying records and returning results
    pub fn new() -> PagingOfSecretTransitionHistorySummaryModel {
