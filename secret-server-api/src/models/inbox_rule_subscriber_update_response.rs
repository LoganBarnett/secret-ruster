...
/// InboxRuleSubscriberUpdateResponse : InboxRuleSubscriberUpdateResponse
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InboxRuleSubscriberUpdateResponse {
    /// Success
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
}

impl InboxRuleSubscriberUpdateResponse {
    /// InboxRuleSubscriberUpdateResponse
    pub fn new() -> InboxRuleSubscriberUpdateResponse {
        InboxRuleSubscriberUpdateResponse {
            success: None,
        }
    }
