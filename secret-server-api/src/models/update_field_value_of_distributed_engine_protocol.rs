...
/// UpdateFieldValueOfDistributedEngineProtocol : Protocol used by Distibuted Engine
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateFieldValueOfDistributedEngineProtocol {
    /// Dirty
    #[serde(rename = "dirty", skip_serializing_if = "Option::is_none")]
    pub dirty: Option<bool>,
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<models::DistributedEngineProtocol>,
}

impl UpdateFieldValueOfDistributedEngineProtocol {
    /// Protocol used by Distibuted Engine
    pub fn new() -> UpdateFieldValueOfDistributedEngineProtocol {
